...
export class QAssetSensorAnomalyDetectionParameters extends QueryObject {
  public readonly sensorId = new QStringPath(this.withPrefix("SensorId"));
  public readonly counterMaxAnomalyRatioValue = new QNumberPath(
    this.withPrefix("CounterMaxAnomalyRatioValue"),
  );
  public readonly counterSensitivityValue = new QNumberPath(
    this.withPrefix("CounterSensitivityValue"),
  );
  public readonly counterName = new QStringPath(this.withPrefix("CounterName"));
}

export const qAssetSensorAnomalyDetectionParameters =
  new QAssetSensorAnomalyDetectionParameters();

export class QAssetSensorAnomalyDetectionParametersId extends QId<AssetSensorAnomalyDetectionParametersId> {
  private readonly params = [new QStringParam("SensorId", "sensorId")];
...
export class QAssetTransReportingCurrencyAmounts extends QueryObject {
  public readonly dataAreaId = new QStringPath(this.withPrefix("dataAreaId"));
  public readonly assetTrans = new QNumberPath(this.withPrefix("AssetTrans"));
  public readonly reportingCurrencyExchRate = new QNumberPath(
    this.withPrefix("ReportingCurrencyExchRate"),
  );
  public readonly bookId = new QStringPath(this.withPrefix("BookId"));
  ...
  public readonly transDate = new QDateTimeOffsetPath(
    this.withPrefix("TransDate"),
  );
  public readonly amountReportingCurrency = new QNumberPath(
    this.withPrefix("AmountReportingCurrency"),
  );
  public readonly amountCur = new QNumberPath(this.withPrefix("AmountCur"));
  public readonly amountMst = new QNumberPath(this.withPrefix("AmountMST"));
}

export const qAssetTransReportingCurrencyAmounts =
  new QAssetTransReportingCurrencyAmounts();

export class QAssetTransReportingCurrencyAmountsId extends QId<AssetTransReportingCurrencyAmountsId> {
  private readonly params = [
    new QStringParam("dataAreaId"),
    new QNumberParam("AssetTrans", "assetTrans"),
  ];
