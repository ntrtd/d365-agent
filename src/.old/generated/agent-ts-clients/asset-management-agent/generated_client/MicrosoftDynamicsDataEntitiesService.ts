...
> extends ODataService<ClientType> {
  public assetSensorAnomalyDetectionParameters(): AssetSensorAnomalyDetectionParametersCollectionService<ClientType>;
  public assetSensorAnomalyDetectionParameters(
    id: AssetSensorAnomalyDetectionParametersId,
  ): AssetSensorAnomalyDetectionParametersService<ClientType>;
  public assetSensorAnomalyDetectionParameters(
    id?: AssetSensorAnomalyDetectionParametersId | undefined,
  ) {
    const fieldName = "AssetSensorAnomalyDetectionParameters";
    const { client, path, options, isUrlNotEncoded } = this.__base;
    return typeof id === "undefined" || id === null
      ? new AssetSensorAnomalyDetectionParametersCollectionService(
          client,
          path,
          fieldName,
          options,
        )
      : new AssetSensorAnomalyDetectionParametersService(
          client,
          path,
          new QAssetSensorAnomalyDetectionParametersId(fieldName).buildUrl(
            id,
            isUrlNotEncoded(),
          ),
          options,
  ...
  public assetTransReportingCurrencyAmounts(): AssetTransReportingCurrencyAmountsCollectionService<ClientType>;
  public assetTransReportingCurrencyAmounts(
    id: AssetTransReportingCurrencyAmountsId,
  ): AssetTransReportingCurrencyAmountsService<ClientType>;
  public assetTransReportingCurrencyAmounts(
    id?: AssetTransReportingCurrencyAmountsId | undefined,
  ) {
    const fieldName = "AssetTransReportingCurrencyAmounts";
    const { client, path, options, isUrlNotEncoded } = this.__base;
    return typeof id === "undefined" || id === null
      ? new AssetTransReportingCurrencyAmountsCollectionService(
          client,
          path,
          fieldName,
          options,
        )
      : new AssetTransReportingCurrencyAmountsService(
          client,
          path,
          new QAssetTransReportingCurrencyAmountsId(fieldName).buildUrl(
            id,
            isUrlNotEncoded(),
          ),
          options,
...
export class AssetSensorAnomalyDetectionParametersService<
  in out ClientType extends ODataHttpClient,
...
export class AssetSensorAnomalyDetectionParametersCollectionService<
  in out ClientType extends ODataHttpClient,
...
> {
  constructor(
    ...
    super(
      ...
      name,
      qAssetSensorAnomalyDetectionParameters,
      new QAssetSensorAnomalyDetectionParametersId(name),
      options,
    );
  }
}
...
export class AssetTransReportingCurrencyAmountsService<
  in out ClientType extends ODataHttpClient,
> extends EntityTypeServiceV4<
  ClientType,
  AssetTransReportingCurrencyAmounts,
...
> {
  constructor(
    ...
    super(client, basePath, name, qAssetTransReportingCurrencyAmounts, options);
  }
}

export class AssetTransReportingCurrencyAmountsCollectionService<
  in out ClientType extends ODataHttpClient,
> extends EntitySetServiceV4<
  ClientType,
  AssetTransReportingCurrencyAmounts,
...
> {
  constructor(
    ...
    super(
      ...
      name,
      qAssetTransReportingCurrencyAmounts,
      new QAssetTransReportingCurrencyAmountsId(name),
      options,
    );
  }
}
