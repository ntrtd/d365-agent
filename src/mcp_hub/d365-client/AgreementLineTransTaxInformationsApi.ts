...
import { AgreementLineTransTaxInformationsRequestBuilder } from './AgreementLineTransTaxInformationsRequestBuilder';
...
export class AgreementLineTransTaxInformationsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<AgreementLineTransTaxInformations<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): AgreementLineTransTaxInformationsApi<DeSerializersT> {
    return new AgreementLineTransTaxInformationsApi(deSerializers);
  }
  ...
  entityConstructor = AgreementLineTransTaxInformations;

  requestBuilder(): AgreementLineTransTaxInformationsRequestBuilder<DeSerializersT> {
    return new AgreementLineTransTaxInformationsRequestBuilder<DeSerializersT>(
      this
    );
  }

  entityBuilder(): EntityBuilderType<
    AgreementLineTransTaxInformations<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof AgreementLineTransTaxInformations,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        AgreementLineTransTaxInformations,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      AgreementLineTransTaxInformations<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    >;
    AGREEMENT: OrderableEdmTypeField<
      AgreementLineTransTaxInformations<DeSerializers>,
      DeSerializersT,
      'Edm.Int64',
      false,
    ...
    EXCISE_IS_SCRAP: EnumField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<AgreementLineTransTaxInformations<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link agreement} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        AGREEMENT: fieldBuilder.buildEdmTypeField(
          'Agreement',
          'Edm.Int64',
          false
        ),
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', AgreementLineTransTaxInformations)
      };
    }
