...
import { CallCenterSalesOrderCustomerPaymentsRequestBuilder } from './CallCenterSalesOrderCustomerPaymentsRequestBuilder';
...
export class CallCenterSalesOrderCustomerPaymentsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      CallCenterSalesOrderCustomerPayments<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): CallCenterSalesOrderCustomerPaymentsApi<DeSerializersT> {
    return new CallCenterSalesOrderCustomerPaymentsApi(deSerializers);
  }
  ...
  entityConstructor = CallCenterSalesOrderCustomerPayments;

  requestBuilder(): CallCenterSalesOrderCustomerPaymentsRequestBuilder<DeSerializersT> {
    return new CallCenterSalesOrderCustomerPaymentsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof CallCenterSalesOrderCustomerPayments,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        CallCenterSalesOrderCustomerPayments,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      CallCenterSalesOrderCustomerPayments<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    PAYMENT_SCHED_ID: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<CallCenterSalesOrderCustomerPayments<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', CallCenterSalesOrderCustomerPayments)
      };
    }
