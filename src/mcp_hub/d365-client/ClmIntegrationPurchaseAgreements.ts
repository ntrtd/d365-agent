...
import type { ClmIntegrationPurchaseAgreementsApi } from './ClmIntegrationPurchaseAgreementsApi';
...
/**
 * This class represents the entity "CLMIntegrationPurchaseAgreements" of service "d365_metadata".
 */
export class ClmIntegrationPurchaseAgreements<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ClmIntegrationPurchaseAgreementsType<T>
{
  /**
   * Technical entity name for ClmIntegrationPurchaseAgreements.
   */
  static override _entityName = 'CLMIntegrationPurchaseAgreements';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ClmIntegrationPurchaseAgreements entity.
   */
   ...
   * @nullable
   */
  declare agreementOwnership?: ClmIntegrationPurchaseAgreementOwnershipType | null;
  /**
  ...
  /**
   * Secondary Responsible Worker Email.
   * @nullable
   */
  declare secondaryResponsibleWorkerEmail?: DeserializedType<
    T,
    'Edm.String'
  > | null;
  /**
   * Contract Legal Entity Id.
   * @nullable
   */
  declare contractLegalEntityId?: DeserializedType<T, 'Edm.String'> | null;
  /**
   * Vat Operation Code.
   * @nullable
   */
  ...
  /**
   * Primary Responsible Worker Email.
   * @nullable
   */
  declare primaryResponsibleWorkerEmail?: DeserializedType<
    T,
    'Edm.String'
  > | null;
  /**
  ...
  constructor(_entityApi: ClmIntegrationPurchaseAgreementsApi<T>) {
    super(_entityApi);
  }
}

export interface ClmIntegrationPurchaseAgreementsType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  agreementOwnership?: ClmIntegrationPurchaseAgreementOwnershipType | null;
  ...
  secondaryResponsibleWorkerEmail?: DeserializedType<T, 'Edm.String'> | null;
  contractLegalEntityId?: DeserializedType<T, 'Edm.String'> | null;
  ...
  primaryResponsibleWorkerEmail?: DeserializedType<T, 'Edm.String'> | null;
