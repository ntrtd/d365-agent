...
import type { SalesInvoiceHeadersApi } from './SalesInvoiceHeadersApi';

/**
 * This class represents the entity "SalesInvoiceHeaders" of service "d365_metadata".
 */
export class SalesInvoiceHeaders<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements SalesInvoiceHeadersType<T>
{
  /**
   * Technical entity name for SalesInvoiceHeaders.
   */
  static override _entityName = 'SalesInvoiceHeaders';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the SalesInvoiceHeaders entity.
   */
  static _keys = ['dataAreaId', 'InvoiceNumber', 'InvoiceDate'];
  /**
   * Data Area Id.
   */
  ...
  constructor(_entityApi: SalesInvoiceHeadersApi<T>) {
    super(_entityApi);
  }
}

export interface SalesInvoiceHeadersType<
