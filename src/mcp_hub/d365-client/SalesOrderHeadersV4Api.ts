...
import { SalesOrderHeadersV4RequestBuilder } from './SalesOrderHeadersV4RequestBuilder';
...
export class SalesOrderHeadersV4Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<SalesOrderHeadersV4<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new SalesOrderHeadersV4Api(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    SALES_ORDER_ORIGIN: OneToOneLink<
      SalesOrderHeadersV4<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = SalesOrderHeadersV4;

  requestBuilder(): SalesOrderHeadersV4RequestBuilder<DeSerializersT> {
    return new SalesOrderHeadersV4RequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<SalesOrderHeadersV4<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      SalesOrderHeadersV4<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    DIMENSION_SET: OneToOneLink<
      ...
      DimensionSetsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<SalesOrderHeadersV4<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', SalesOrderHeadersV4)
      };
    }
