...
import { DualWriteVendorActivitiesRequestBuilder } from './DualWriteVendorActivitiesRequestBuilder';
...
export class DualWriteVendorActivitiesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<DualWriteVendorActivities<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): DualWriteVendorActivitiesApi<DeSerializersT> {
    return new DualWriteVendorActivitiesApi(deSerializers);
  }
  ...
  entityConstructor = DualWriteVendorActivities;

  requestBuilder(): DualWriteVendorActivitiesRequestBuilder<DeSerializersT> {
    return new DualWriteVendorActivitiesRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    DualWriteVendorActivities<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof DualWriteVendorActivities,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        DualWriteVendorActivities,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      DualWriteVendorActivities<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    SOURCE: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<DualWriteVendorActivities<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', DualWriteVendorActivities)
      };
    }
