...
import type { DualWriteCustomerActivitiesV2Api } from './DualWriteCustomerActivitiesV2Api';
...
/**
 * This class represents the entity "DualWriteCustomerActivitiesV2" of service "d365_metadata".
 */
export class DualWriteCustomerActivitiesV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements DualWriteCustomerActivitiesV2Type<T>
{
  /**
   * Technical entity name for DualWriteCustomerActivitiesV2.
   */
  static override _entityName = 'DualWriteCustomerActivitiesV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the DualWriteCustomerActivitiesV2 entity.
   */
  static _keys = ['dataAreaId', 'ActivityNumber', 'AccountNum'];
  /**
   * Data Area Id.
   */
  ...
  constructor(_entityApi: DualWriteCustomerActivitiesV2Api<T>) {
    super(_entityApi);
  }
}

export interface DualWriteCustomerActivitiesV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
