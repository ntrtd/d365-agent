...
import type { PayrollWorkerAddressesCurrentApi } from './PayrollWorkerAddressesCurrentApi';
import { NoYes } from './NoYes';
import { BaseWorkers, BaseWorkersType } from './BaseWorkers';

/**
 * This class represents the entity "PayrollWorkerAddressesCurrent" of service "d365_metadata".
 */
export class PayrollWorkerAddressesCurrent<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements PayrollWorkerAddressesCurrentType<T>
{
  /**
   * Technical entity name for PayrollWorkerAddressesCurrent.
   */
  static override _entityName = 'PayrollWorkerAddressesCurrent';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the PayrollWorkerAddressesCurrent entity.
   */
  ...
  constructor(_entityApi: PayrollWorkerAddressesCurrentApi<T>) {
    super(_entityApi);
  }
}

export interface PayrollWorkerAddressesCurrentType<
  T extends DeSerializers = DefaultDeSerializers
> {
