...
import type { ExchangeRatesApi } from './ExchangeRatesApi';
...
/**
 * This class represents the entity "ExchangeRates" of service "d365_metadata".
 */
export class ExchangeRates<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements ExchangeRatesType<T>
{
  /**
   * Technical entity name for ExchangeRates.
   */
  static override _entityName = 'ExchangeRates';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ExchangeRates entity.
   */
  ...
  constructor(_entityApi: ExchangeRatesApi<T>) {
    super(_entityApi);
  }
}
