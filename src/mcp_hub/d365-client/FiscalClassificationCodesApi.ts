...
import { FiscalClassificationCodesRequestBuilder } from './FiscalClassificationCodesRequestBuilder';
...
export class FiscalClassificationCodesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<FiscalClassificationCodes<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): FiscalClassificationCodesApi<DeSerializersT> {
    return new FiscalClassificationCodesApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    RELEASED_PRODUCTS_V_2: OneToManyLink<
      FiscalClassificationCodes<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = FiscalClassificationCodes;

  requestBuilder(): FiscalClassificationCodesRequestBuilder<DeSerializersT> {
    return new FiscalClassificationCodesRequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof FiscalClassificationCodes,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      FiscalClassificationCodes<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    FISCAL_CLASSIFICATION_CODE: OrderableEdmTypeField<
      ...
      true
    >;
    FISCAL_CLASSIFICATION_NAME: OrderableEdmTypeField<
      FiscalClassificationCodes<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    RELEASED_PRODUCTS_V_2: OneToManyLink<
      ...
      ReleasedProductsV2Api<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<FiscalClassificationCodes<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link fiscalClassificationName} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        FISCAL_CLASSIFICATION_NAME: fieldBuilder.buildEdmTypeField(
          'FiscalClassificationName',
          'Edm.String',
          true
        ),
        /**
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', FiscalClassificationCodes)
      };
    }
