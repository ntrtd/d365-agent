...
import type { ShipConsolidationTemplatesV2Api } from './ShipConsolidationTemplatesV2Api';
import { NoYes } from './NoYes';
import { WhsShipConsolidationPolicyType } from './WhsShipConsolidationPolicyType';

/**
 * This class represents the entity "ShipConsolidationTemplatesV2" of service "d365_metadata".
 */
export class ShipConsolidationTemplatesV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ShipConsolidationTemplatesV2Type<T>
{
  /**
   * Technical entity name for ShipConsolidationTemplatesV2.
   */
  static override _entityName = 'ShipConsolidationTemplatesV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ShipConsolidationTemplatesV2 entity.
   */
  ...
  constructor(_entityApi: ShipConsolidationTemplatesV2Api<T>) {
    super(_entityApi);
  }
}

export interface ShipConsolidationTemplatesV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
