...
import type { AssetMaintenanceWorkOrderLinesV2Api } from './AssetMaintenanceWorkOrderLinesV2Api';
...
/**
 * This class represents the entity "AssetMaintenanceWorkOrderLinesV2" of service "d365_metadata".
 */
export class AssetMaintenanceWorkOrderLinesV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements AssetMaintenanceWorkOrderLinesV2Type<T>
{
  /**
   * Technical entity name for AssetMaintenanceWorkOrderLinesV2.
   */
  static override _entityName = 'AssetMaintenanceWorkOrderLinesV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the AssetMaintenanceWorkOrderLinesV2 entity.
   */
  ...
  /**
   * Schedule Work Order Job.
   * @nullable
   */
  declare scheduleWorkOrderJob?: NoYes | null;
  /**
   * Forecast Hour Qty.
   */
   ...
   */
  declare maintenanceWorkOrderUserReferencesMaintenanceWorkOrderJobV2: AssetMaintenanceWorkOrderUserReferences<T>[];
  /**
   * One-to-one navigation property to the {@link MaintenanceWorkOrderLineDocumentAttachments} entity.
   */
  declare workOrderJobDocumentAttachment?: MaintenanceWorkOrderLineDocumentAttachments<T> | null;
  /**
   * One-to-many navigation property to the {@link AssetMaintenanceAssetBillOfMaterialsV2} entity.
   */
  declare maintenanceAssetBillOfMaterialsMaintenanceWorkOrderJobV2: AssetMaintenanceAssetBillOfMaterialsV2<T>[];
  /**
   ...
   */
  declare maintenanceWorkOrderJobChecklistHeadersMaintenanceWorkOrderJobV2: AssetMaintenanceWorkOrderJobChecklistHeadersV2<T>[];

  constructor(_entityApi: AssetMaintenanceWorkOrderLinesV2Api<T>) {
    super(_entityApi);
  }
}

export interface AssetMaintenanceWorkOrderLinesV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  scheduleWorkOrderJob?: NoYes | null;
  ...
  maintenanceWorkOrderUserReferencesMaintenanceWorkOrderJobV2: AssetMaintenanceWorkOrderUserReferencesType<T>[];
  workOrderJobDocumentAttachment?: MaintenanceWorkOrderLineDocumentAttachmentsType<T> | null;
  maintenanceAssetBillOfMaterialsMaintenanceWorkOrderJobV2: AssetMaintenanceAssetBillOfMaterialsV2Type<T>[];
  ...
  maintenanceWorkOrderJobChecklistHeadersMaintenanceWorkOrderJobV2: AssetMaintenanceWorkOrderJobChecklistHeadersV2Type<T>[];
}
