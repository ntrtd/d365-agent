...
import { ReleasedProductMastersRequestBuilder } from './ReleasedProductMastersRequestBuilder';
...
export class ReleasedProductMastersApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<ReleasedProductMasters<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new ReleasedProductMastersApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    PRODUCT_MASTER: OneToOneLink<
      ReleasedProductMasters<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = ReleasedProductMasters;

  requestBuilder(): ReleasedProductMastersRequestBuilder<DeSerializersT> {
    return new ReleasedProductMastersRequestBuilder<DeSerializersT>(this);
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ReleasedProductMasters<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    RELEASED_PRODUCT_VARIANT_V_2: OneToManyLink<
      ...
      ReleasedProductVariantsV2Api<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<ReleasedProductMasters<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ReleasedProductMasters)
      };
    }
