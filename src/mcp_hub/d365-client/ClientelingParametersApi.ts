...
import { ClientelingParametersRequestBuilder } from './ClientelingParametersRequestBuilder';
...
export class ClientelingParametersApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<ClientelingParameters<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): ClientelingParametersApi<DeSerializersT> {
    return new ClientelingParametersApi(deSerializers);
  }
  ...
  entityConstructor = ClientelingParameters;

  requestBuilder(): ClientelingParametersRequestBuilder<DeSerializersT> {
    return new ClientelingParametersRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    ClientelingParameters<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<ClientelingParameters<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof ClientelingParameters,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        ClientelingParameters,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ClientelingParameters<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    CUSTOMER_INSIGHTS_APPLICATION_SECRET_NAME: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<ClientelingParameters<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ClientelingParameters)
      };
    }
