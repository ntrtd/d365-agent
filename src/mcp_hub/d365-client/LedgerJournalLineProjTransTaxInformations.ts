...
import type { LedgerJournalLineProjTransTaxInformationsApi } from './LedgerJournalLineProjTransTaxInformationsApi';
...
/**
 * This class represents the entity "LedgerJournalLineProjTransTaxInformations" of service "d365_metadata".
 */
export class LedgerJournalLineProjTransTaxInformations<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements LedgerJournalLineProjTransTaxInformationsType<T>
{
  /**
   * Technical entity name for LedgerJournalLineProjTransTaxInformations.
   */
  static override _entityName = 'LedgerJournalLineProjTransTaxInformations';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the LedgerJournalLineProjTransTaxInformations entity.
   */
  static _keys = ['dataAreaId', 'LineNumber', 'JournalBatchNumber'];
  /**
   * Data Area Id.
   */
  ...
  constructor(_entityApi: LedgerJournalLineProjTransTaxInformationsApi<T>) {
    super(_entityApi);
  }
}

export interface LedgerJournalLineProjTransTaxInformationsType<
  T extends DeSerializers = DefaultDeSerializers
> {
