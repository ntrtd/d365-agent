...
import type { PurchaseOrderHeadersApi } from './PurchaseOrderHeadersApi';
...
/**
 * This class represents the entity "PurchaseOrderHeaders" of service "d365_metadata".
 */
export class PurchaseOrderHeaders<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements PurchaseOrderHeadersType<T>
{
  /**
   * Technical entity name for PurchaseOrderHeaders.
   */
  static override _entityName = 'PurchaseOrderHeaders';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the PurchaseOrderHeaders entity.
   */
  ...
  constructor(_entityApi: PurchaseOrderHeadersApi<T>) {
    super(_entityApi);
  }
}

export interface PurchaseOrderHeadersType<
  T extends DeSerializers = DefaultDeSerializers
> {
