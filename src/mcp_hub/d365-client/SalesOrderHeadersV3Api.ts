...
import { SalesOrderHeadersV3RequestBuilder } from './SalesOrderHeadersV3RequestBuilder';
...
export class SalesOrderHeadersV3Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<SalesOrderHeadersV3<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new SalesOrderHeadersV3Api(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    SALES_ORDER_HEADER_DOCUMENT_ATTACHMENTS: OneToManyLink<
      SalesOrderHeadersV3<DeSerializersT>,
      DeSerializersT,
    ...
    >;
    /**
     * Static representation of the one-to-many navigation property {@link salesOrderLines} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SALES_ORDER_LINES: OneToManyLink<
      SalesOrderHeadersV3<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ...
      SALES_ORDER_LINES: new OneToManyLink(
        'SalesOrderLines',
        this,
        linkedApis[2]
      ),
  ...
  entityConstructor = SalesOrderHeadersV3;

  requestBuilder(): SalesOrderHeadersV3RequestBuilder<DeSerializersT> {
    return new SalesOrderHeadersV3RequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<SalesOrderHeadersV3<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      SalesOrderHeadersV3<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    IS_SALES_PROCESSING_STOPPED: EnumField<
      ...
      true
    >;
    SHIPPING_CARRIER_CUSTOMER_ACCOUNT_NUMBER: OrderableEdmTypeField<
      SalesOrderHeadersV3<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    FIXED_EXCHANGE_RATE: OrderableEdmTypeField<
      ...
      true
    >;
    SUB_BILL_CREATED_FROM_SUBSCRIPTION_BILLING: EnumField<
      SalesOrderHeadersV3<DeSerializers>,
      DeSerializersT,
      NoYes,
      true,
    ...
    DIMENSION_SET: OneToOneLink<
      ...
      DimensionSetsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<SalesOrderHeadersV3<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link shippingCarrierCustomerAccountNumber} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        SHIPPING_CARRIER_CUSTOMER_ACCOUNT_NUMBER:
        ...
        /**
         * Static representation of the {@link subBillCreatedFromSubscriptionBilling} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        SUB_BILL_CREATED_FROM_SUBSCRIPTION_BILLING: fieldBuilder.buildEnumField(
          'SubBillCreatedFromSubscriptionBilling',
          NoYes,
          true
        ),
        /**
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', SalesOrderHeadersV3)
      };
    }
