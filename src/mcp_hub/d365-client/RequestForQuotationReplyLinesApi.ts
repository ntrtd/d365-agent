...
import { RequestForQuotationReplyLinesRequestBuilder } from './RequestForQuotationReplyLinesRequestBuilder';
...
export class RequestForQuotationReplyLinesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<RequestForQuotationReplyLines<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): RequestForQuotationReplyLinesApi<DeSerializersT> {
    return new RequestForQuotationReplyLinesApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    DIMENSION_SET: OneToOneLink<
      RequestForQuotationReplyLines<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = RequestForQuotationReplyLines;

  requestBuilder(): RequestForQuotationReplyLinesRequestBuilder<DeSerializersT> {
    return new RequestForQuotationReplyLinesRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof RequestForQuotationReplyLines,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      RequestForQuotationReplyLines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    RFQ_CASE_LINE_LINE_NUMBER: OrderableEdmTypeField<
      ...
      true
    >;
    REQUESTED_QUANTITY_UNIT_SYMBOL: OrderableEdmTypeField<
      RequestForQuotationReplyLines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    DIMENSION_SET: OneToOneLink<
      ...
      DimensionSetsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<RequestForQuotationReplyLines<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link requestedQuantityUnitSymbol} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        REQUESTED_QUANTITY_UNIT_SYMBOL: fieldBuilder.buildEdmTypeField(
          'RequestedQuantityUnitSymbol',
          'Edm.String',
          true
        ),
        /**
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', RequestForQuotationReplyLines)
      };
    }
