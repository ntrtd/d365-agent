...
import { SalesInvoiceHeadersRequestBuilder } from './SalesInvoiceHeadersRequestBuilder';
import {
  CustomField,
...
export class SalesInvoiceHeadersApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<SalesInvoiceHeaders<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): SalesInvoiceHeadersApi<DeSerializersT> {
    return new SalesInvoiceHeadersApi(deSerializers);
  }
  ...
  entityConstructor = SalesInvoiceHeaders;

  requestBuilder(): SalesInvoiceHeadersRequestBuilder<DeSerializersT> {
    return new SalesInvoiceHeadersRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    SalesInvoiceHeaders<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<SalesInvoiceHeaders<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      SalesInvoiceHeaders<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    SALES_ORDER_ORIGIN_CODE: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<SalesInvoiceHeaders<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', SalesInvoiceHeaders)
      };
    }
