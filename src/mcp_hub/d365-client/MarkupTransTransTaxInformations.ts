...
import type { MarkupTransTransTaxInformationsApi } from './MarkupTransTransTaxInformationsApi';
...
/**
 * This class represents the entity "MarkupTransTransTaxInformations" of service "d365_metadata".
 */
export class MarkupTransTransTaxInformations<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements MarkupTransTransTaxInformationsType<T>
{
  /**
   * Technical entity name for MarkupTransTransTaxInformations.
   */
  static override _entityName = 'MarkupTransTransTaxInformations';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the MarkupTransTransTaxInformations entity.
   */
  static _keys = ['dataAreaId', 'LineNum', 'TransRecId', 'TransTableId'];
  /**
   * Data Area Id.
   */
  ...
  constructor(_entityApi: MarkupTransTransTaxInformationsApi<T>) {
    super(_entityApi);
  }
}

export interface MarkupTransTransTaxInformationsType<
  T extends DeSerializers = DefaultDeSerializers
> {
