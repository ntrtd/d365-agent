...
import { PurchRfqLineTransTaxInformationsRequestBuilder } from './PurchRfqLineTransTaxInformationsRequestBuilder';
...
export class PurchRfqLineTransTaxInformationsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<PurchRfqLineTransTaxInformations<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): PurchRfqLineTransTaxInformationsApi<DeSerializersT> {
    return new PurchRfqLineTransTaxInformationsApi(deSerializers);
  }
  ...
  entityConstructor = PurchRfqLineTransTaxInformations;

  requestBuilder(): PurchRfqLineTransTaxInformationsRequestBuilder<DeSerializersT> {
    return new PurchRfqLineTransTaxInformationsRequestBuilder<DeSerializersT>(
      this
    );
  }

  entityBuilder(): EntityBuilderType<
    PurchRfqLineTransTaxInformations<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof PurchRfqLineTransTaxInformations,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        PurchRfqLineTransTaxInformations,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    TAX_WITHHOLD_ACKNOWLEDGEMENT_NUMBER: OrderableEdmTypeField<
      PurchRfqLineTransTaxInformations<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
      true
    >;
    RFQ_ID: OrderableEdmTypeField<
      PurchRfqLineTransTaxInformations<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    EXCISE_IS_SCRAP: EnumField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<PurchRfqLineTransTaxInformations<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link rfqId} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        RFQ_ID: fieldBuilder.buildEdmTypeField('RFQId', 'Edm.String', true),
        /**
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PurchRfqLineTransTaxInformations)
      };
    }
