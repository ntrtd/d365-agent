...
import type { InventoryMovementJournalEntriesV2Api } from './InventoryMovementJournalEntriesV2Api';
...
import {
  ...
  InventoryMovementJournalHeadersType
} from './InventoryMovementJournalHeaders';

/**
 * This class represents the entity "InventoryMovementJournalEntriesV2" of service "d365_metadata".
 */
export class InventoryMovementJournalEntriesV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements InventoryMovementJournalEntriesV2Type<T>
{
  /**
   * Technical entity name for InventoryMovementJournalEntriesV2.
   */
  static override _entityName = 'InventoryMovementJournalEntriesV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the InventoryMovementJournalEntriesV2 entity.
   */
  static _keys = [
    'dataAreaId',
    'JournalNumber',
  ...
  /**
   * One-to-one navigation property to the {@link InventoryMovementJournalHeaders} entity.
   */
  declare inventoryMovementJournalHeader?: InventoryMovementJournalHeaders<T> | null;

  constructor(_entityApi: InventoryMovementJournalEntriesV2Api<T>) {
    super(_entityApi);
  }
}

export interface InventoryMovementJournalEntriesV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  inventoryMovementJournalHeader?: InventoryMovementJournalHeadersType<T> | null;
}
