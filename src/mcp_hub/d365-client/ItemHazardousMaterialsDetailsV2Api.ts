...
import { ItemHazardousMaterialsDetailsV2RequestBuilder } from './ItemHazardousMaterialsDetailsV2RequestBuilder';
...
export class ItemHazardousMaterialsDetailsV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<ItemHazardousMaterialsDetailsV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): ItemHazardousMaterialsDetailsV2Api<DeSerializersT> {
    return new ItemHazardousMaterialsDetailsV2Api(deSerializers);
  }
  ...
  entityConstructor = ItemHazardousMaterialsDetailsV2;

  requestBuilder(): ItemHazardousMaterialsDetailsV2RequestBuilder<DeSerializersT> {
    return new ItemHazardousMaterialsDetailsV2RequestBuilder<DeSerializersT>(
      this
    );
  }

  entityBuilder(): EntityBuilderType<
    ItemHazardousMaterialsDetailsV2<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof ItemHazardousMaterialsDetailsV2,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        ItemHazardousMaterialsDetailsV2,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ItemHazardousMaterialsDetailsV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    PACK_CODE: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<ItemHazardousMaterialsDetailsV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ItemHazardousMaterialsDetailsV2)
      };
    }
