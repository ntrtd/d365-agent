...
import type { EngineeringChangeOrderProductsV2Api } from './EngineeringChangeOrderProductsV2Api';
...
/**
 * This class represents the entity "EngineeringChangeOrderProductsV2" of service "d365_metadata".
 */
export class EngineeringChangeOrderProductsV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements EngineeringChangeOrderProductsV2Type<T>
{
  /**
   * Technical entity name for EngineeringChangeOrderProductsV2.
   */
  static override _entityName = 'EngineeringChangeOrderProductsV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the EngineeringChangeOrderProductsV2 entity.
   */
  ...
  constructor(_entityApi: EngineeringChangeOrderProductsV2Api<T>) {
    super(_entityApi);
  }
}

export interface EngineeringChangeOrderProductsV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
