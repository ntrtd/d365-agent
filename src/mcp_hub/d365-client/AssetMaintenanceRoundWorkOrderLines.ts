...
import type { AssetMaintenanceRoundWorkOrderLinesApi } from './AssetMaintenanceRoundWorkOrderLinesApi';
...
/**
 * This class represents the entity "AssetMaintenanceRoundWorkOrderLines" of service "d365_metadata".
 */
export class AssetMaintenanceRoundWorkOrderLines<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements AssetMaintenanceRoundWorkOrderLinesType<T>
{
  /**
   * Technical entity name for AssetMaintenanceRoundWorkOrderLines.
   */
  static override _entityName = 'AssetMaintenanceRoundWorkOrderLines';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the AssetMaintenanceRoundWorkOrderLines entity.
   */
  ...
  /**
   * Maintenance Round Id.
   * @nullable
   */
  declare maintenanceRoundId?: DeserializedType<T, 'Edm.String'> | null;
  /**
   ...
   */
  declare roundWorkOrderJobDocumentAttacment?: MaintenanceWorkOrderLineDocumentAttachments<T> | null;
  /**
   * One-to-many navigation property to the {@link AssetMaintenanceAssetBillOfMaterialsV2} entity.
   */
  declare maintenanceAssetBillOfMaterialsMaintenanceRoundWorkOrderJob: AssetMaintenanceAssetBillOfMaterialsV2<T>[];
  /**
   ...
   */
  declare maintenanceRound?: AssetMaintenanceRounds<T> | null;
  /**
   * One-to-one navigation property to the {@link AssetMaintenanceAssetsV3} entity.
   */
   ...
   */
  declare maintenanceWorkOrderJobChecklistHeadersMaintenanceRoundWorkOrderJob: AssetMaintenanceWorkOrderJobChecklistHeadersV2<T>[];

  constructor(_entityApi: AssetMaintenanceRoundWorkOrderLinesApi<T>) {
    super(_entityApi);
  }
}

export interface AssetMaintenanceRoundWorkOrderLinesType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  maintenanceRoundId?: DeserializedType<T, 'Edm.String'> | null;
  ...
  roundWorkOrderJobDocumentAttacment?: MaintenanceWorkOrderLineDocumentAttachmentsType<T> | null;
  maintenanceAssetBillOfMaterialsMaintenanceRoundWorkOrderJob: AssetMaintenanceAssetBillOfMaterialsV2Type<T>[];
  ...
  maintenanceRound?: AssetMaintenanceRoundsType<T> | null;
  asset?: AssetMaintenanceAssetsV3Type<T> | null;
  maintenanceWorkOrderJobChecklistHeadersMaintenanceRoundWorkOrderJob: AssetMaintenanceWorkOrderJobChecklistHeadersV2Type<T>[];
}
