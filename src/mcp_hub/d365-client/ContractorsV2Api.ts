...
import { ContractorsV2RequestBuilder } from './ContractorsV2RequestBuilder';
...
export class ContractorsV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<ContractorsV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new ContractorsV2Api(deSerializers);
  }
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ...
      NATIVE_LANGUAGE: new OneToOneLink('NativeLanguage', this, linkedApis[5]),
      WORK_CALENDAR: new OneToOneLink('WorkCalendar', this, linkedApis[6])
    };
    return this;
  }

  entityConstructor = ContractorsV2;

  requestBuilder(): ContractorsV2RequestBuilder<DeSerializersT> {
    return new ContractorsV2RequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<ContractorsV2<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<ContractorsV2<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof ContractorsV2, DeSerializersT>;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(ContractorsV2, this.deSerializers);
    }
  ...
  private _schema?: {
    ...
    ELECTRONIC_LOCATION_ID: OrderableEdmTypeField<
      ...
      true
    >;
    CONTRACTOR_VENDOR_DATA_AREA: OrderableEdmTypeField<
      ContractorsV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
      true
    >;
    CONTRACTOR_DETAILS_EFFECTIVE: OrderableEdmTypeField<
      ContractorsV2<DeSerializers>,
      DeSerializersT,
      'Edm.DateTimeOffset',
      false,
    ...
    CALENDAR_DATA_AREA_ID: OrderableEdmTypeField<
      ...
      true
    >;
    CONTRACTOR_VENDOR_ID: OrderableEdmTypeField<
      ContractorsV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
      true
    >;
    CONTRACTOR_PURCHASE_REQUISITION_ID: OrderableEdmTypeField<
      ContractorsV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
      true
    >;
    CONTRACTOR_DETAILS_EXPIRATION: OrderableEdmTypeField<
      ContractorsV2<DeSerializers>,
      DeSerializersT,
      'Edm.DateTimeOffset',
      false,
    ...
    CALENDAR_ID: OrderableEdmTypeField<
      ...
      true
    >;
    CONTRACTOR_PURCHASE_ORDER_ID: OrderableEdmTypeField<
      ContractorsV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    WORK_CALENDAR: OneToOneLink<
      ...
      WorkCalendarsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<ContractorsV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link contractorVendorDataArea} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CONTRACTOR_VENDOR_DATA_AREA: fieldBuilder.buildEdmTypeField(
          'ContractorVendorDataArea',
          'Edm.String',
          true
        ),
        /**
         * Static representation of the {@link contractorDetailsEffective} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CONTRACTOR_DETAILS_EFFECTIVE: fieldBuilder.buildEdmTypeField(
          'ContractorDetailsEffective',
          'Edm.DateTimeOffset',
          false
        ),
        /**
        ...
        /**
         * Static representation of the {@link contractorVendorId} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CONTRACTOR_VENDOR_ID: fieldBuilder.buildEdmTypeField(
          'ContractorVendorId',
          'Edm.String',
          true
        ),
        /**
         * Static representation of the {@link contractorPurchaseRequisitionId} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CONTRACTOR_PURCHASE_REQUISITION_ID: fieldBuilder.buildEdmTypeField(
          'ContractorPurchaseRequisitionId',
          'Edm.String',
          true
        ),
        /**
         * Static representation of the {@link contractorDetailsExpiration} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CONTRACTOR_DETAILS_EXPIRATION: fieldBuilder.buildEdmTypeField(
          'ContractorDetailsExpiration',
          'Edm.DateTimeOffset',
          false
        ),
        /**
        ...
        /**
         * Static representation of the {@link contractorPurchaseOrderId} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CONTRACTOR_PURCHASE_ORDER_ID: fieldBuilder.buildEdmTypeField(
          'ContractorPurchaseOrderId',
          'Edm.String',
          true
        ),
        ...this.navigationPropertyFields,
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ContractorsV2)
      };
    }
