...
import { CdsInventoryChargesRequestBuilder } from './CdsInventoryChargesRequestBuilder';
...
export class CdsInventoryChargesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<CdsInventoryCharges<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): CdsInventoryChargesApi<DeSerializersT> {
    return new CdsInventoryChargesApi(deSerializers);
  }
  ...
  entityConstructor = CdsInventoryCharges;

  requestBuilder(): CdsInventoryChargesRequestBuilder<DeSerializersT> {
    return new CdsInventoryChargesRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    CdsInventoryCharges<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<CdsInventoryCharges<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      CdsInventoryCharges<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    CREDIT_POSTING_TYPE: EnumField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<CdsInventoryCharges<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', CdsInventoryCharges)
      };
    }
