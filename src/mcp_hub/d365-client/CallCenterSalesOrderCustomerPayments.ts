...
import type { CallCenterSalesOrderCustomerPaymentsApi } from './CallCenterSalesOrderCustomerPaymentsApi';
import { NoYes } from './NoYes';
import { McrCustPaymStatus } from './McrCustPaymStatus';
import { McrCustPaymType } from './McrCustPaymType';

/**
 * This class represents the entity "CallCenterSalesOrderCustomerPayments" of service "d365_metadata".
 */
export class CallCenterSalesOrderCustomerPayments<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements CallCenterSalesOrderCustomerPaymentsType<T>
{
  /**
   * Technical entity name for CallCenterSalesOrderCustomerPayments.
   */
  static override _entityName = 'CallCenterSalesOrderCustomerPayments';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the CallCenterSalesOrderCustomerPayments entity.
   */
  static _keys = ['dataAreaId', 'LineNumber', 'SalesOrderId'];
  /**
   * Data Area Id.
   */
  ...
  constructor(_entityApi: CallCenterSalesOrderCustomerPaymentsApi<T>) {
    super(_entityApi);
  }
}

export interface CallCenterSalesOrderCustomerPaymentsType<
  T extends DeSerializers = DefaultDeSerializers
> {
