...
import type { PositionDetailsApi } from './PositionDetailsApi';
...
/**
 * This class represents the entity "PositionDetails" of service "d365_metadata".
 */
export class PositionDetails<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements PositionDetailsType<T>
{
  /**
   * Technical entity name for PositionDetails.
   */
  static override _entityName = 'PositionDetails';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the PositionDetails entity.
   */
  ...
  constructor(_entityApi: PositionDetailsApi<T>) {
    super(_entityApi);
  }
}
