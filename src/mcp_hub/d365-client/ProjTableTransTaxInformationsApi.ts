...
import { ProjTableTransTaxInformationsRequestBuilder } from './ProjTableTransTaxInformationsRequestBuilder';
...
export class ProjTableTransTaxInformationsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<ProjTableTransTaxInformations<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): ProjTableTransTaxInformationsApi<DeSerializersT> {
    return new ProjTableTransTaxInformationsApi(deSerializers);
  }
  ...
  entityConstructor = ProjTableTransTaxInformations;

  requestBuilder(): ProjTableTransTaxInformationsRequestBuilder<DeSerializersT> {
    return new ProjTableTransTaxInformationsRequestBuilder<DeSerializersT>(
      this
    );
  }

  entityBuilder(): EntityBuilderType<
    ProjTableTransTaxInformations<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof ProjTableTransTaxInformations,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        ProjTableTransTaxInformations,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ProjTableTransTaxInformations<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    EXCISE_IS_SCRAP: EnumField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<ProjTableTransTaxInformations<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ProjTableTransTaxInformations)
      };
    }
