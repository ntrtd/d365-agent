...
import { ProjInvoiceChorusProDetailsRequestBuilder } from './ProjInvoiceChorusProDetailsRequestBuilder';
import {
  CustomField,
...
export class ProjInvoiceChorusProDetailsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<ProjInvoiceChorusProDetails<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): ProjInvoiceChorusProDetailsApi<DeSerializersT> {
    return new ProjInvoiceChorusProDetailsApi(deSerializers);
  }
  ...
  entityConstructor = ProjInvoiceChorusProDetails;

  requestBuilder(): ProjInvoiceChorusProDetailsRequestBuilder<DeSerializersT> {
    return new ProjInvoiceChorusProDetailsRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    ProjInvoiceChorusProDetails<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof ProjInvoiceChorusProDetails,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        ProjInvoiceChorusProDetails,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ProjInvoiceChorusProDetails<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    CHORUS_PRO_INVOICE_STATUS: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<ProjInvoiceChorusProDetails<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ProjInvoiceChorusProDetails)
      };
    }
