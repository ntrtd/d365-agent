...
import type { InventoryMovementJournalHeadersApi } from './InventoryMovementJournalHeadersApi';
...
/**
 * This class represents the entity "InventoryMovementJournalHeaders" of service "d365_metadata".
 */
export class InventoryMovementJournalHeaders<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements InventoryMovementJournalHeadersType<T>
{
  /**
   * Technical entity name for InventoryMovementJournalHeaders.
   */
  static override _entityName = 'InventoryMovementJournalHeaders';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the InventoryMovementJournalHeaders entity.
   */
   ...
   */
  declare inventoryMovementJournalLine: InventoryMovementJournalEntriesV2<T>[];

  constructor(_entityApi: InventoryMovementJournalHeadersApi<T>) {
    super(_entityApi);
  }
}

export interface InventoryMovementJournalHeadersType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  inventoryMovementJournalLine: InventoryMovementJournalEntriesV2Type<T>[];
}
