...
import { PurchAgreementPaymentOrdersRequestBuilder } from './PurchAgreementPaymentOrdersRequestBuilder';
...
export class PurchAgreementPaymentOrdersApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<PurchAgreementPaymentOrders<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): PurchAgreementPaymentOrdersApi<DeSerializersT> {
    return new PurchAgreementPaymentOrdersApi(deSerializers);
  }
  ...
  entityConstructor = PurchAgreementPaymentOrders;

  requestBuilder(): PurchAgreementPaymentOrdersRequestBuilder<DeSerializersT> {
    return new PurchAgreementPaymentOrdersRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    PurchAgreementPaymentOrders<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof PurchAgreementPaymentOrders,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        PurchAgreementPaymentOrders,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    LEGAL_ENTITY: OrderableEdmTypeField<
      PurchAgreementPaymentOrders<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    >;
    PURCHASE_AGREEMENT: OrderableEdmTypeField<
      PurchAgreementPaymentOrders<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
    ...
    PERIOD_NUMBER: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<PurchAgreementPaymentOrders<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link purchaseAgreement} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PURCHASE_AGREEMENT: fieldBuilder.buildEdmTypeField(
          'PurchaseAgreement',
          'Edm.String',
          false
        ),
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PurchAgreementPaymentOrders)
      };
    }
