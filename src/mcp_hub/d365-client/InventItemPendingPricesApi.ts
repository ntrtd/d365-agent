...
import { InventItemPendingPricesRequestBuilder } from './InventItemPendingPricesRequestBuilder';
...
export class InventItemPendingPricesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<InventItemPendingPrices<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): InventItemPendingPricesApi<DeSerializersT> {
    return new InventItemPendingPricesApi(deSerializers);
  }
  ...
  entityConstructor = InventItemPendingPrices;

  requestBuilder(): InventItemPendingPricesRequestBuilder<DeSerializersT> {
    return new InventItemPendingPricesRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    InventItemPendingPrices<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof InventItemPendingPrices,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        InventItemPendingPrices,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      InventItemPendingPrices<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    IS_PRICE_INCLUDING_CHARGES: EnumField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<InventItemPendingPrices<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', InventItemPendingPrices)
      };
    }
