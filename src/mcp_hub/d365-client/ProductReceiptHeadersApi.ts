...
import { ProductReceiptHeadersRequestBuilder } from './ProductReceiptHeadersRequestBuilder';
import { ProductReceiptLinesV2Api } from './ProductReceiptLinesV2Api';
...
export class ProductReceiptHeadersApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<ProductReceiptHeaders<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new ProductReceiptHeadersApi(deSerializers);
  }

  private navigationPropertyFields!: {
    /**
     * Static representation of the one-to-many navigation property {@link productReceiptLines} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PRODUCT_RECEIPT_LINES: OneToManyLink<
      ProductReceiptHeaders<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    linkedApis: [ProductReceiptLinesV2Api<DeSerializersT>]
  ): this {
    this.navigationPropertyFields = {
      PRODUCT_RECEIPT_LINES: new OneToManyLink(
        'ProductReceiptLines',
        this,
        linkedApis[0]
      )
  ...
  entityConstructor = ProductReceiptHeaders;

  requestBuilder(): ProductReceiptHeadersRequestBuilder<DeSerializersT> {
    return new ProductReceiptHeadersRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<ProductReceiptHeaders<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ProductReceiptHeaders<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    PRODUCT_RECEIPT_LINES: OneToManyLink<
      ...
      ProductReceiptLinesV2Api<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<ProductReceiptHeaders<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ProductReceiptHeaders)
      };
    }
