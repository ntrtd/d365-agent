...
import { PartyLocationPostalAddressesV2RequestBuilder } from './PartyLocationPostalAddressesV2RequestBuilder';
...
export class PartyLocationPostalAddressesV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<PartyLocationPostalAddressesV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): PartyLocationPostalAddressesV2Api<DeSerializersT> {
    return new PartyLocationPostalAddressesV2Api(deSerializers);
  }
  ...
  entityConstructor = PartyLocationPostalAddressesV2;

  requestBuilder(): PartyLocationPostalAddressesV2RequestBuilder<DeSerializersT> {
    return new PartyLocationPostalAddressesV2RequestBuilder<DeSerializersT>(
      this
    );
  }

  entityBuilder(): EntityBuilderType<
    PartyLocationPostalAddressesV2<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof PartyLocationPostalAddressesV2,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    PARTY_NUMBER: OrderableEdmTypeField<
      PartyLocationPostalAddressesV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    COUNTRY_REGION_ISO_CODE: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<PartyLocationPostalAddressesV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PartyLocationPostalAddressesV2)
      };
    }
