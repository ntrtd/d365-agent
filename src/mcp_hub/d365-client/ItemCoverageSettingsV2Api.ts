...
import { ItemCoverageSettingsV2RequestBuilder } from './ItemCoverageSettingsV2RequestBuilder';
...
export class ItemCoverageSettingsV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<ItemCoverageSettingsV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): ItemCoverageSettingsV2Api<DeSerializersT> {
    return new ItemCoverageSettingsV2Api(deSerializers);
  }
  ...
  entityConstructor = ItemCoverageSettingsV2;

  requestBuilder(): ItemCoverageSettingsV2RequestBuilder<DeSerializersT> {
    return new ItemCoverageSettingsV2RequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    ItemCoverageSettingsV2<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ItemCoverageSettingsV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    ORDER_CYCLE: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<ItemCoverageSettingsV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ItemCoverageSettingsV2)
      };
    }
