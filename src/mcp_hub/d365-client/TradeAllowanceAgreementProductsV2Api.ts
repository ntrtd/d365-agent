...
import { TradeAllowanceAgreementProductsV2RequestBuilder } from './TradeAllowanceAgreementProductsV2RequestBuilder';
...
export class TradeAllowanceAgreementProductsV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<TradeAllowanceAgreementProductsV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new TradeAllowanceAgreementProductsV2Api(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    PROMOTIONAL_PRODUCT_UNIT_OF_MEASURE: OneToOneLink<
      TradeAllowanceAgreementProductsV2<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = TradeAllowanceAgreementProductsV2;

  requestBuilder(): TradeAllowanceAgreementProductsV2RequestBuilder<DeSerializersT> {
    return new TradeAllowanceAgreementProductsV2RequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof TradeAllowanceAgreementProductsV2,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      TradeAllowanceAgreementProductsV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    TRADE_ALLOWANCE_AGREEMENT_HEADER: OneToOneLink<
      ...
      TradeAllowanceAgreementHeadersApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<TradeAllowanceAgreementProductsV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', TradeAllowanceAgreementProductsV2)
      };
    }
