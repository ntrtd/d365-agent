...
import { PartyContactsV2RequestBuilder } from './PartyContactsV2RequestBuilder';
...
export class PartyContactsV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<PartyContactsV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new PartyContactsV2Api(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    CDS_PARTY: OneToOneLink<
      PartyContactsV2<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = PartyContactsV2;

  requestBuilder(): PartyContactsV2RequestBuilder<DeSerializersT> {
    return new PartyContactsV2RequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<PartyContactsV2<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<PartyContactsV2<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof PartyContactsV2, DeSerializersT>;
  get fieldBuilder() {
  ...
  private _schema?: {
    ...
    CDS_PARTY: OneToOneLink<
      ...
      CdsPartiesApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<PartyContactsV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PartyContactsV2)
      };
    }
