...
import { WhsSourceSystemItemInventoryUpdateLogsRequestBuilder } from './WhsSourceSystemItemInventoryUpdateLogsRequestBuilder';
...
export class WhsSourceSystemItemInventoryUpdateLogsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      WhsSourceSystemItemInventoryUpdateLogs<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): WhsSourceSystemItemInventoryUpdateLogsApi<DeSerializersT> {
    return new WhsSourceSystemItemInventoryUpdateLogsApi(deSerializers);
  }
  ...
  entityConstructor = WhsSourceSystemItemInventoryUpdateLogs;

  requestBuilder(): WhsSourceSystemItemInventoryUpdateLogsRequestBuilder<DeSerializersT> {
    return new WhsSourceSystemItemInventoryUpdateLogsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof WhsSourceSystemItemInventoryUpdateLogs,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        WhsSourceSystemItemInventoryUpdateLogs,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      WhsSourceSystemItemInventoryUpdateLogs<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', WhsSourceSystemItemInventoryUpdateLogs)
      };
    }
