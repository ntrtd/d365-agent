...
import type { TransactionBankedTenderTransApi } from './TransactionBankedTenderTransApi';
import { NoYes } from './NoYes';
import { RetailEntryStatus } from './RetailEntryStatus';
import { RetailBankedStatusTypeBase } from './RetailBankedStatusTypeBase';

/**
 * This class represents the entity "TransactionBankedTenderTrans" of service "d365_metadata".
 */
export class TransactionBankedTenderTrans<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements TransactionBankedTenderTransType<T>
{
  /**
   * Technical entity name for TransactionBankedTenderTrans.
   */
  static override _entityName = 'TransactionBankedTenderTrans';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the TransactionBankedTenderTrans entity.
   */
  static _keys = [
    'dataAreaId',
    'RetailChannelId',
   ...
   * @nullable
   */
  declare bankBagNumber?: DeserializedType<T, 'Edm.String'> | null;
  /**
   * Banked Status Type.
   * @nullable
   */
  declare bankedStatusType?: RetailBankedStatusTypeBase | null;
  /**
   * Change Line.
   * @nullable
   */
  ...
  constructor(_entityApi: TransactionBankedTenderTransApi<T>) {
    super(_entityApi);
  }
}

export interface TransactionBankedTenderTransType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  bankBagNumber?: DeserializedType<T, 'Edm.String'> | null;
  bankedStatusType?: RetailBankedStatusTypeBase | null;
