...
import type { RetailTransactionSalesLinesApi } from './RetailTransactionSalesLinesApi';
...
/**
 * This class represents the entity "RetailTransactionSalesLines" of service "d365_metadata".
 */
export class RetailTransactionSalesLines<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements RetailTransactionSalesLinesType<T>
{
  /**
   * Technical entity name for RetailTransactionSalesLines.
   */
  static override _entityName = 'RetailTransactionSalesLines';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the RetailTransactionSalesLines entity.
   */
  static _keys = [
    'dataAreaId',
    'Terminal',
  ...
  constructor(_entityApi: RetailTransactionSalesLinesApi<T>) {
    super(_entityApi);
  }
}

export interface RetailTransactionSalesLinesType<
  T extends DeSerializers = DefaultDeSerializers
> {
