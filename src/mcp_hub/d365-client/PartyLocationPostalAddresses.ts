...
import type { PartyLocationPostalAddressesApi } from './PartyLocationPostalAddressesApi';
import { NoYes } from './NoYes';
import { Timezone } from './Timezone';

/**
 * This class represents the entity "PartyLocationPostalAddresses" of service "d365_metadata".
 */
export class PartyLocationPostalAddresses<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements PartyLocationPostalAddressesType<T>
{
  /**
   * Technical entity name for PartyLocationPostalAddresses.
   */
  static override _entityName = 'PartyLocationPostalAddresses';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the PartyLocationPostalAddresses entity.
   */
  ...
  constructor(_entityApi: PartyLocationPostalAddressesApi<T>) {
    super(_entityApi);
  }
}

export interface PartyLocationPostalAddressesType<
  T extends DeSerializers = DefaultDeSerializers
> {
