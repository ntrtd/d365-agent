...
import { SalesInvoiceV2LinesRequestBuilder } from './SalesInvoiceV2LinesRequestBuilder';
...
export class SalesInvoiceV2LinesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<SalesInvoiceV2Lines<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new SalesInvoiceV2LinesApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    SALES_INVOICE_HEADER_V_2: OneToOneLink<
      SalesInvoiceV2Lines<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    linkedApis: [SalesInvoiceHeadersV2Api<DeSerializersT>]
  ): this {
  ...
  entityConstructor = SalesInvoiceV2Lines;

  requestBuilder(): SalesInvoiceV2LinesRequestBuilder<DeSerializersT> {
    return new SalesInvoiceV2LinesRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<SalesInvoiceV2Lines<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      SalesInvoiceV2Lines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    SALES_INVOICE_HEADER_V_2: OneToOneLink<
      ...
      SalesInvoiceHeadersV2Api<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<SalesInvoiceV2Lines<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', SalesInvoiceV2Lines)
      };
    }
