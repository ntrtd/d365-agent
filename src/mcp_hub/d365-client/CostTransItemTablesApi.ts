...
import { CostTransItemTablesRequestBuilder } from './CostTransItemTablesRequestBuilder';
...
export class CostTransItemTablesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<CostTransItemTables<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): CostTransItemTablesApi<DeSerializersT> {
    return new CostTransItemTablesApi(deSerializers);
  }
  ...
  entityConstructor = CostTransItemTables;

  requestBuilder(): CostTransItemTablesRequestBuilder<DeSerializersT> {
    return new CostTransItemTablesRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    CostTransItemTables<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<CostTransItemTables<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      CostTransItemTables<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    TAX_ITEM_GROUP: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<CostTransItemTables<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', CostTransItemTables)
      };
    }
