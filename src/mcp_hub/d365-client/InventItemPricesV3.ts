...
import type { InventItemPricesV3Api } from './InventItemPricesV3Api';
import { CostingVersionPriceType } from './CostingVersionPriceType';
import { NoYes } from './NoYes';

/**
 * This class represents the entity "InventItemPricesV3" of service "d365_metadata".
 */
export class InventItemPricesV3<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements InventItemPricesV3Type<T>
{
  /**
   * Technical entity name for InventItemPricesV3.
   */
  static override _entityName = 'InventItemPricesV3';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the InventItemPricesV3 entity.
   */
  static _keys = [
    'dataAreaId',
    'ItemNumber',
  ...
  constructor(_entityApi: InventItemPricesV3Api<T>) {
    super(_entityApi);
  }
}

export interface InventItemPricesV3Type<
