...
import { CallCenterCustomerCreditPaymentsRequestBuilder } from './CallCenterCustomerCreditPaymentsRequestBuilder';
...
export class CallCenterCustomerCreditPaymentsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<CallCenterCustomerCreditPayments<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): CallCenterCustomerCreditPaymentsApi<DeSerializersT> {
    return new CallCenterCustomerCreditPaymentsApi(deSerializers);
  }
  ...
  entityConstructor = CallCenterCustomerCreditPayments;

  requestBuilder(): CallCenterCustomerCreditPaymentsRequestBuilder<DeSerializersT> {
    return new CallCenterCustomerCreditPaymentsRequestBuilder<DeSerializersT>(
      this
    );
  }

  entityBuilder(): EntityBuilderType<
    CallCenterCustomerCreditPayments<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof CallCenterCustomerCreditPayments,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        CallCenterCustomerCreditPayments,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      CallCenterCustomerCreditPayments<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    LINE_NUMBER: OrderableEdmTypeField<
      ...
      true
    >;
    CUSTOMER_CREDIT_ID: OrderableEdmTypeField<
      CallCenterCustomerCreditPayments<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
    ...
    PAYMENT_SCHED_ID: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<CallCenterCustomerCreditPayments<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link customerCreditId} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CUSTOMER_CREDIT_ID: fieldBuilder.buildEdmTypeField(
          'CustomerCreditId',
          'Edm.String',
          false
        ),
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', CallCenterCustomerCreditPayments)
      };
    }
