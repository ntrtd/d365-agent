...
import { ProductAllocationLinesV2RequestBuilder } from './ProductAllocationLinesV2RequestBuilder';
...
export class ProductAllocationLinesV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<ProductAllocationLinesV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new ProductAllocationLinesV2Api(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    PRODUCT_STYLE: OneToOneLink<
      ProductAllocationLinesV2<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ...
      PRODUCT_VERSION: new OneToOneLink('ProductVersion', this, linkedApis[4])
    };
    return this;
  }

  entityConstructor = ProductAllocationLinesV2;

  requestBuilder(): ProductAllocationLinesV2RequestBuilder<DeSerializersT> {
    return new ProductAllocationLinesV2RequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof ProductAllocationLinesV2,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ProductAllocationLinesV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    LINE_NUMBER: OrderableEdmTypeField<
      ...
      true
    >;
    PRODUCT_ALLOCATION_PERCENTAGE: OrderableEdmTypeField<
      ProductAllocationLinesV2<DeSerializers>,
      DeSerializersT,
      'Edm.Decimal',
      false,
    ...
    PRODUCT_VERSION: OneToOneLink<
      ...
      ProductVersionsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<ProductAllocationLinesV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link productAllocationPercentage} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PRODUCT_ALLOCATION_PERCENTAGE: fieldBuilder.buildEdmTypeField(
          'ProductAllocationPercentage',
          'Edm.Decimal',
          false
        ),
        ...this.navigationPropertyFields,
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ProductAllocationLinesV2)
      };
    }
