...
import type { TimesheetLineTransTaxInformationsApi } from './TimesheetLineTransTaxInformationsApi';
...
/**
 * This class represents the entity "TimesheetLineTransTaxInformations" of service "d365_metadata".
 */
export class TimesheetLineTransTaxInformations<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements TimesheetLineTransTaxInformationsType<T>
{
  /**
   * Technical entity name for TimesheetLineTransTaxInformations.
   */
  static override _entityName = 'TimesheetLineTransTaxInformations';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the TimesheetLineTransTaxInformations entity.
   */
  static _keys = ['dataAreaId', 'TimesheetNbr', 'LineNum'];
  /**
   * Data Area Id.
   */
   ...
   * Timesheet Nbr.
   */
  declare timesheetNbr: DeserializedType<T, 'Edm.String'>;
  /**
   * Line Num.
   */
  ...
  constructor(_entityApi: TimesheetLineTransTaxInformationsApi<T>) {
    super(_entityApi);
  }
}

export interface TimesheetLineTransTaxInformationsType<
  T extends DeSerializers = DefaultDeSerializers
> {
