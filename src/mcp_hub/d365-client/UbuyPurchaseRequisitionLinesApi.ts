...
import { UbuyPurchaseRequisitionLinesRequestBuilder } from './UbuyPurchaseRequisitionLinesRequestBuilder';
import { DimensionSetsApi } from './DimensionSetsApi';
import { ProjectsApi } from './ProjectsApi';
import { UbuyPurchaseRequisitionHeadersApi } from './UbuyPurchaseRequisitionHeadersApi';
...
export class UbuyPurchaseRequisitionLinesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<UbuyPurchaseRequisitionLines<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new UbuyPurchaseRequisitionLinesApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    DIMENSION_SET: OneToOneLink<
      UbuyPurchaseRequisitionLines<DeSerializersT>,
      DeSerializersT,
    ...
    >;
    /**
     * Static representation of the one-to-one navigation property {@link ubuyPurchaseRequisitionHeader} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    UBUY_PURCHASE_REQUISITION_HEADER: OneToOneLink<
      UbuyPurchaseRequisitionLines<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ...
      UBUY_PURCHASE_REQUISITION_HEADER: new OneToOneLink(
        'UbuyPurchaseRequisitionHeader',
        this,
        linkedApis[2]
      )
    };
  ...
  entityConstructor = UbuyPurchaseRequisitionLines;

  requestBuilder(): UbuyPurchaseRequisitionLinesRequestBuilder<DeSerializersT> {
    return new UbuyPurchaseRequisitionLinesRequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof UbuyPurchaseRequisitionLines,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    REQUISITION_NUMBER: OrderableEdmTypeField<
      UbuyPurchaseRequisitionLines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    UBUY_PURCHASE_REQUISITION_HEADER: OneToOneLink<
      ...
      UbuyPurchaseRequisitionHeadersApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<UbuyPurchaseRequisitionLines<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', UbuyPurchaseRequisitionLines)
      };
    }
