...
import type { InboundLoadPackingStructureCaseLinesV3Api } from './InboundLoadPackingStructureCaseLinesV3Api';
import {
...
/**
 * This class represents the entity "InboundLoadPackingStructureCaseLinesV3" of service "d365_metadata".
 */
export class InboundLoadPackingStructureCaseLinesV3<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements InboundLoadPackingStructureCaseLinesV3Type<T>
{
  /**
   * Technical entity name for InboundLoadPackingStructureCaseLinesV3.
   */
  static override _entityName = 'InboundLoadPackingStructureCaseLinesV3';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the InboundLoadPackingStructureCaseLinesV3 entity.
   */
  static _keys = [
    'dataAreaId',
    'InboundShipmentId',
  ...
  constructor(_entityApi: InboundLoadPackingStructureCaseLinesV3Api<T>) {
    super(_entityApi);
  }
}

export interface InboundLoadPackingStructureCaseLinesV3Type<
  T extends DeSerializers = DefaultDeSerializers
> {
