...
> extends RequestBuilder<WarehouseLocations<T>, T> {
   ...
   * @param dataAreaId Key property. See {@link WarehouseLocations.dataAreaId}.
   * @param warehouseId Key property. See {@link WarehouseLocations.warehouseId}.
   * @param warehouseLocationId Key property. See {@link WarehouseLocations.warehouseLocationId}.
  ...
  delete(
    ...
    return new DeleteRequestBuilder<WarehouseLocations<T>, T>(
      this.entityApi,
      dataAreaIdOrEntity instanceof WarehouseLocations
        ? dataAreaIdOrEntity
        : {
