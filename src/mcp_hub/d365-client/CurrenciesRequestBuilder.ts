...
> extends RequestBuilder<Currencies<T>, T> {
   ...
   * @param currencyCode Key property. See {@link Currencies.currencyCode}.
   ...
   */
  delete(currencyCode: string): DeleteRequestBuilder<Currencies<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `Currencies`.
  ...
  delete(currencyCodeOrEntity: any): DeleteRequestBuilder<Currencies<T>, T> {
    return new DeleteRequestBuilder<Currencies<T>, T>(
      this.entityApi,
      currencyCodeOrEntity instanceof Currencies
