...
import type { LeaveRequestsApi } from './LeaveRequestsApi';
...
/**
 * This class represents the entity "LeaveRequests" of service "d365_metadata".
 */
export class LeaveRequests<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements LeaveRequestsType<T>
{
  /**
   * Technical entity name for LeaveRequests.
   */
  static override _entityName = 'LeaveRequests';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the LeaveRequests entity.
   */
  ...
  /**
   * One-to-one navigation property to the {@link LeaveTypeReasonCodes} entity.
   */
  declare typeReasonCode?: LeaveTypeReasonCodes<T> | null;
  /**
   * One-to-one navigation property to the {@link LeaveEnrollments} entity.
   */
  declare enrollment?: LeaveEnrollments<T> | null;

  constructor(_entityApi: LeaveRequestsApi<T>) {
    super(_entityApi);
  }
}
...
> {
  ...
  typeReasonCode?: LeaveTypeReasonCodesType<T> | null;
  enrollment?: LeaveEnrollmentsType<T> | null;
}
