...
import { ShipConsolidationTemplatesV3RequestBuilder } from './ShipConsolidationTemplatesV3RequestBuilder';
...
export class ShipConsolidationTemplatesV3Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<ShipConsolidationTemplatesV3<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): ShipConsolidationTemplatesV3Api<DeSerializersT> {
    return new ShipConsolidationTemplatesV3Api(deSerializers);
  }
  ...
  entityConstructor = ShipConsolidationTemplatesV3;

  requestBuilder(): ShipConsolidationTemplatesV3RequestBuilder<DeSerializersT> {
    return new ShipConsolidationTemplatesV3RequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    ShipConsolidationTemplatesV3<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof ShipConsolidationTemplatesV3,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        ShipConsolidationTemplatesV3,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ShipConsolidationTemplatesV3<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    ORIGIN_COUNTRY_REGION_ID: OrderableEdmTypeField<
      ...
      true
    >;
    FILTER_QUERY_JSON: OrderableEdmTypeField<
      ShipConsolidationTemplatesV3<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    ORIGIN_OPERATIONAL_SITE_ID: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<ShipConsolidationTemplatesV3<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link filterQueryJson} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        FILTER_QUERY_JSON: fieldBuilder.buildEdmTypeField(
          'FilterQueryJson',
          'Edm.String',
          true
        ),
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ShipConsolidationTemplatesV3)
      };
    }
