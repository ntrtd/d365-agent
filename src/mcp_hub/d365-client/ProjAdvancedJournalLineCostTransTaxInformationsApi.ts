...
import { ProjAdvancedJournalLineCostTransTaxInformationsRequestBuilder } from './ProjAdvancedJournalLineCostTransTaxInformationsRequestBuilder';
...
export class ProjAdvancedJournalLineCostTransTaxInformationsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      ProjAdvancedJournalLineCostTransTaxInformations<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): ProjAdvancedJournalLineCostTransTaxInformationsApi<DeSerializersT> {
    return new ProjAdvancedJournalLineCostTransTaxInformationsApi(
      deSerializers
    );
  }
  ...
  entityConstructor = ProjAdvancedJournalLineCostTransTaxInformations;

  requestBuilder(): ProjAdvancedJournalLineCostTransTaxInformationsRequestBuilder<DeSerializersT> {
    return new ProjAdvancedJournalLineCostTransTaxInformationsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof ProjAdvancedJournalLineCostTransTaxInformations,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ProjAdvancedJournalLineCostTransTaxInformations<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
