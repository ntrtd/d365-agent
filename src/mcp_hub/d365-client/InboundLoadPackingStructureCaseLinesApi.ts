...
import { InboundLoadPackingStructureCaseLinesRequestBuilder } from './InboundLoadPackingStructureCaseLinesRequestBuilder';
...
export class InboundLoadPackingStructureCaseLinesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      InboundLoadPackingStructureCaseLines<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    ...
    return new InboundLoadPackingStructureCaseLinesApi(deSerializers);
  }
  ...
  entityConstructor = InboundLoadPackingStructureCaseLines;

  requestBuilder(): InboundLoadPackingStructureCaseLinesRequestBuilder<DeSerializersT> {
    return new InboundLoadPackingStructureCaseLinesRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof InboundLoadPackingStructureCaseLines,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      InboundLoadPackingStructureCaseLines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    LOAD_PACKING_STRUCTURE_CASE: OneToOneLink<
      ...
      InboundLoadPackingStructureCasesApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<InboundLoadPackingStructureCaseLines<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', InboundLoadPackingStructureCaseLines)
      };
    }
