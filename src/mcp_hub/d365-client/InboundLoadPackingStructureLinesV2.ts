...
import type { InboundLoadPackingStructureLinesV2Api } from './InboundLoadPackingStructureLinesV2Api';
import {
...
/**
 * This class represents the entity "InboundLoadPackingStructureLinesV2" of service "d365_metadata".
 */
export class InboundLoadPackingStructureLinesV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements InboundLoadPackingStructureLinesV2Type<T>
{
  /**
   * Technical entity name for InboundLoadPackingStructureLinesV2.
   */
  static override _entityName = 'InboundLoadPackingStructureLinesV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the InboundLoadPackingStructureLinesV2 entity.
   */
  static _keys = [
    'dataAreaId',
    'InboundShipmentId',
  ...
  constructor(_entityApi: InboundLoadPackingStructureLinesV2Api<T>) {
    super(_entityApi);
  }
}

export interface InboundLoadPackingStructureLinesV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
