...
import type { FormulaLinesV2Api } from './FormulaLinesV2Api';
...
/**
 * This class represents the entity "FormulaLinesV2" of service "d365_metadata".
 */
export class FormulaLinesV2<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements FormulaLinesV2Type<T>
{
  /**
   * Technical entity name for FormulaLinesV2.
   */
  static override _entityName = 'FormulaLinesV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the FormulaLinesV2 entity.
   */
  static _keys = ['dataAreaId', 'FormulaId', 'LineCreationSequenceNumber'];
  /**
   * Data Area Id.
   */
  ...
  constructor(_entityApi: FormulaLinesV2Api<T>) {
    super(_entityApi);
  }
}

export interface FormulaLinesV2Type<
