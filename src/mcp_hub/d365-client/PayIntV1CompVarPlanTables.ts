...
import type { PayIntV1CompVarPlanTablesApi } from './PayIntV1CompVarPlanTablesApi';
...
/**
 * This class represents the entity "PayIntV1CompVarPlanTables" of service "d365_metadata".
 */
export class PayIntV1CompVarPlanTables<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements PayIntV1CompVarPlanTablesType<T>
{
  /**
   * Technical entity name for PayIntV1CompVarPlanTables.
   */
  static override _entityName = 'PayIntV1CompVarPlanTables';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the PayIntV1CompVarPlanTables entity.
   */
  ...
  constructor(_entityApi: PayIntV1CompVarPlanTablesApi<T>) {
    super(_entityApi);
  }
}

export interface PayIntV1CompVarPlanTablesType<
  T extends DeSerializers = DefaultDeSerializers
> {
