...
import type { SalesOrderHeadersV3Api } from './SalesOrderHeadersV3Api';
...
/**
 * This class represents the entity "SalesOrderHeadersV3" of service "d365_metadata".
 */
export class SalesOrderHeadersV3<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements SalesOrderHeadersV3Type<T>
{
  /**
   * Technical entity name for SalesOrderHeadersV3.
   */
  static override _entityName = 'SalesOrderHeadersV3';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the SalesOrderHeadersV3 entity.
   */
  ...
  constructor(_entityApi: SalesOrderHeadersV3Api<T>) {
    super(_entityApi);
  }
}

export interface SalesOrderHeadersV3Type<
