...
import type { InboundLoadPackingStructureLinesApi } from './InboundLoadPackingStructureLinesApi';
import {
...
/**
 * This class represents the entity "InboundLoadPackingStructureLines" of service "d365_metadata".
 */
export class InboundLoadPackingStructureLines<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements InboundLoadPackingStructureLinesType<T>
{
  /**
   * Technical entity name for InboundLoadPackingStructureLines.
   */
  static override _entityName = 'InboundLoadPackingStructureLines';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the InboundLoadPackingStructureLines entity.
   */
  static _keys = [
    'dataAreaId',
    'InboundShipmentId',
  ...
  constructor(_entityApi: InboundLoadPackingStructureLinesApi<T>) {
    super(_entityApi);
  }
}

export interface InboundLoadPackingStructureLinesType<
  T extends DeSerializers = DefaultDeSerializers
> {
