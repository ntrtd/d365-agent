...
import { VendorRebateAgreementProductSelectionsRequestBuilder } from './VendorRebateAgreementProductSelectionsRequestBuilder';
import {
  CustomField,
...
export class VendorRebateAgreementProductSelectionsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      VendorRebateAgreementProductSelections<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): VendorRebateAgreementProductSelectionsApi<DeSerializersT> {
    return new VendorRebateAgreementProductSelectionsApi(deSerializers);
  }
  ...
  entityConstructor = VendorRebateAgreementProductSelections;

  requestBuilder(): VendorRebateAgreementProductSelectionsRequestBuilder<DeSerializersT> {
    return new VendorRebateAgreementProductSelectionsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof VendorRebateAgreementProductSelections,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        VendorRebateAgreementProductSelections,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      VendorRebateAgreementProductSelections<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', VendorRebateAgreementProductSelections)
      };
    }
