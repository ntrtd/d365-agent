...
import type { PayIntV1EmployeesV2Api } from './PayIntV1EmployeesV2Api';
...
/**
 * This class represents the entity "PayIntV1EmployeesV2" of service "d365_metadata".
 */
export class PayIntV1EmployeesV2<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements PayIntV1EmployeesV2Type<T>
{
  /**
   * Technical entity name for PayIntV1EmployeesV2.
   */
  static override _entityName = 'PayIntV1EmployeesV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the PayIntV1EmployeesV2 entity.
   */
  static _keys = ['PersonnelNumber', 'EmploymentLegalEntityId', 'EmploymentId'];
  /**
   * Personnel Number.
   */
  ...
  /**
   * Employee Details Effective.
   */
  declare employeeDetailsEffective: DeserializedType<T, 'Edm.DateTimeOffset'>;
  /**
   * Address State.
   * @nullable
   */
  ...
  /**
   * Employee Details Expiration.
   */
  declare employeeDetailsExpiration: DeserializedType<T, 'Edm.DateTimeOffset'>;
  /**
   * Address Zip Code.
   * @nullable
   */
   ...
   */
  declare relocationReimbursement: DeserializedType<T, 'Edm.Decimal'>;
  /**
   * Is Fulltime Student.
   * @nullable
   */
   ...
   * Pension Start.
   */
  declare pensionStart: DeserializedType<T, 'Edm.DateTimeOffset'>;
  /**
   * Pension Enrollment.
   */
  declare pensionEnrollment: DeserializedType<T, 'Edm.DateTimeOffset'>;

  constructor(_entityApi: PayIntV1EmployeesV2Api<T>) {
    super(_entityApi);
  }
}

export interface PayIntV1EmployeesV2Type<
...
> {
  ...
  employeeDetailsEffective: DeserializedType<T, 'Edm.DateTimeOffset'>;
  ...
  employeeDetailsExpiration: DeserializedType<T, 'Edm.DateTimeOffset'>;
  ...
  relocationReimbursement: DeserializedType<T, 'Edm.Decimal'>;
  ...
  pensionStart: DeserializedType<T, 'Edm.DateTimeOffset'>;
  pensionEnrollment: DeserializedType<T, 'Edm.DateTimeOffset'>;
}
