...
import type { PurchaseAgreementLinesV2Api } from './PurchaseAgreementLinesV2Api';
...
/**
 * This class represents the entity "PurchaseAgreementLinesV2" of service "d365_metadata".
 */
export class PurchaseAgreementLinesV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements PurchaseAgreementLinesV2Type<T>
{
  /**
   * Technical entity name for PurchaseAgreementLinesV2.
   */
  static override _entityName = 'PurchaseAgreementLinesV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the PurchaseAgreementLinesV2 entity.
   */
   ...
   */
  declare purchaseAgreementLineNotes: PurchaseAgreementLineNotes<T>[];
  /**
   * One-to-one navigation property to the {@link PurchaseAgreementLineFulfillment} entity.
   */
  declare purchaseAgreementLineFulfillment?: PurchaseAgreementLineFulfillment<T> | null;

  constructor(_entityApi: PurchaseAgreementLinesV2Api<T>) {
    super(_entityApi);
  }
}

export interface PurchaseAgreementLinesV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  purchaseAgreementLineNotes: PurchaseAgreementLineNotesType<T>[];
  purchaseAgreementLineFulfillment?: PurchaseAgreementLineFulfillmentType<T> | null;
}
