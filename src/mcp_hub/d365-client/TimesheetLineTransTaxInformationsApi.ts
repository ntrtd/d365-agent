...
import { TimesheetLineTransTaxInformationsRequestBuilder } from './TimesheetLineTransTaxInformationsRequestBuilder';
...
export class TimesheetLineTransTaxInformationsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<TimesheetLineTransTaxInformations<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): TimesheetLineTransTaxInformationsApi<DeSerializersT> {
    return new TimesheetLineTransTaxInformationsApi(deSerializers);
  }
  ...
  entityConstructor = TimesheetLineTransTaxInformations;

  requestBuilder(): TimesheetLineTransTaxInformationsRequestBuilder<DeSerializersT> {
    return new TimesheetLineTransTaxInformationsRequestBuilder<DeSerializersT>(
      this
    );
  }

  entityBuilder(): EntityBuilderType<
    TimesheetLineTransTaxInformations<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof TimesheetLineTransTaxInformations,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        TimesheetLineTransTaxInformations,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      TimesheetLineTransTaxInformations<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    >;
    TIMESHEET_NBR: OrderableEdmTypeField<
      TimesheetLineTransTaxInformations<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
    ...
    EXCISE_IS_SCRAP: EnumField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<TimesheetLineTransTaxInformations<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link timesheetNbr} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        TIMESHEET_NBR: fieldBuilder.buildEdmTypeField(
          'TimesheetNbr',
          'Edm.String',
          false
        ),
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', TimesheetLineTransTaxInformations)
      };
    }
