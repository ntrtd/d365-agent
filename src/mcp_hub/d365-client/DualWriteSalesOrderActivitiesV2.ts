...
import type { DualWriteSalesOrderActivitiesV2Api } from './DualWriteSalesOrderActivitiesV2Api';
...
/**
 * This class represents the entity "DualWriteSalesOrderActivitiesV2" of service "d365_metadata".
 */
export class DualWriteSalesOrderActivitiesV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements DualWriteSalesOrderActivitiesV2Type<T>
{
  /**
   * Technical entity name for DualWriteSalesOrderActivitiesV2.
   */
  static override _entityName = 'DualWriteSalesOrderActivitiesV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the DualWriteSalesOrderActivitiesV2 entity.
   */
  ...
  constructor(_entityApi: DualWriteSalesOrderActivitiesV2Api<T>) {
    super(_entityApi);
  }
}

export interface DualWriteSalesOrderActivitiesV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
