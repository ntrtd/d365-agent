...
import { AssetMaintenanceUnplannedWorkOrderLinesRequestBuilder } from './AssetMaintenanceUnplannedWorkOrderLinesRequestBuilder';
...
export class AssetMaintenanceUnplannedWorkOrderLinesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      AssetMaintenanceUnplannedWorkOrderLines<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    ...
    return new AssetMaintenanceUnplannedWorkOrderLinesApi(deSerializers);
  }

  private navigationPropertyFields!: {
    /**
     * Static representation of the one-to-one navigation property {@link unplannedWorkOrderJobDocumentAttachment} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    UNPLANNED_WORK_ORDER_JOB_DOCUMENT_ATTACHMENT: OneToOneLink<
      AssetMaintenanceUnplannedWorkOrderLines<DeSerializersT>,
      DeSerializersT,
      MaintenanceWorkOrderLineDocumentAttachmentsApi<DeSerializersT>
    >;
    /**
     * Static representation of the one-to-many navigation property {@link maintenanceAssetBillOfMaterialsMaintenanceUnplannedWorkOrderJob} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    MAINTENANCE_ASSET_BILL_OF_MATERIALS_MAINTENANCE_UNPLANNED_WORK_ORDER_JOB: OneToManyLink<
      AssetMaintenanceUnplannedWorkOrderLines<DeSerializersT>,
      DeSerializersT,
    ...
    >;
    /**
     * Static representation of the one-to-many navigation property {@link maintenanceWorkOrderJobChecklistHeadersMaintenanceUnplannedWorkOrderJob} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    MAINTENANCE_WORK_ORDER_JOB_CHECKLIST_HEADERS_MAINTENANCE_UNPLANNED_WORK_ORDER_JOB: OneToManyLink<
      AssetMaintenanceUnplannedWorkOrderLines<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      UNPLANNED_WORK_ORDER_JOB_DOCUMENT_ATTACHMENT: new OneToOneLink(
        'UnplannedWorkOrderJob_DocumentAttachment',
        this,
        linkedApis[0]
      ),
      MAINTENANCE_ASSET_BILL_OF_MATERIALS_MAINTENANCE_UNPLANNED_WORK_ORDER_JOB:
        new OneToManyLink(
          'MaintenanceAssetBillOfMaterials_MaintenanceUnplannedWorkOrderJob',
          this,
          linkedApis[1]
        ),
      ...
      ASSET: new OneToOneLink('Asset', this, linkedApis[10]),
      MAINTENANCE_WORK_ORDER_JOB_CHECKLIST_HEADERS_MAINTENANCE_UNPLANNED_WORK_ORDER_JOB:
        new OneToManyLink(
          'MaintenanceWorkOrderJobChecklistHeaders_MaintenanceUnplannedWorkOrderJob',
          this,
          linkedApis[11]
        )
    };
  ...
  entityConstructor = AssetMaintenanceUnplannedWorkOrderLines;

  requestBuilder(): AssetMaintenanceUnplannedWorkOrderLinesRequestBuilder<DeSerializersT> {
    return new AssetMaintenanceUnplannedWorkOrderLinesRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof AssetMaintenanceUnplannedWorkOrderLines,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      AssetMaintenanceUnplannedWorkOrderLines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', AssetMaintenanceUnplannedWorkOrderLines)
      };
    }
