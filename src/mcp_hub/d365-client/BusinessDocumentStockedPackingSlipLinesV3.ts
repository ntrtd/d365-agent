...
import type { BusinessDocumentStockedPackingSlipLinesV3Api } from './BusinessDocumentStockedPackingSlipLinesV3Api';
import {
...
/**
 * This class represents the entity "BusinessDocumentStockedPackingSlipLinesV3" of service "d365_metadata".
 */
export class BusinessDocumentStockedPackingSlipLinesV3<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements BusinessDocumentStockedPackingSlipLinesV3Type<T>
{
  /**
   * Technical entity name for BusinessDocumentStockedPackingSlipLinesV3.
   */
  static override _entityName = 'BusinessDocumentStockedPackingSlipLinesV3';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the BusinessDocumentStockedPackingSlipLinesV3 entity.
   */
  static _keys = [
    'dataAreaId',
    'SalesId',
  ...
  constructor(_entityApi: BusinessDocumentStockedPackingSlipLinesV3Api<T>) {
    super(_entityApi);
  }
}

export interface BusinessDocumentStockedPackingSlipLinesV3Type<
  T extends DeSerializers = DefaultDeSerializers
> {
