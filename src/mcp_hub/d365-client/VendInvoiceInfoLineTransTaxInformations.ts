...
import type { VendInvoiceInfoLineTransTaxInformationsApi } from './VendInvoiceInfoLineTransTaxInformationsApi';
...
/**
 * This class represents the entity "VendInvoiceInfoLineTransTaxInformations" of service "d365_metadata".
 */
export class VendInvoiceInfoLineTransTaxInformations<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements VendInvoiceInfoLineTransTaxInformationsType<T>
{
  /**
   * Technical entity name for VendInvoiceInfoLineTransTaxInformations.
   */
  static override _entityName = 'VendInvoiceInfoLineTransTaxInformations';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the VendInvoiceInfoLineTransTaxInformations entity.
   */
  ...
  constructor(_entityApi: VendInvoiceInfoLineTransTaxInformationsApi<T>) {
    super(_entityApi);
  }
}

export interface VendInvoiceInfoLineTransTaxInformationsType<
  T extends DeSerializers = DefaultDeSerializers
> {
