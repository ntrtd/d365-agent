...
import { LedgerJournalLineTransTaxInformationsRequestBuilder } from './LedgerJournalLineTransTaxInformationsRequestBuilder';
...
export class LedgerJournalLineTransTaxInformationsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      LedgerJournalLineTransTaxInformations<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): LedgerJournalLineTransTaxInformationsApi<DeSerializersT> {
    return new LedgerJournalLineTransTaxInformationsApi(deSerializers);
  }
  ...
  entityConstructor = LedgerJournalLineTransTaxInformations;

  requestBuilder(): LedgerJournalLineTransTaxInformationsRequestBuilder<DeSerializersT> {
    return new LedgerJournalLineTransTaxInformationsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof LedgerJournalLineTransTaxInformations,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        LedgerJournalLineTransTaxInformations,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      LedgerJournalLineTransTaxInformations<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    TAX_ID: OrderableEdmTypeField<
      ...
      true
    >;
    CUSTOMS_EXPORT_ORDER: EnumField<
      LedgerJournalLineTransTaxInformations<DeSerializers>,
      DeSerializersT,
      NoYes,
      true,
    ...
    EXCISE_IS_SCRAP: EnumField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<LedgerJournalLineTransTaxInformations<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link customsExportOrder} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CUSTOMS_EXPORT_ORDER: fieldBuilder.buildEnumField(
          'CustomsExportOrder',
          NoYes,
          true
        ),
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', LedgerJournalLineTransTaxInformations)
      };
    }
