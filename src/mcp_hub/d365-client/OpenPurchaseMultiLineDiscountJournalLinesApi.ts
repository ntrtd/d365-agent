...
import { OpenPurchaseMultiLineDiscountJournalLinesRequestBuilder } from './OpenPurchaseMultiLineDiscountJournalLinesRequestBuilder';
import { VendorsV2Api } from './VendorsV2Api';
import { MultilineDiscountProductGroupsApi } from './MultilineDiscountProductGroupsApi';
import { MultilineDiscountVendorGroupsApi } from './MultilineDiscountVendorGroupsApi';
...
export class OpenPurchaseMultiLineDiscountJournalLinesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      OpenPurchaseMultiLineDiscountJournalLines<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    ...
    return new OpenPurchaseMultiLineDiscountJournalLinesApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    >;
    /**
     * Static representation of the one-to-one navigation property {@link multilineDiscountVendorGroup} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    MULTILINE_DISCOUNT_VENDOR_GROUP: OneToOneLink<
      OpenPurchaseMultiLineDiscountJournalLines<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ...
      MULTILINE_DISCOUNT_VENDOR_GROUP: new OneToOneLink(
        'MultilineDiscountVendorGroup',
        this,
        linkedApis[2]
      )
    };
  ...
  entityConstructor = OpenPurchaseMultiLineDiscountJournalLines;

  requestBuilder(): OpenPurchaseMultiLineDiscountJournalLinesRequestBuilder<DeSerializersT> {
    return new OpenPurchaseMultiLineDiscountJournalLinesRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof OpenPurchaseMultiLineDiscountJournalLines,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      OpenPurchaseMultiLineDiscountJournalLines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
