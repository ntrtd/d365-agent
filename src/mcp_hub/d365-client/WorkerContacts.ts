...
import type { WorkerContactsApi } from './WorkerContactsApi';
import { LogisticsElectronicAddressMethodType } from './LogisticsElectronicAddressMethodType';
import { NoYes } from './NoYes';
import { Workers, WorkersType } from './Workers';

/**
 * This class represents the entity "WorkerContacts" of service "d365_metadata".
 */
export class WorkerContacts<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements WorkerContactsType<T>
{
  /**
   * Technical entity name for WorkerContacts.
   */
  static override _entityName = 'WorkerContacts';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the WorkerContacts entity.
   */
  ...
  constructor(_entityApi: WorkerContactsApi<T>) {
    super(_entityApi);
  }
}

export interface WorkerContactsType<
