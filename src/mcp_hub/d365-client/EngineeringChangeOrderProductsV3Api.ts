...
import { EngineeringChangeOrderProductsV3RequestBuilder } from './EngineeringChangeOrderProductsV3RequestBuilder';
...
export class EngineeringChangeOrderProductsV3Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<EngineeringChangeOrderProductsV3<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new EngineeringChangeOrderProductsV3Api(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    ENGINEERING_CHANGE_ORDER_PRODUCT_ATTRIBUTES: OneToManyLink<
      EngineeringChangeOrderProductsV3<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ...
      PRODUCT_OWNER: new OneToOneLink('ProductOwner', this, linkedApis[1]),
  ...
  entityConstructor = EngineeringChangeOrderProductsV3;

  requestBuilder(): EngineeringChangeOrderProductsV3RequestBuilder<DeSerializersT> {
    return new EngineeringChangeOrderProductsV3RequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof EngineeringChangeOrderProductsV3,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      EngineeringChangeOrderProductsV3<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    ENGINEERING_CHANGE_ORDER_PRODUCT_ROUTE_HEADERS_V_2: OneToManyLink<
      ...
      EngineeringChangeOrderProductRouteHeadersV2Api<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<EngineeringChangeOrderProductsV3<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', EngineeringChangeOrderProductsV3)
      };
    }
