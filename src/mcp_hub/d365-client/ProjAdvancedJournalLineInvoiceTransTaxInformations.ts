...
import type { ProjAdvancedJournalLineInvoiceTransTaxInformationsApi } from './ProjAdvancedJournalLineInvoiceTransTaxInformationsApi';
...
/**
 * This class represents the entity "ProjAdvancedJournalLineInvoiceTransTaxInformations" of service "d365_metadata".
 */
export class ProjAdvancedJournalLineInvoiceTransTaxInformations<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ProjAdvancedJournalLineInvoiceTransTaxInformationsType<T>
{
  /**
   * Technical entity name for ProjAdvancedJournalLineInvoiceTransTaxInformations.
   */
  ...
  /**
   * All key fields of the ProjAdvancedJournalLineInvoiceTransTaxInformations entity.
   */
  static _keys = ['dataAreaId', 'ProjAdvancedJournal', 'LineNumber'];
  /**
   * Data Area Id.
   */
  ...
  /**
   * Customs Export Order.
   * @nullable
   */
  declare customsExportOrder?: NoYes | null;
  /**
  ...
  constructor(
    _entityApi: ProjAdvancedJournalLineInvoiceTransTaxInformationsApi<T>
  ) {
    super(_entityApi);
  }
}

export interface ProjAdvancedJournalLineInvoiceTransTaxInformationsType<
  T extends DeSerializers = DefaultDeSerializers
> {
