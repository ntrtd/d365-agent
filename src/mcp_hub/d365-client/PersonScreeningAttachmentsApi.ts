...
import { PersonScreeningAttachmentsRequestBuilder } from './PersonScreeningAttachmentsRequestBuilder';
...
export class PersonScreeningAttachmentsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<PersonScreeningAttachments<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): PersonScreeningAttachmentsApi<DeSerializersT> {
    return new PersonScreeningAttachmentsApi(deSerializers);
  }
  ...
  entityConstructor = PersonScreeningAttachments;

  requestBuilder(): PersonScreeningAttachmentsRequestBuilder<DeSerializersT> {
    return new PersonScreeningAttachmentsRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    PersonScreeningAttachments<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof PersonScreeningAttachments,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        PersonScreeningAttachments,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      PersonScreeningAttachments<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    TYPE_ID: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<PersonScreeningAttachments<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PersonScreeningAttachments)
      };
    }
