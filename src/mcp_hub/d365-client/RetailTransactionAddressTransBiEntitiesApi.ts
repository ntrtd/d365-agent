...
import { RetailTransactionAddressTransBiEntitiesRequestBuilder } from './RetailTransactionAddressTransBiEntitiesRequestBuilder';
import {
  CustomField,
...
export class RetailTransactionAddressTransBiEntitiesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      RetailTransactionAddressTransBiEntities<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): RetailTransactionAddressTransBiEntitiesApi<DeSerializersT> {
    return new RetailTransactionAddressTransBiEntitiesApi(deSerializers);
  }
  ...
  entityConstructor = RetailTransactionAddressTransBiEntities;

  requestBuilder(): RetailTransactionAddressTransBiEntitiesRequestBuilder<DeSerializersT> {
    return new RetailTransactionAddressTransBiEntitiesRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof RetailTransactionAddressTransBiEntities,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        RetailTransactionAddressTransBiEntities,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      RetailTransactionAddressTransBiEntities<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', RetailTransactionAddressTransBiEntities)
      };
    }
