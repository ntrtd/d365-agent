...
import type { InventoryServiceAdjustmentJournalHeadersApi } from './InventoryServiceAdjustmentJournalHeadersApi';
...
/**
 * This class represents the entity "InventoryServiceAdjustmentJournalHeaders" of service "d365_metadata".
 */
export class InventoryServiceAdjustmentJournalHeaders<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements InventoryServiceAdjustmentJournalHeadersType<T>
{
  /**
   * Technical entity name for InventoryServiceAdjustmentJournalHeaders.
   */
  static override _entityName = 'InventoryServiceAdjustmentJournalHeaders';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the InventoryServiceAdjustmentJournalHeaders entity.
   */
   ...
   */
  declare inventoryServiceAdjustmentJournalEntries: InventoryServiceAdjustmentJournalEntries<T>[];

  constructor(_entityApi: InventoryServiceAdjustmentJournalHeadersApi<T>) {
    super(_entityApi);
  }
}

export interface InventoryServiceAdjustmentJournalHeadersType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  inventoryServiceAdjustmentJournalEntries: InventoryServiceAdjustmentJournalEntriesType<T>[];
}
