...
import { WorkerPostalAddressesRequestBuilder } from './WorkerPostalAddressesRequestBuilder';
...
export class WorkerPostalAddressesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<WorkerPostalAddresses<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): WorkerPostalAddressesApi<DeSerializersT> {
    return new WorkerPostalAddressesApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
     ...
     */
    WORKER: OneToOneLink<
      WorkerPostalAddresses<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = WorkerPostalAddresses;

  requestBuilder(): WorkerPostalAddressesRequestBuilder<DeSerializersT> {
    return new WorkerPostalAddressesRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<WorkerPostalAddresses<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    PERSONNEL_NUMBER: OrderableEdmTypeField<
      WorkerPostalAddresses<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    WORKER: OneToOneLink<
      ...
      WorkersApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<WorkerPostalAddresses<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', WorkerPostalAddresses)
      };
    }
