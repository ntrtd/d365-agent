...
import { SalesAgreementLinesRequestBuilder } from './SalesAgreementLinesRequestBuilder';
...
import { SalesAgreementLineNotesApi } from './SalesAgreementLineNotesApi';
import { SalesAgreementLineFulfillmentApi } from './SalesAgreementLineFulfillmentApi';
...
export class SalesAgreementLinesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<SalesAgreementLines<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new SalesAgreementLinesApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    SHIPPING_WAREHOUSE: OneToOneLink<
      SalesAgreementLines<DeSerializersT>,
      DeSerializersT,
      WarehousesApi<DeSerializersT>
    >;
    /**
     * Static representation of the one-to-one navigation property {@link salesAgreementHeader} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SALES_AGREEMENT_HEADER: OneToOneLink<
      SalesAgreementLines<DeSerializersT>,
      DeSerializersT,
    ...
    >;
    /**
     * Static representation of the one-to-many navigation property {@link salesAgreementLineNotes} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SALES_AGREEMENT_LINE_NOTES: OneToManyLink<
      SalesAgreementLines<DeSerializersT>,
      DeSerializersT,
      SalesAgreementLineNotesApi<DeSerializersT>
    >;
    /**
     * Static representation of the one-to-one navigation property {@link salesAgreementLinesFulfillment} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SALES_AGREEMENT_LINES_FULFILLMENT: OneToOneLink<
      SalesAgreementLines<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ...
      SALES_AGREEMENT_HEADER: new OneToOneLink(
      ...
      UNIT: new OneToOneLink('Unit', this, linkedApis[3]),
      DEFAULT_LEDGER_DIMENSION: new OneToOneLink(
        'DefaultLedgerDimension',
        this,
        linkedApis[4]
      ),
      PROJECT: new OneToOneLink('Project', this, linkedApis[5]),
      SHIPPING_SITE: new OneToOneLink('ShippingSite', this, linkedApis[6]),
      SALES_AGREEMENT_LINE_NOTES: new OneToManyLink(
        'SalesAgreementLineNotes',
        this,
        linkedApis[7]
      ),
      SALES_AGREEMENT_LINES_FULFILLMENT: new OneToOneLink(
        'SalesAgreementLinesFulfillment',
        this,
        linkedApis[8]
      )
    };
  ...
  entityConstructor = SalesAgreementLines;

  requestBuilder(): SalesAgreementLinesRequestBuilder<DeSerializersT> {
    return new SalesAgreementLinesRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<SalesAgreementLines<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      SalesAgreementLines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    PRODUCT_STYLE_ID: OrderableEdmTypeField<
      ...
      true
    >;
    KITTING_BOM_ID: OrderableEdmTypeField<
      SalesAgreementLines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    SALES_AGREEMENT_LINES_FULFILLMENT: OneToOneLink<
      ...
      SalesAgreementLineFulfillmentApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<SalesAgreementLines<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link kittingBomId} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        KITTING_BOM_ID: fieldBuilder.buildEdmTypeField(
          'KittingBOMId',
          'Edm.String',
          true
        ),
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', SalesAgreementLines)
      };
    }
