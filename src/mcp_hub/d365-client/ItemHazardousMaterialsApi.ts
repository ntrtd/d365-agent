...
import { ItemHazardousMaterialsRequestBuilder } from './ItemHazardousMaterialsRequestBuilder';
...
export class ItemHazardousMaterialsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<ItemHazardousMaterials<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): ItemHazardousMaterialsApi<DeSerializersT> {
    return new ItemHazardousMaterialsApi(deSerializers);
  }
  ...
  entityConstructor = ItemHazardousMaterials;

  requestBuilder(): ItemHazardousMaterialsRequestBuilder<DeSerializersT> {
    return new ItemHazardousMaterialsRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    ItemHazardousMaterials<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof ItemHazardousMaterials,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        ItemHazardousMaterials,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ItemHazardousMaterials<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    PACK_CODE: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<ItemHazardousMaterials<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ItemHazardousMaterials)
      };
    }
