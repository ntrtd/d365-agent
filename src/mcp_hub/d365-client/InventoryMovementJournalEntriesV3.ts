...
import type { InventoryMovementJournalEntriesV3Api } from './InventoryMovementJournalEntriesV3Api';
...
/**
 * This class represents the entity "InventoryMovementJournalEntriesV3" of service "d365_metadata".
 */
export class InventoryMovementJournalEntriesV3<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements InventoryMovementJournalEntriesV3Type<T>
{
  /**
   * Technical entity name for InventoryMovementJournalEntriesV3.
   */
  static override _entityName = 'InventoryMovementJournalEntriesV3';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the InventoryMovementJournalEntriesV3 entity.
   */
  static _keys = [
    'dataAreaId',
    'JournalNumber',
  ...
  constructor(_entityApi: InventoryMovementJournalEntriesV3Api<T>) {
    super(_entityApi);
  }
}

export interface InventoryMovementJournalEntriesV3Type<
  T extends DeSerializers = DefaultDeSerializers
> {
