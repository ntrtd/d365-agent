...
import type { ExpCopilotAutomationReportsApi } from './ExpCopilotAutomationReportsApi';
...
/**
 * This class represents the entity "ExpCopilotAutomationReports" of service "d365_metadata".
 */
export class ExpCopilotAutomationReports<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ExpCopilotAutomationReportsType<T>
{
  /**
   * Technical entity name for ExpCopilotAutomationReports.
   */
  static override _entityName = 'ExpCopilotAutomationReports';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ExpCopilotAutomationReports entity.
   */
  ...
  constructor(_entityApi: ExpCopilotAutomationReportsApi<T>) {
    super(_entityApi);
  }
}

export interface ExpCopilotAutomationReportsType<
  T extends DeSerializers = DefaultDeSerializers
> {
