...
import { InventTransferLineTransTaxInformationsRequestBuilder } from './InventTransferLineTransTaxInformationsRequestBuilder';
...
export class InventTransferLineTransTaxInformationsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      InventTransferLineTransTaxInformations<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): InventTransferLineTransTaxInformationsApi<DeSerializersT> {
    return new InventTransferLineTransTaxInformationsApi(deSerializers);
  }
  ...
  entityConstructor = InventTransferLineTransTaxInformations;

  requestBuilder(): InventTransferLineTransTaxInformationsRequestBuilder<DeSerializersT> {
    return new InventTransferLineTransTaxInformationsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof InventTransferLineTransTaxInformations,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        InventTransferLineTransTaxInformations,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      InventTransferLineTransTaxInformations<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', InventTransferLineTransTaxInformations)
      };
    }
