...
import { InboundLoadPackingStructureCaseLinesV5RequestBuilder } from './InboundLoadPackingStructureCaseLinesV5RequestBuilder';
...
export class InboundLoadPackingStructureCaseLinesV5Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      InboundLoadPackingStructureCaseLinesV5<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): InboundLoadPackingStructureCaseLinesV5Api<DeSerializersT> {
    return new InboundLoadPackingStructureCaseLinesV5Api(deSerializers);
  }
  ...
  entityConstructor = InboundLoadPackingStructureCaseLinesV5;

  requestBuilder(): InboundLoadPackingStructureCaseLinesV5RequestBuilder<DeSerializersT> {
    return new InboundLoadPackingStructureCaseLinesV5RequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof InboundLoadPackingStructureCaseLinesV5,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        InboundLoadPackingStructureCaseLinesV5,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      InboundLoadPackingStructureCaseLinesV5<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', InboundLoadPackingStructureCaseLinesV5)
      };
    }
