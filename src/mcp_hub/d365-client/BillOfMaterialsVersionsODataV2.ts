...
import type { BillOfMaterialsVersionsODataV2Api } from './BillOfMaterialsVersionsODataV2Api';
...
/**
 * This class represents the entity "BillOfMaterialsVersionsODataV2" of service "d365_metadata".
 */
export class BillOfMaterialsVersionsODataV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements BillOfMaterialsVersionsODataV2Type<T>
{
  /**
   * Technical entity name for BillOfMaterialsVersionsODataV2.
   */
  static override _entityName = 'BillOfMaterialsVersionsODataV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the BillOfMaterialsVersionsODataV2 entity.
   */
  static _keys = [
    'dataAreaId',
  ...
  constructor(_entityApi: BillOfMaterialsVersionsODataV2Api<T>) {
    super(_entityApi);
  }
}

export interface BillOfMaterialsVersionsODataV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
