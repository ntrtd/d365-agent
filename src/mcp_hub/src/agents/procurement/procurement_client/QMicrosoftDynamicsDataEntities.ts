...
export class QExternalLinks extends QueryObject {
  public readonly dataAreaId = new QStringPath(this.withPrefix("dataAreaId"));
  public readonly displayText = new QStringPath(this.withPrefix("DisplayText"));
  public readonly groupName = new QStringPath(this.withPrefix("GroupName"));
  public readonly displayContext = new QEnumPath(
    this.withPrefix("DisplayContext"),
    HcmExternalLinksDisplayContext,
  );
  public readonly address = new QStringPath(this.withPrefix("Address"));
  public readonly externalLinksGroups = new QEntityPath(
    this.withPrefix("ExternalLinksGroups"),
    () => QExternalLinksGroups,
  );
}

export const qExternalLinks = new QExternalLinks();

export class QExternalLinksId extends QId<ExternalLinksId> {
  private readonly params = [
    new QStringParam("dataAreaId"),
    new QStringParam("DisplayText", "displayText"),
    new QStringParam("GroupName", "groupName"),
  ];
...
export class QProspectiveVendorRegistrationContactPersonPostalAddresses extends QueryObject {
  public readonly vendorRegistrationId = new QNumberPath(
    this.withPrefix("VendorRegistrationId"),
  );
  ...
  public readonly addressBuildingCompliment = new QStringPath(
    this.withPrefix("AddressBuildingCompliment"),
  );
  public readonly isRoleDelivery = new QEnumPath(
    this.withPrefix("IsRoleDelivery"),
    NoYes,
  );
  public readonly contactPersonEmailAddress = new QStringPath(
    this.withPrefix("ContactPersonEmailAddress"),
  );
  public readonly addressCity = new QStringPath(this.withPrefix("AddressCity"));
  public readonly addressCityInKana = new QStringPath(
    this.withPrefix("AddressCityInKana"),
  );
  public readonly addressPostBox = new QStringPath(
    this.withPrefix("AddressPostBox"),
  );
  public readonly isAddressPrimary = new QEnumPath(
    this.withPrefix("IsAddressPrimary"),
    NoYes,
  );
  public readonly addressValidTo = new QDateTimeOffsetPath(
    this.withPrefix("AddressValidTo"),
  );
  public readonly addressStateId = new QStringPath(
    this.withPrefix("AddressStateId"),
  );
  public readonly addressLatitude = new QNumberPath(
    this.withPrefix("AddressLatitude"),
  );
  public readonly isRoleHome = new QEnumPath(
    this.withPrefix("IsRoleHome"),
    NoYes,
  );
  public readonly addressLocationRoles = new QStringPath(
    this.withPrefix("AddressLocationRoles"),
  );
  public readonly addressDescription = new QStringPath(
    this.withPrefix("AddressDescription"),
  );
  public readonly isPrimaryTaxRegistration = new QEnumPath(
    this.withPrefix("IsPrimaryTaxRegistration"),
    NoYes,
  );
  public readonly addressDistrictName = new QStringPath(
    this.withPrefix("AddressDistrictName"),
  );
  public readonly attentionToAddressLine = new QStringPath(
    this.withPrefix("AttentionToAddressLine"),
  );
  public readonly addressStreet = new QStringPath(
    this.withPrefix("AddressStreet"),
  );
  public readonly isLocationOwner = new QEnumPath(
    this.withPrefix("IsLocationOwner"),
    NoYes,
  );
  public readonly addressStreetInKana = new QStringPath(
    this.withPrefix("AddressStreetInKana"),
  );
  public readonly addressCountyId = new QStringPath(
    this.withPrefix("AddressCountyId"),
  );
  public readonly formattedAddress = new QStringPath(
    this.withPrefix("FormattedAddress"),
  );
  public readonly addressTimeZone = new QEnumPath(
    this.withPrefix("AddressTimeZone"),
    Timezone,
  );
  public readonly addressLongitude = new QNumberPath(
    this.withPrefix("AddressLongitude"),
  );
  public readonly isRoleBusiness = new QEnumPath(
    this.withPrefix("IsRoleBusiness"),
    NoYes,
  );
  ...
  public readonly isAddressPrivate = new QEnumPath(
    this.withPrefix("IsAddressPrivate"),
    NoYes,
  );
  public readonly addressStreetNumber = new QStringPath(
    this.withPrefix("AddressStreetNumber"),
  );
...
export const qProspectiveVendorRegistrationContactPersonPostalAddresses =
  new QProspectiveVendorRegistrationContactPersonPostalAddresses();

export class QProspectiveVendorRegistrationContactPersonPostalAddressesId extends QId<ProspectiveVendorRegistrationContactPersonPostalAddressesId> {
  private readonly params = [
    new QNumberParam("VendorRegistrationId", "vendorRegistrationId"),
    new QStringParam("AddressLocationId", "addressLocationId"),
  ];
...
export class QExternalLinksGroups extends QueryObject {
  public readonly dataAreaId = new QStringPath(this.withPrefix("dataAreaId"));
  public readonly name = new QStringPath(this.withPrefix("Name"));
  public readonly externalLinks = new QEntityCollectionPath(
    this.withPrefix("ExternalLinks"),
    () => QExternalLinks,
  );
}

export const qExternalLinksGroups = new QExternalLinksGroups();

export class QExternalLinksGroupsId extends QId<ExternalLinksGroupsId> {
  private readonly params = [
    new QStringParam("dataAreaId"),
