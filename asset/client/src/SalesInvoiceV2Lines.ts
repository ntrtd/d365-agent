...
import type { SalesInvoiceV2LinesApi } from './SalesInvoiceV2LinesApi';
import {
...
/**
 * This class represents the entity "SalesInvoiceV2Lines" of service "d365_metadata".
 */
export class SalesInvoiceV2Lines<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements SalesInvoiceV2LinesType<T>
{
  /**
   * Technical entity name for SalesInvoiceV2Lines.
   */
  static override _entityName = 'SalesInvoiceV2Lines';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the SalesInvoiceV2Lines entity.
   */
  static _keys = [
    'dataAreaId',
    'InvoiceNumber',
  ...
  constructor(_entityApi: SalesInvoiceV2LinesApi<T>) {
    super(_entityApi);
  }
}

export interface SalesInvoiceV2LinesType<
