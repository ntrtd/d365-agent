...
import type { ExpMobileExpenseLineAttachedToReportsApi } from './ExpMobileExpenseLineAttachedToReportsApi';
...
/**
 * This class represents the entity "ExpMobileExpenseLineAttachedToReports" of service "d365_metadata".
 */
export class ExpMobileExpenseLineAttachedToReports<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ExpMobileExpenseLineAttachedToReportsType<T>
{
  /**
   * Technical entity name for ExpMobileExpenseLineAttachedToReports.
   */
  static override _entityName = 'ExpMobileExpenseLineAttachedToReports';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ExpMobileExpenseLineAttachedToReports entity.
   */
  ...
  constructor(_entityApi: ExpMobileExpenseLineAttachedToReportsApi<T>) {
    super(_entityApi);
  }
}

export interface ExpMobileExpenseLineAttachedToReportsType<
  T extends DeSerializers = DefaultDeSerializers
> {
