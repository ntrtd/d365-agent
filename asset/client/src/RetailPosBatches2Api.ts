...
import { RetailPosBatches2RequestBuilder } from './RetailPosBatches2RequestBuilder';
...
export class RetailPosBatches2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<RetailPosBatches2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): RetailPosBatches2Api<DeSerializersT> {
    return new RetailPosBatches2Api(deSerializers);
  }
  ...
  entityConstructor = RetailPosBatches2;

  requestBuilder(): RetailPosBatches2RequestBuilder<DeSerializersT> {
    return new RetailPosBatches2RequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    RetailPosBatches2<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<RetailPosBatches2<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  ): CustomField<RetailPosBatches2<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      RetailPosBatches2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    LOGONS_COUNT: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<RetailPosBatches2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', RetailPosBatches2)
      };
    }
