...
import { RetailTransactionSupplementaryInvoicesRequestBuilder } from './RetailTransactionSupplementaryInvoicesRequestBuilder';
import {
  CustomField,
...
export class RetailTransactionSupplementaryInvoicesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      RetailTransactionSupplementaryInvoices<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): RetailTransactionSupplementaryInvoicesApi<DeSerializersT> {
    return new RetailTransactionSupplementaryInvoicesApi(deSerializers);
  }
  ...
  entityConstructor = RetailTransactionSupplementaryInvoices;

  requestBuilder(): RetailTransactionSupplementaryInvoicesRequestBuilder<DeSerializersT> {
    return new RetailTransactionSupplementaryInvoicesRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof RetailTransactionSupplementaryInvoices,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        RetailTransactionSupplementaryInvoices,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      RetailTransactionSupplementaryInvoices<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', RetailTransactionSupplementaryInvoices)
      };
    }
