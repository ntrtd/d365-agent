...
import type { InboundLoadPackingStructureCaseLinesV5Api } from './InboundLoadPackingStructureCaseLinesV5Api';
import { WhsModule } from './WhsModule';

/**
 * This class represents the entity "InboundLoadPackingStructureCaseLinesV5" of service "d365_metadata".
 */
export class InboundLoadPackingStructureCaseLinesV5<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements InboundLoadPackingStructureCaseLinesV5Type<T>
{
  /**
   * Technical entity name for InboundLoadPackingStructureCaseLinesV5.
   */
  static override _entityName = 'InboundLoadPackingStructureCaseLinesV5';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the InboundLoadPackingStructureCaseLinesV5 entity.
   */
  static _keys = [
    'dataAreaId',
    'InboundShipmentId',
  ...
  constructor(_entityApi: InboundLoadPackingStructureCaseLinesV5Api<T>) {
    super(_entityApi);
  }
}

export interface InboundLoadPackingStructureCaseLinesV5Type<
  T extends DeSerializers = DefaultDeSerializers
> {
