...
import { GoalTemplateMeasurementsRequestBuilder } from './GoalTemplateMeasurementsRequestBuilder';
...
export class GoalTemplateMeasurementsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<GoalTemplateMeasurements<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new GoalTemplateMeasurementsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    GOAL_TEMPLATE: OneToOneLink<
      GoalTemplateMeasurements<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = GoalTemplateMeasurements;

  requestBuilder(): GoalTemplateMeasurementsRequestBuilder<DeSerializersT> {
    return new GoalTemplateMeasurementsRequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof GoalTemplateMeasurements,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    TEMPLATE_ID: OrderableEdmTypeField<
      GoalTemplateMeasurements<DeSerializers>,
      DeSerializersT,
      'Edm.Int32',
      false,
      true
    ...
    MEASUREMENT: OneToOneLink<
      ...
      MeasurementsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<GoalTemplateMeasurements<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', GoalTemplateMeasurements)
      };
    }
