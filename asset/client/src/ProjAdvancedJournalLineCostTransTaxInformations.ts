...
import type { ProjAdvancedJournalLineCostTransTaxInformationsApi } from './ProjAdvancedJournalLineCostTransTaxInformationsApi';
...
/**
 * This class represents the entity "ProjAdvancedJournalLineCostTransTaxInformations" of service "d365_metadata".
 */
export class ProjAdvancedJournalLineCostTransTaxInformations<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ProjAdvancedJournalLineCostTransTaxInformationsType<T>
{
  /**
   * Technical entity name for ProjAdvancedJournalLineCostTransTaxInformations.
   */
  ...
  /**
   * All key fields of the ProjAdvancedJournalLineCostTransTaxInformations entity.
   */
  ...
  constructor(
    _entityApi: ProjAdvancedJournalLineCostTransTaxInformationsApi<T>
  ) {
    super(_entityApi);
  }
}

export interface ProjAdvancedJournalLineCostTransTaxInformationsType<
  T extends DeSerializers = DefaultDeSerializers
> {
