...
import { DocumentProjInvoiceItemLinesRequestBuilder } from './DocumentProjInvoiceItemLinesRequestBuilder';
...
export class DocumentProjInvoiceItemLinesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<DocumentProjInvoiceItemLines<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new DocumentProjInvoiceItemLinesApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    BUSINESS_DOCUMENT_TAX_TRANSACTION: OneToManyLink<
      DocumentProjInvoiceItemLines<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = DocumentProjInvoiceItemLines;

  requestBuilder(): DocumentProjInvoiceItemLinesRequestBuilder<DeSerializersT> {
    return new DocumentProjInvoiceItemLinesRequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof DocumentProjInvoiceItemLines,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      DocumentProjInvoiceItemLines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    DATA_AREA: OrderableEdmTypeField<
      ...
      true
    >;
    PROJ_INVOICE_ITEM_REC_ID: OrderableEdmTypeField<
      DocumentProjInvoiceItemLines<DeSerializers>,
      DeSerializersT,
      'Edm.Int64',
      false,
      true
    >;
    PROJ_INVOICE_ITEM_TABLE_ID: OrderableEdmTypeField<
      DocumentProjInvoiceItemLines<DeSerializers>,
      DeSerializersT,
      'Edm.Int32',
      false,
    ...
    DOCUMENT_PROJECT_INVOICE_BASE: OneToOneLink<
      ...
      DocumentProjectInvoiceBasesApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<DocumentProjInvoiceItemLines<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link projInvoiceItemRecId} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PROJ_INVOICE_ITEM_REC_ID: fieldBuilder.buildEdmTypeField(
          'ProjInvoiceItemRecId',
          'Edm.Int64',
          false
        ),
        /**
         * Static representation of the {@link projInvoiceItemTableId} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PROJ_INVOICE_ITEM_TABLE_ID: fieldBuilder.buildEdmTypeField(
          'ProjInvoiceItemTableId',
          'Edm.Int32',
          false
        ),
        /**
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', DocumentProjInvoiceItemLines)
      };
    }
