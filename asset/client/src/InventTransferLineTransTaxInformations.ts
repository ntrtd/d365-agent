...
import type { InventTransferLineTransTaxInformationsApi } from './InventTransferLineTransTaxInformationsApi';
...
/**
 * This class represents the entity "InventTransferLineTransTaxInformations" of service "d365_metadata".
 */
export class InventTransferLineTransTaxInformations<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements InventTransferLineTransTaxInformationsType<T>
{
  /**
   * Technical entity name for InventTransferLineTransTaxInformations.
   */
  static override _entityName = 'InventTransferLineTransTaxInformations';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the InventTransferLineTransTaxInformations entity.
   */
  static _keys = ['dataAreaId', 'TransferId', 'LineNum', 'Type'];
  /**
   * Data Area Id.
   */
  ...
  constructor(_entityApi: InventTransferLineTransTaxInformationsApi<T>) {
    super(_entityApi);
  }
}

export interface InventTransferLineTransTaxInformationsType<
  T extends DeSerializers = DefaultDeSerializers
> {
