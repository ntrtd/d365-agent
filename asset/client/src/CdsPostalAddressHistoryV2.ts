...
import type { CdsPostalAddressHistoryV2Api } from './CdsPostalAddressHistoryV2Api';
...
/**
 * This class represents the entity "CDSPostalAddressHistoryV2" of service "d365_metadata".
 */
export class CdsPostalAddressHistoryV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements CdsPostalAddressHistoryV2Type<T>
{
  /**
   * Technical entity name for CdsPostalAddressHistoryV2.
   */
  static override _entityName = 'CDSPostalAddressHistoryV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the CdsPostalAddressHistoryV2 entity.
   */
  ...
  constructor(_entityApi: CdsPostalAddressHistoryV2Api<T>) {
    super(_entityApi);
  }
}

export interface CdsPostalAddressHistoryV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
