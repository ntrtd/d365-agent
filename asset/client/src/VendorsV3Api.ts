...
import { VendorsV3RequestBuilder } from './VendorsV3RequestBuilder';
...
export class VendorsV3Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<VendorsV3<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): VendorsV3Api<DeSerializersT> {
    return new VendorsV3Api(deSerializers);
  }
  ...
  entityConstructor = VendorsV3;

  requestBuilder(): VendorsV3RequestBuilder<DeSerializersT> {
    return new VendorsV3RequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<VendorsV3<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<VendorsV3<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof VendorsV3, DeSerializersT>;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(VendorsV3, this.deSerializers);
    }
  ...
  private _schema?: {
    ...
    DIMENSION_SET: OneToOneLink<
      ...
      DimensionSetsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<VendorsV3<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', VendorsV3)
      };
    }
