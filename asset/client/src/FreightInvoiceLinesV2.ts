...
import type { FreightInvoiceLinesV2Api } from './FreightInvoiceLinesV2Api';
...
import {
  ...
  FreightInvoiceHeadersV2Type
} from './FreightInvoiceHeadersV2';

/**
 * This class represents the entity "FreightInvoiceLinesV2" of service "d365_metadata".
 */
export class FreightInvoiceLinesV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements FreightInvoiceLinesV2Type<T>
{
  /**
   * Technical entity name for FreightInvoiceLinesV2.
   */
  static override _entityName = 'FreightInvoiceLinesV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the FreightInvoiceLinesV2 entity.
   */
  ...
  /**
   * One-to-one navigation property to the {@link FreightInvoiceHeadersV2} entity.
   */
  declare freightInvoiceHeaderV2?: FreightInvoiceHeadersV2<T> | null;

  constructor(_entityApi: FreightInvoiceLinesV2Api<T>) {
    super(_entityApi);
  }
}

export interface FreightInvoiceLinesV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  freightInvoiceHeaderV2?: FreightInvoiceHeadersV2Type<T> | null;
}
