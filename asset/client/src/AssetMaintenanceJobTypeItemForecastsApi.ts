...
import { AssetMaintenanceJobTypeItemForecastsRequestBuilder } from './AssetMaintenanceJobTypeItemForecastsRequestBuilder';
import {
  CustomField,
...
export class AssetMaintenanceJobTypeItemForecastsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      AssetMaintenanceJobTypeItemForecasts<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): AssetMaintenanceJobTypeItemForecastsApi<DeSerializersT> {
    return new AssetMaintenanceJobTypeItemForecastsApi(deSerializers);
  }
  ...
  entityConstructor = AssetMaintenanceJobTypeItemForecasts;

  requestBuilder(): AssetMaintenanceJobTypeItemForecastsRequestBuilder<DeSerializersT> {
    return new AssetMaintenanceJobTypeItemForecastsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof AssetMaintenanceJobTypeItemForecasts,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        AssetMaintenanceJobTypeItemForecasts,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      AssetMaintenanceJobTypeItemForecasts<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    FORECAST_CURRENCY: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<AssetMaintenanceJobTypeItemForecasts<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', AssetMaintenanceJobTypeItemForecasts)
      };
    }
