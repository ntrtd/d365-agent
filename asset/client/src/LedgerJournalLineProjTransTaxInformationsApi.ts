...
import { LedgerJournalLineProjTransTaxInformationsRequestBuilder } from './LedgerJournalLineProjTransTaxInformationsRequestBuilder';
...
export class LedgerJournalLineProjTransTaxInformationsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      LedgerJournalLineProjTransTaxInformations<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): LedgerJournalLineProjTransTaxInformationsApi<DeSerializersT> {
    return new LedgerJournalLineProjTransTaxInformationsApi(deSerializers);
  }
  ...
  entityConstructor = LedgerJournalLineProjTransTaxInformations;

  requestBuilder(): LedgerJournalLineProjTransTaxInformationsRequestBuilder<DeSerializersT> {
    return new LedgerJournalLineProjTransTaxInformationsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof LedgerJournalLineProjTransTaxInformations,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        LedgerJournalLineProjTransTaxInformations,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      LedgerJournalLineProjTransTaxInformations<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
