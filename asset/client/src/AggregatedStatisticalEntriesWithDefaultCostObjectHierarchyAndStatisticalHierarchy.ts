...
import type { AggregatedStatisticalEntriesWithDefaultCostObjectHierarchyAndStatisticalHierarchyApi } from './AggregatedStatisticalEntriesWithDefaultCostObjectHierarchyAndStatisticalHierarchyApi';
import { FiscalPeriodMonth } from './FiscalPeriodMonth';
import { FiscalQuarter } from './FiscalQuarter';

/**
 * This class represents the entity "AggregatedStatisticalEntriesWithDefaultCostObjectHierarchyAndStatisticalHierarchy" of service "d365_metadata".
 */
export class AggregatedStatisticalEntriesWithDefaultCostObjectHierarchyAndStatisticalHierarchy<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements
    AggregatedStatisticalEntriesWithDefaultCostObjectHierarchyAndStatisticalHierarchyType<T>
{
  /**
   * Technical entity name for AggregatedStatisticalEntriesWithDefaultCostObjectHierarchyAndStatisticalHierarchy.
   */
  ...
  /**
   * All key fields of the AggregatedStatisticalEntriesWithDefaultCostObjectHierarchyAndStatisticalHierarchy entity.
   */
  static _keys = [
    'CostAccountingDate',
  ...
  constructor(
    _entityApi: AggregatedStatisticalEntriesWithDefaultCostObjectHierarchyAndStatisticalHierarchyApi<T>
  ) {
    super(_entityApi);
  }
}

export interface AggregatedStatisticalEntriesWithDefaultCostObjectHierarchyAndStatisticalHierarchyType<
  T extends DeSerializers = DefaultDeSerializers
> {
