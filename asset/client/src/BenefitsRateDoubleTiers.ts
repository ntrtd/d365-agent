...
import type { BenefitsRateDoubleTiersApi } from './BenefitsRateDoubleTiersApi';
...
/**
 * This class represents the entity "BenefitsRateDoubleTiers" of service "d365_metadata".
 */
export class BenefitsRateDoubleTiers<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements BenefitsRateDoubleTiersType<T>
{
  /**
   * Technical entity name for BenefitsRateDoubleTiers.
   */
  static override _entityName = 'BenefitsRateDoubleTiers';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the BenefitsRateDoubleTiers entity.
   */
  static _keys = [
    'RateId',
    'RateValidTo',
  ...
  /**
   * Tier Code Id For Single Tier.
   */
  declare tierCodeIdForSingleTier: DeserializedType<T, 'Edm.String'>;
  /**
   * Tier Code Id For Double Tier.
   */
  declare tierCodeIdForDoubleTier: DeserializedType<T, 'Edm.String'>;
  /**
   * Compensation Level.
   * @nullable
   */
  ...
  /**
   * One-to-one navigation property to the {@link BenefitsRateTiers} entity.
   */
  declare rateTiers?: BenefitsRateTiers<T> | null;

  constructor(_entityApi: BenefitsRateDoubleTiersApi<T>) {
    super(_entityApi);
  }
}

export interface BenefitsRateDoubleTiersType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  rateTiers?: BenefitsRateTiersType<T> | null;
}
