...
import type { ProductSpecificOrderSettingsV2Api } from './ProductSpecificOrderSettingsV2Api';
...
/**
 * This class represents the entity "ProductSpecificOrderSettingsV2" of service "d365_metadata".
 */
export class ProductSpecificOrderSettingsV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ProductSpecificOrderSettingsV2Type<T>
{
  /**
   * Technical entity name for ProductSpecificOrderSettingsV2.
   */
  static override _entityName = 'ProductSpecificOrderSettingsV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ProductSpecificOrderSettingsV2 entity.
   */
  static _keys = [
    'dataAreaId',
    'ItemNumber',
  ...
  constructor(_entityApi: ProductSpecificOrderSettingsV2Api<T>) {
    super(_entityApi);
  }
}

export interface ProductSpecificOrderSettingsV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
