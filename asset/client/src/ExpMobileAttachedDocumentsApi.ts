...
import { ExpMobileAttachedDocumentsRequestBuilder } from './ExpMobileAttachedDocumentsRequestBuilder';
...
export class ExpMobileAttachedDocumentsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<ExpMobileAttachedDocuments<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): ExpMobileAttachedDocumentsApi<DeSerializersT> {
    return new ExpMobileAttachedDocumentsApi(deSerializers);
  }
  ...
  entityConstructor = ExpMobileAttachedDocuments;

  requestBuilder(): ExpMobileAttachedDocumentsRequestBuilder<DeSerializersT> {
    return new ExpMobileAttachedDocumentsRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    ExpMobileAttachedDocuments<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof ExpMobileAttachedDocuments,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        ExpMobileAttachedDocuments,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    ENT_REC_ID: OrderableEdmTypeField<
      ExpMobileAttachedDocuments<DeSerializers>,
      DeSerializersT,
      'Edm.Int64',
      false,
      true
    ...
    CAPTURED_RECEIPT: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<ExpMobileAttachedDocuments<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ExpMobileAttachedDocuments)
      };
    }
