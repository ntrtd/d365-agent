...
import type { CdsOpenPurchasePriceJournalLinesV2Api } from './CdsOpenPurchasePriceJournalLinesV2Api';
import { NoYes } from './NoYes';

/**
 * This class represents the entity "CDSOpenPurchasePriceJournalLinesV2" of service "d365_metadata".
 */
export class CdsOpenPurchasePriceJournalLinesV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements CdsOpenPurchasePriceJournalLinesV2Type<T>
{
  /**
   * Technical entity name for CdsOpenPurchasePriceJournalLinesV2.
   */
  static override _entityName = 'CDSOpenPurchasePriceJournalLinesV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the CdsOpenPurchasePriceJournalLinesV2 entity.
   */
  ...
  constructor(_entityApi: CdsOpenPurchasePriceJournalLinesV2Api<T>) {
    super(_entityApi);
  }
}

export interface CdsOpenPurchasePriceJournalLinesV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
