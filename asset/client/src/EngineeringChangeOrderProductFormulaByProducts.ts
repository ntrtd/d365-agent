...
import type { EngineeringChangeOrderProductFormulaByProductsApi } from './EngineeringChangeOrderProductFormulaByProductsApi';
...
/**
 * This class represents the entity "EngineeringChangeOrderProductFormulaByProducts" of service "d365_metadata".
 */
export class EngineeringChangeOrderProductFormulaByProducts<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements EngineeringChangeOrderProductFormulaByProductsType<T>
{
  /**
   * Technical entity name for EngineeringChangeOrderProductFormulaByProducts.
   */
  ...
  /**
   * All key fields of the EngineeringChangeOrderProductFormulaByProducts entity.
   */
  static _keys = [
    'dataAreaId',
  ...
  constructor(
    _entityApi: EngineeringChangeOrderProductFormulaByProductsApi<T>
  ) {
    super(_entityApi);
  }
}

export interface EngineeringChangeOrderProductFormulaByProductsType<
  T extends DeSerializers = DefaultDeSerializers
> {
