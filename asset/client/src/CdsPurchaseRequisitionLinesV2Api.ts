...
import { CdsPurchaseRequisitionLinesV2RequestBuilder } from './CdsPurchaseRequisitionLinesV2RequestBuilder';
...
export class CdsPurchaseRequisitionLinesV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<CdsPurchaseRequisitionLinesV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): CdsPurchaseRequisitionLinesV2Api<DeSerializersT> {
    return new CdsPurchaseRequisitionLinesV2Api(deSerializers);
  }
  ...
  entityConstructor = CdsPurchaseRequisitionLinesV2;

  requestBuilder(): CdsPurchaseRequisitionLinesV2RequestBuilder<DeSerializersT> {
    return new CdsPurchaseRequisitionLinesV2RequestBuilder<DeSerializersT>(
      this
    );
  }

  entityBuilder(): EntityBuilderType<
    CdsPurchaseRequisitionLinesV2<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof CdsPurchaseRequisitionLinesV2,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        CdsPurchaseRequisitionLinesV2,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    REQUISITION_NUMBER: OrderableEdmTypeField<
      CdsPurchaseRequisitionLinesV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    RECEIVING_WAREHOUSE_ID: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<CdsPurchaseRequisitionLinesV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', CdsPurchaseRequisitionLinesV2)
      };
    }
