...
import { CostAccountingDataConnectorMainAccountTypesRequestBuilder } from './CostAccountingDataConnectorMainAccountTypesRequestBuilder';
import {
  CustomField,
...
export class CostAccountingDataConnectorMainAccountTypesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      CostAccountingDataConnectorMainAccountTypes<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): CostAccountingDataConnectorMainAccountTypesApi<DeSerializersT> {
    return new CostAccountingDataConnectorMainAccountTypesApi(deSerializers);
  }
  ...
  entityConstructor = CostAccountingDataConnectorMainAccountTypes;

  requestBuilder(): CostAccountingDataConnectorMainAccountTypesRequestBuilder<DeSerializersT> {
    return new CostAccountingDataConnectorMainAccountTypesRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof CostAccountingDataConnectorMainAccountTypes,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_CONNECTOR_SYSTEM_INSTANCE_SURROGATE_KEY: OrderableEdmTypeField<
      CostAccountingDataConnectorMainAccountTypes<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
