...
import { UnitOfMeasureTranslationsRequestBuilder } from './UnitOfMeasureTranslationsRequestBuilder';
...
export class UnitOfMeasureTranslationsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<UnitOfMeasureTranslations<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new UnitOfMeasureTranslationsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    UNIT_OF_MEASURE: OneToOneLink<
      UnitOfMeasureTranslations<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = UnitOfMeasureTranslations;

  requestBuilder(): UnitOfMeasureTranslationsRequestBuilder<DeSerializersT> {
    return new UnitOfMeasureTranslationsRequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof UnitOfMeasureTranslations,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    UNIT_SYMBOL: OrderableEdmTypeField<
      UnitOfMeasureTranslations<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    UNIT_OF_MEASURE: OneToOneLink<
      ...
      UnitsOfMeasureApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<UnitOfMeasureTranslations<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', UnitOfMeasureTranslations)
      };
    }
