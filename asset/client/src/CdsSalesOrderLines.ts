...
import type { CdsSalesOrderLinesApi } from './CdsSalesOrderLinesApi';
...
/**
 * This class represents the entity "CDSSalesOrderLines" of service "d365_metadata".
 */
export class CdsSalesOrderLines<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements CdsSalesOrderLinesType<T>
{
  /**
   * Technical entity name for CdsSalesOrderLines.
   */
  static override _entityName = 'CDSSalesOrderLines';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the CdsSalesOrderLines entity.
   */
  static _keys = [
    'dataAreaId',
    'SalesOrderNumber',
  ...
  constructor(_entityApi: CdsSalesOrderLinesApi<T>) {
    super(_entityApi);
  }
}

export interface CdsSalesOrderLinesType<
