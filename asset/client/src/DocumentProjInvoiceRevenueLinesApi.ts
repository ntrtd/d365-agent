...
import { DocumentProjInvoiceRevenueLinesRequestBuilder } from './DocumentProjInvoiceRevenueLinesRequestBuilder';
...
export class DocumentProjInvoiceRevenueLinesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<DocumentProjInvoiceRevenueLines<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new DocumentProjInvoiceRevenueLinesApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    DOCUMENT_PROJECT_INVOICE_BASE: OneToOneLink<
      DocumentProjInvoiceRevenueLines<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = DocumentProjInvoiceRevenueLines;

  requestBuilder(): DocumentProjInvoiceRevenueLinesRequestBuilder<DeSerializersT> {
    return new DocumentProjInvoiceRevenueLinesRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof DocumentProjInvoiceRevenueLines,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      DocumentProjInvoiceRevenueLines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    DATA_AREA: OrderableEdmTypeField<
      ...
      true
    >;
    PROJ_INVOICE_REVENUE_TABLE_ID: OrderableEdmTypeField<
      DocumentProjInvoiceRevenueLines<DeSerializers>,
      DeSerializersT,
      'Edm.Int32',
      false,
      true
    >;
    PROJ_INVOICE_REVENUE_REC_ID: OrderableEdmTypeField<
      DocumentProjInvoiceRevenueLines<DeSerializers>,
      DeSerializersT,
      'Edm.Int64',
      false,
    ...
    BUSINESS_DOCUMENT_TAX_TRANSACTION: OneToManyLink<
      ...
      BusinessDocumentTaxTransactionsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<DocumentProjInvoiceRevenueLines<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link projInvoiceRevenueTableId} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PROJ_INVOICE_REVENUE_TABLE_ID: fieldBuilder.buildEdmTypeField(
          'ProjInvoiceRevenueTableId',
          'Edm.Int32',
          false
        ),
        /**
         * Static representation of the {@link projInvoiceRevenueRecId} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PROJ_INVOICE_REVENUE_REC_ID: fieldBuilder.buildEdmTypeField(
          'ProjInvoiceRevenueRecId',
          'Edm.Int64',
          false
        ),
        /**
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', DocumentProjInvoiceRevenueLines)
      };
    }
