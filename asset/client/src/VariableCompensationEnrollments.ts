...
import type { VariableCompensationEnrollmentsApi } from './VariableCompensationEnrollmentsApi';
...
/**
 * This class represents the entity "VariableCompensationEnrollments" of service "d365_metadata".
 */
export class VariableCompensationEnrollments<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements VariableCompensationEnrollmentsType<T>
{
  /**
   * Technical entity name for VariableCompensationEnrollments.
   */
  static override _entityName = 'VariableCompensationEnrollments';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the VariableCompensationEnrollments entity.
   */
  ...
  /**
   * One-to-one navigation property to the {@link CompVarPlanTables} entity.
   */
  declare variableCompensationPlan?: CompVarPlanTables<T> | null;
  /**
   * One-to-one navigation property to the {@link DimensionSets} entity.
   */
  declare dimensionSet?: DimensionSets<T> | null;

  constructor(_entityApi: VariableCompensationEnrollmentsApi<T>) {
    super(_entityApi);
  }
}

export interface VariableCompensationEnrollmentsType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  variableCompensationPlan?: CompVarPlanTablesType<T> | null;
