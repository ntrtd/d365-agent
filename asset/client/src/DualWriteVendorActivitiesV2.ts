...
import type { DualWriteVendorActivitiesV2Api } from './DualWriteVendorActivitiesV2Api';
...
/**
 * This class represents the entity "DualWriteVendorActivitiesV2" of service "d365_metadata".
 */
export class DualWriteVendorActivitiesV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements DualWriteVendorActivitiesV2Type<T>
{
  /**
   * Technical entity name for DualWriteVendorActivitiesV2.
   */
  static override _entityName = 'DualWriteVendorActivitiesV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the DualWriteVendorActivitiesV2 entity.
   */
  ...
  constructor(_entityApi: DualWriteVendorActivitiesV2Api<T>) {
    super(_entityApi);
  }
}

export interface DualWriteVendorActivitiesV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
