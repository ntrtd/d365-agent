...
import { AssetMaintenanceJobTypeDefaultToolsRequestBuilder } from './AssetMaintenanceJobTypeDefaultToolsRequestBuilder';
import {
  CustomField,
...
export class AssetMaintenanceJobTypeDefaultToolsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      AssetMaintenanceJobTypeDefaultTools<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): AssetMaintenanceJobTypeDefaultToolsApi<DeSerializersT> {
    return new AssetMaintenanceJobTypeDefaultToolsApi(deSerializers);
  }
  ...
  entityConstructor = AssetMaintenanceJobTypeDefaultTools;

  requestBuilder(): AssetMaintenanceJobTypeDefaultToolsRequestBuilder<DeSerializersT> {
    return new AssetMaintenanceJobTypeDefaultToolsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof AssetMaintenanceJobTypeDefaultTools,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        AssetMaintenanceJobTypeDefaultTools,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      AssetMaintenanceJobTypeDefaultTools<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    RESOURCE: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<AssetMaintenanceJobTypeDefaultTools<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', AssetMaintenanceJobTypeDefaultTools)
      };
    }
