...
> extends RequestBuilder<Teams<T>, T> {
   ...
   * @param partyNumber Key property. See {@link Teams.partyNumber}.
   ...
   */
  delete(partyNumber: string): DeleteRequestBuilder<Teams<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `Teams`.
  ...
  delete(partyNumberOrEntity: any): DeleteRequestBuilder<Teams<T>, T> {
    return new DeleteRequestBuilder<Teams<T>, T>(
      this.entityApi,
      partyNumberOrEntity instanceof Teams
        ? partyNumberOrEntity
