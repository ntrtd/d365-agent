...
import { VendInvoiceInfoLineTransTaxInformationsRequestBuilder } from './VendInvoiceInfoLineTransTaxInformationsRequestBuilder';
...
export class VendInvoiceInfoLineTransTaxInformationsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      VendInvoiceInfoLineTransTaxInformations<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): VendInvoiceInfoLineTransTaxInformationsApi<DeSerializersT> {
    return new VendInvoiceInfoLineTransTaxInformationsApi(deSerializers);
  }
  ...
  entityConstructor = VendInvoiceInfoLineTransTaxInformations;

  requestBuilder(): VendInvoiceInfoLineTransTaxInformationsRequestBuilder<DeSerializersT> {
    return new VendInvoiceInfoLineTransTaxInformationsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof VendInvoiceInfoLineTransTaxInformations,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        VendInvoiceInfoLineTransTaxInformations,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      VendInvoiceInfoLineTransTaxInformations<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', VendInvoiceInfoLineTransTaxInformations)
      };
    }
