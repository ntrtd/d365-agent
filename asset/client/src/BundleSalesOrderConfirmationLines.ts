...
import type { BundleSalesOrderConfirmationLinesApi } from './BundleSalesOrderConfirmationLinesApi';
...
/**
 * This class represents the entity "BundleSalesOrderConfirmationLines" of service "d365_metadata".
 */
export class BundleSalesOrderConfirmationLines<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements BundleSalesOrderConfirmationLinesType<T>
{
  /**
   * Technical entity name for BundleSalesOrderConfirmationLines.
   */
  static override _entityName = 'BundleSalesOrderConfirmationLines';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the BundleSalesOrderConfirmationLines entity.
   */
  static _keys = [
    'dataAreaId',
    'SalesOrderNumber',
  ...
  constructor(_entityApi: BundleSalesOrderConfirmationLinesApi<T>) {
    super(_entityApi);
  }
}

export interface BundleSalesOrderConfirmationLinesType<
  T extends DeSerializers = DefaultDeSerializers
> {
