...
/**
 * This class represents the entity "Customers" of service "d365_metadata".
 */
  ...
  implements CustomersType<T>
{
   ...
   */
  static override _entityName = 'Customers';
  /**
  ...
  /**
   * Is Rfid Pallet Tagging Enabled.
   * @nullable
   */
  declare isRfidPalletTaggingEnabled?: NoYes | null;
  /**
  ...
  /**
   * Is Rfid Case Tagging Enabled.
   * @nullable
   */
  declare isRfidCaseTaggingEnabled?: NoYes | null;
  /**
   * Enterprise Number.
   * @nullable
   */
  ...
  /**
   * Is Rfid Item Tagging Enabled.
   * @nullable
   */
  declare isRfidItemTaggingEnabled?: NoYes | null;
  /**
   * Customer Group Id.
   * @nullable
   */
...
export interface CustomersType<T extends DeSerializers = DefaultDeSerializers> {
  ...
  isRfidPalletTaggingEnabled?: NoYes | null;
  ...
  isRfidCaseTaggingEnabled?: NoYes | null;
  ...
  isRfidItemTaggingEnabled?: NoYes | null;
