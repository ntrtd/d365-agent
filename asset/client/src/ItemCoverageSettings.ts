...
import type { ItemCoverageSettingsApi } from './ItemCoverageSettingsApi';
...
/**
 * This class represents the entity "ItemCoverageSettings" of service "d365_metadata".
 */
export class ItemCoverageSettings<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ItemCoverageSettingsType<T>
{
  /**
   * Technical entity name for ItemCoverageSettings.
   */
  static override _entityName = 'ItemCoverageSettings';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ItemCoverageSettings entity.
   */
  static _keys = [
    'dataAreaId',
    'ItemNumber',
   ...
   */
  declare coverageWarehouse?: Warehouses<T> | null;
  /**
   ...
   */
  declare coverageSite?: OperationalSites<T> | null;
  /**
   * One-to-one navigation property to the {@link WarehouseLocations} entity.
   */
  declare coverageWarehouseLocation?: WarehouseLocations<T> | null;
  /**
   ...
   * One-to-one navigation property to the {@link Warehouses} entity.
   */
  declare defaultPlannedTransferOrderFromWarehouse?: Warehouses<T> | null;
  /**
   * One-to-one navigation property to the {@link ReleasedProductsV2} entity.
   */
  declare planningFormulaReleasedProduct?: ReleasedProductsV2<T> | null;

  constructor(_entityApi: ItemCoverageSettingsApi<T>) {
    super(_entityApi);
  }
}

export interface ItemCoverageSettingsType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  coverageWarehouse?: WarehousesType<T> | null;
  vendor?: VendorsV2Type<T> | null;
  coverageSite?: OperationalSitesType<T> | null;
  coverageWarehouseLocation?: WarehouseLocationsType<T> | null;
  releasedProduct?: ReleasedProductsV2Type<T> | null;
  defaultPlannedTransferOrderFromWarehouse?: WarehousesType<T> | null;
  planningFormulaReleasedProduct?: ReleasedProductsV2Type<T> | null;
}
