...
import type { LtmVendTablesApi } from './LtmVendTablesApi';

/**
 * This class represents the entity "LTMVendTables" of service "d365_metadata".
 */
export class LtmVendTables<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements LtmVendTablesType<T>
{
  /**
   * Technical entity name for LtmVendTables.
   */
  static override _entityName = 'LTMVendTables';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the LtmVendTables entity.
   */
  ...
  constructor(_entityApi: LtmVendTablesApi<T>) {
    super(_entityApi);
  }
}

export interface LtmVendTablesType<
