...
import type { InventItemPricesApi } from './InventItemPricesApi';
import { CostingVersionPriceType } from './CostingVersionPriceType';
import { NoYes } from './NoYes';

/**
 * This class represents the entity "InventItemPrices" of service "d365_metadata".
 */
export class InventItemPrices<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements InventItemPricesType<T>
{
  /**
   * Technical entity name for InventItemPrices.
   */
  static override _entityName = 'InventItemPrices';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the InventItemPrices entity.
   */
  static _keys = [
    'dataAreaId',
    'ItemNumber',
  ...
  constructor(_entityApi: InventItemPricesApi<T>) {
    super(_entityApi);
  }
}

export interface InventItemPricesType<
