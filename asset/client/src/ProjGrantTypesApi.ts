...
import { ProjGrantTypesRequestBuilder } from './ProjGrantTypesRequestBuilder';
...
export class ProjGrantTypesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<ProjGrantTypes<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): ProjGrantTypesApi<DeSerializersT> {
    return new ProjGrantTypesApi(deSerializers);
  }
  ...
  entityConstructor = ProjGrantTypes;

  requestBuilder(): ProjGrantTypesRequestBuilder<DeSerializersT> {
    return new ProjGrantTypesRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    ProjGrantTypes<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<ProjGrantTypes<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<ProjGrantTypes<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof ProjGrantTypes, DeSerializersT>;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(ProjGrantTypes, this.deSerializers);
    }
  ...
  private _schema?: {
    ...
    FEDERAL_MANDATE: EnumField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<ProjGrantTypes<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ProjGrantTypes)
      };
    }
