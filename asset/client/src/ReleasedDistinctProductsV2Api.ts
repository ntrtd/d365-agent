...
import { ReleasedDistinctProductsV2RequestBuilder } from './ReleasedDistinctProductsV2RequestBuilder';
...
export class ReleasedDistinctProductsV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<ReleasedDistinctProductsV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new ReleasedDistinctProductsV2Api(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    OPEN_SALES_PRICE_JOURNAL_LINE: OneToManyLink<
      ReleasedDistinctProductsV2<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = ReleasedDistinctProductsV2;

  requestBuilder(): ReleasedDistinctProductsV2RequestBuilder<DeSerializersT> {
    return new ReleasedDistinctProductsV2RequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof ReleasedDistinctProductsV2,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ReleasedDistinctProductsV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    PRODUCT_TRANSLATION: OneToManyLink<
      ...
      ProductTranslationsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<ReleasedDistinctProductsV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ReleasedDistinctProductsV2)
      };
    }
