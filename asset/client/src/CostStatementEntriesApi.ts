...
import { CostStatementEntriesRequestBuilder } from './CostStatementEntriesRequestBuilder';
...
export class CostStatementEntriesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<CostStatementEntries<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new CostStatementEntriesApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    OPERATIONAL_SITE: OneToOneLink<
      CostStatementEntries<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = CostStatementEntries;

  requestBuilder(): CostStatementEntriesRequestBuilder<DeSerializersT> {
    return new CostStatementEntriesRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<CostStatementEntries<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      CostStatementEntries<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    COST_RESOURCE_TYPE: EnumField<
      ...
      true
    >;
    COST_RESOURCE_ID: OrderableEdmTypeField<
      CostStatementEntries<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
    ...
    OPERATIONAL_SITE: OneToOneLink<
      ...
      OperationalSitesApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<CostStatementEntries<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link costResourceId} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        COST_RESOURCE_ID: fieldBuilder.buildEdmTypeField(
          'CostResourceId',
          'Edm.String',
          false
        ),
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', CostStatementEntries)
      };
    }
