...
import { CdsSalesOrderLinesV2RequestBuilder } from './CdsSalesOrderLinesV2RequestBuilder';
...
export class CdsSalesOrderLinesV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<CdsSalesOrderLinesV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new CdsSalesOrderLinesV2Api(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    CDS_SALES_ORDER_HEADER: OneToOneLink<
      CdsSalesOrderLinesV2<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    linkedApis: [CdsSalesOrderHeadersApi<DeSerializersT>]
  ): this {
  ...
  entityConstructor = CdsSalesOrderLinesV2;

  requestBuilder(): CdsSalesOrderLinesV2RequestBuilder<DeSerializersT> {
    return new CdsSalesOrderLinesV2RequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<CdsSalesOrderLinesV2<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      CdsSalesOrderLinesV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    CDS_SALES_ORDER_HEADER: OneToOneLink<
      ...
      CdsSalesOrderHeadersApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<CdsSalesOrderLinesV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', CdsSalesOrderLinesV2)
      };
    }
