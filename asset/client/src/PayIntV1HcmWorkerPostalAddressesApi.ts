...
import { PayIntV1HcmWorkerPostalAddressesRequestBuilder } from './PayIntV1HcmWorkerPostalAddressesRequestBuilder';
...
export class PayIntV1HcmWorkerPostalAddressesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<PayIntV1HcmWorkerPostalAddresses<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): PayIntV1HcmWorkerPostalAddressesApi<DeSerializersT> {
    return new PayIntV1HcmWorkerPostalAddressesApi(deSerializers);
  }
  ...
  entityConstructor = PayIntV1HcmWorkerPostalAddresses;

  requestBuilder(): PayIntV1HcmWorkerPostalAddressesRequestBuilder<DeSerializersT> {
    return new PayIntV1HcmWorkerPostalAddressesRequestBuilder<DeSerializersT>(
      this
    );
  }

  entityBuilder(): EntityBuilderType<
    PayIntV1HcmWorkerPostalAddresses<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof PayIntV1HcmWorkerPostalAddresses,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        PayIntV1HcmWorkerPostalAddresses,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    PERSONNEL_NUMBER: OrderableEdmTypeField<
      PayIntV1HcmWorkerPostalAddresses<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    ADDRESS_APARTMENT: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<PayIntV1HcmWorkerPostalAddresses<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PayIntV1HcmWorkerPostalAddresses)
      };
    }
