...
import type { BillOfMaterialsVersionsV3Api } from './BillOfMaterialsVersionsV3Api';
...
/**
 * This class represents the entity "BillOfMaterialsVersionsV3" of service "d365_metadata".
 */
export class BillOfMaterialsVersionsV3<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements BillOfMaterialsVersionsV3Type<T>
{
  /**
   * Technical entity name for BillOfMaterialsVersionsV3.
   */
  static override _entityName = 'BillOfMaterialsVersionsV3';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the BillOfMaterialsVersionsV3 entity.
   */
  static _keys = [
    'dataAreaId',
  ...
  constructor(_entityApi: BillOfMaterialsVersionsV3Api<T>) {
    super(_entityApi);
  }
}

export interface BillOfMaterialsVersionsV3Type<
  T extends DeSerializers = DefaultDeSerializers
> {
