...
import type { AggregatedDemandsApi } from './AggregatedDemandsApi';
import { ReqDemPlanDemandCategory } from './ReqDemPlanDemandCategory';

/**
 * This class represents the entity "AggregatedDemands" of service "d365_metadata".
 */
export class AggregatedDemands<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements AggregatedDemandsType<T>
{
  /**
   * Technical entity name for AggregatedDemands.
   */
  static override _entityName = 'AggregatedDemands';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the AggregatedDemands entity.
   */
  static _keys = [
    'dataAreaId',
    'DemandCategory',
  ...
  constructor(_entityApi: AggregatedDemandsApi<T>) {
    super(_entityApi);
  }
}

export interface AggregatedDemandsType<
