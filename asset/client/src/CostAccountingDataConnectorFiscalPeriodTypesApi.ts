...
import { CostAccountingDataConnectorFiscalPeriodTypesRequestBuilder } from './CostAccountingDataConnectorFiscalPeriodTypesRequestBuilder';
import {
  CustomField,
...
export class CostAccountingDataConnectorFiscalPeriodTypesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      CostAccountingDataConnectorFiscalPeriodTypes<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): CostAccountingDataConnectorFiscalPeriodTypesApi<DeSerializersT> {
    return new CostAccountingDataConnectorFiscalPeriodTypesApi(deSerializers);
  }
  ...
  entityConstructor = CostAccountingDataConnectorFiscalPeriodTypes;

  requestBuilder(): CostAccountingDataConnectorFiscalPeriodTypesRequestBuilder<DeSerializersT> {
    return new CostAccountingDataConnectorFiscalPeriodTypesRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof CostAccountingDataConnectorFiscalPeriodTypes,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_CONNECTOR_SYSTEM_INSTANCE_SURROGATE_KEY: OrderableEdmTypeField<
      CostAccountingDataConnectorFiscalPeriodTypes<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
