...
import type { WorkerEducationApi } from './WorkerEducationApi';
import { PeriodUnit } from './PeriodUnit';
import { HcmEducationCreditBasis } from './HcmEducationCreditBasis';

/**
 * This class represents the entity "WorkerEducation" of service "d365_metadata".
 */
export class WorkerEducation<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements WorkerEducationType<T>
{
  /**
   * Technical entity name for WorkerEducation.
   */
  static override _entityName = 'WorkerEducation';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the WorkerEducation entity.
   */
  static _keys = [
    'PersonnelNumber',
  ...
  constructor(_entityApi: WorkerEducationApi<T>) {
    super(_entityApi);
  }
}

export interface WorkerEducationType<
