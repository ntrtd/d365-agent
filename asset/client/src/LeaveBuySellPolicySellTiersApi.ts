...
import { LeaveBuySellPolicySellTiersRequestBuilder } from './LeaveBuySellPolicySellTiersRequestBuilder';
...
export class LeaveBuySellPolicySellTiersApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<LeaveBuySellPolicySellTiers<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new LeaveBuySellPolicySellTiersApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    EARNING_CODE: OneToOneLink<
      LeaveBuySellPolicySellTiers<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = LeaveBuySellPolicySellTiers;

  requestBuilder(): LeaveBuySellPolicySellTiersRequestBuilder<DeSerializersT> {
    return new LeaveBuySellPolicySellTiersRequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof LeaveBuySellPolicySellTiers,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      LeaveBuySellPolicySellTiers<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    LEAVE_BUY_SELL_POLICY: OneToOneLink<
      ...
      LeaveBuySellPoliciesApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<LeaveBuySellPolicySellTiers<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', LeaveBuySellPolicySellTiers)
      };
    }
