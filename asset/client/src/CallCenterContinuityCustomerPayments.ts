...
import type { CallCenterContinuityCustomerPaymentsApi } from './CallCenterContinuityCustomerPaymentsApi';
import { NoYes } from './NoYes';
import { McrCustPaymStatus } from './McrCustPaymStatus';
import { McrCustPaymType } from './McrCustPaymType';

/**
 * This class represents the entity "CallCenterContinuityCustomerPayments" of service "d365_metadata".
 */
export class CallCenterContinuityCustomerPayments<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements CallCenterContinuityCustomerPaymentsType<T>
{
  /**
   * Technical entity name for CallCenterContinuityCustomerPayments.
   */
  static override _entityName = 'CallCenterContinuityCustomerPayments';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the CallCenterContinuityCustomerPayments entity.
   */
  static _keys = [
    'dataAreaId',
    'LineNumber',
  ...
  /**
   * Continuity Inventory Transaction Id.
   */
  declare continuityInventoryTransactionId: DeserializedType<T, 'Edm.String'>;
  /**
   * Continuity Schedule Id.
   */
  declare continuityScheduleId: DeserializedType<T, 'Edm.String'>;
  /**
   * Is Plan Refund.
   * @nullable
   */
  ...
  constructor(_entityApi: CallCenterContinuityCustomerPaymentsApi<T>) {
    super(_entityApi);
  }
}

export interface CallCenterContinuityCustomerPaymentsType<
  T extends DeSerializers = DefaultDeSerializers
> {
