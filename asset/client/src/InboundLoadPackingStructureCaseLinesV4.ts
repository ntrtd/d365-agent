...
import type { InboundLoadPackingStructureCaseLinesV4Api } from './InboundLoadPackingStructureCaseLinesV4Api';
import { WhsModule } from './WhsModule';

/**
 * This class represents the entity "InboundLoadPackingStructureCaseLinesV4" of service "d365_metadata".
 */
export class InboundLoadPackingStructureCaseLinesV4<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements InboundLoadPackingStructureCaseLinesV4Type<T>
{
  /**
   * Technical entity name for InboundLoadPackingStructureCaseLinesV4.
   */
  static override _entityName = 'InboundLoadPackingStructureCaseLinesV4';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the InboundLoadPackingStructureCaseLinesV4 entity.
   */
  static _keys = [
    'dataAreaId',
    'InboundShipmentId',
  ...
  constructor(_entityApi: InboundLoadPackingStructureCaseLinesV4Api<T>) {
    super(_entityApi);
  }
}

export interface InboundLoadPackingStructureCaseLinesV4Type<
  T extends DeSerializers = DefaultDeSerializers
> {
