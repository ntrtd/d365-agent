...
import type { ProductReceiptHeadersApi } from './ProductReceiptHeadersApi';
import { NoYes } from './NoYes';
import { Timezone } from './Timezone';
import {
  ProductReceiptLinesV2,
  ProductReceiptLinesV2Type
} from './ProductReceiptLinesV2';

/**
 * This class represents the entity "ProductReceiptHeaders" of service "d365_metadata".
 */
export class ProductReceiptHeaders<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ProductReceiptHeadersType<T>
{
  /**
   * Technical entity name for ProductReceiptHeaders.
   */
  static override _entityName = 'ProductReceiptHeaders';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ProductReceiptHeaders entity.
   */
  ...
  /**
   * One-to-many navigation property to the {@link ProductReceiptLinesV2} entity.
   */
  declare productReceiptLines: ProductReceiptLinesV2<T>[];

  constructor(_entityApi: ProductReceiptHeadersApi<T>) {
    super(_entityApi);
  }
}

export interface ProductReceiptHeadersType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  productReceiptLines: ProductReceiptLinesV2Type<T>[];
}
