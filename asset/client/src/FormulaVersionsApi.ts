...
import { FormulaVersionsRequestBuilder } from './FormulaVersionsRequestBuilder';
...
export class FormulaVersionsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<FormulaVersions<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new FormulaVersionsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    PRODUCT_STYLE: OneToOneLink<
      FormulaVersions<DeSerializersT>,
      DeSerializersT,
    ...
    >;
    /**
     * Static representation of the one-to-one navigation property {@link manufacturedReleasedProductV2} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    MANUFACTURED_RELEASED_PRODUCT_V_2: OneToOneLink<
      FormulaVersions<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ...
      MANUFACTURED_RELEASED_PRODUCT_V_2: new OneToOneLink(
        'ManufacturedReleasedProductV2',
        this,
        linkedApis[2]
      )
    };
  ...
  entityConstructor = FormulaVersions;

  requestBuilder(): FormulaVersionsRequestBuilder<DeSerializersT> {
    return new FormulaVersionsRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<FormulaVersions<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<FormulaVersions<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof FormulaVersions, DeSerializersT>;
  get fieldBuilder() {
  ...
  private _schema?: {
    ...
    MANUFACTURED_RELEASED_PRODUCT_V_2: OneToOneLink<
      ...
      ReleasedProductsV2Api<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<FormulaVersions<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', FormulaVersions)
      };
    }
