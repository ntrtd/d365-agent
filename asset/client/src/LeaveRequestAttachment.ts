...
import type { LeaveRequestAttachmentApi } from './LeaveRequestAttachmentApi';
import { NoYes } from './NoYes';
import { DocuRestriction } from './DocuRestriction';
import { DocuStorageProviderType } from './DocuStorageProviderType';

/**
 * This class represents the entity "LeaveRequestAttachment" of service "d365_metadata".
 */
export class LeaveRequestAttachment<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements LeaveRequestAttachmentType<T>
{
  /**
   * Technical entity name for LeaveRequestAttachment.
   */
  static override _entityName = 'LeaveRequestAttachment';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the LeaveRequestAttachment entity.
   */
  ...
  constructor(_entityApi: LeaveRequestAttachmentApi<T>) {
    super(_entityApi);
  }
}

export interface LeaveRequestAttachmentType<
  T extends DeSerializers = DefaultDeSerializers
> {
