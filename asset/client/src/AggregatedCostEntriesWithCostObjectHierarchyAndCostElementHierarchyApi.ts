...
import { AggregatedCostEntriesWithCostObjectHierarchyAndCostElementHierarchyRequestBuilder } from './AggregatedCostEntriesWithCostObjectHierarchyAndCostElementHierarchyRequestBuilder';
...
export class AggregatedCostEntriesWithCostObjectHierarchyAndCostElementHierarchyApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      AggregatedCostEntriesWithCostObjectHierarchyAndCostElementHierarchy<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): AggregatedCostEntriesWithCostObjectHierarchyAndCostElementHierarchyApi<DeSerializersT> {
    return new AggregatedCostEntriesWithCostObjectHierarchyAndCostElementHierarchyApi(
      deSerializers
    );
  }
  ...
  requestBuilder(): AggregatedCostEntriesWithCostObjectHierarchyAndCostElementHierarchyRequestBuilder<DeSerializersT> {
    return new AggregatedCostEntriesWithCostObjectHierarchyAndCostElementHierarchyRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof AggregatedCostEntriesWithCostObjectHierarchyAndCostElementHierarchy,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    COST_CONTROL_UNIT_NAME: OrderableEdmTypeField<
      AggregatedCostEntriesWithCostObjectHierarchyAndCostElementHierarchy<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
