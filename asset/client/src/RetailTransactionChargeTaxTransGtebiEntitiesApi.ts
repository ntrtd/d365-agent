...
import { RetailTransactionChargeTaxTransGtebiEntitiesRequestBuilder } from './RetailTransactionChargeTaxTransGtebiEntitiesRequestBuilder';
...
export class RetailTransactionChargeTaxTransGtebiEntitiesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      RetailTransactionChargeTaxTransGtebiEntities<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): RetailTransactionChargeTaxTransGtebiEntitiesApi<DeSerializersT> {
    return new RetailTransactionChargeTaxTransGtebiEntitiesApi(deSerializers);
  }
  ...
  entityConstructor = RetailTransactionChargeTaxTransGtebiEntities;

  requestBuilder(): RetailTransactionChargeTaxTransGtebiEntitiesRequestBuilder<DeSerializersT> {
    return new RetailTransactionChargeTaxTransGtebiEntitiesRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof RetailTransactionChargeTaxTransGtebiEntities,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        RetailTransactionChargeTaxTransGtebiEntities,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      RetailTransactionChargeTaxTransGtebiEntities<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
