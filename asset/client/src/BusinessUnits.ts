...
import type { BusinessUnitsApi } from './BusinessUnitsApi';
import { NoYes } from './NoYes';
import { Timezone } from './Timezone';
import { OmOperatingUnitType } from './OmOperatingUnitType';

/**
 * This class represents the entity "BusinessUnits" of service "d365_metadata".
 */
export class BusinessUnits<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements BusinessUnitsType<T>
{
  /**
   * Technical entity name for BusinessUnits.
   */
  static override _entityName = 'BusinessUnits';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the BusinessUnits entity.
   */
  ...
  constructor(_entityApi: BusinessUnitsApi<T>) {
    super(_entityApi);
  }
}
