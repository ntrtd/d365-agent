...
import type { PurchaseLineDiscountAgreementsApi } from './PurchaseLineDiscountAgreementsApi';
import { NoYes } from './NoYes';

/**
 * This class represents the entity "PurchaseLineDiscountAgreements" of service "d365_metadata".
 */
export class PurchaseLineDiscountAgreements<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements PurchaseLineDiscountAgreementsType<T>
{
  /**
   * Technical entity name for PurchaseLineDiscountAgreements.
   */
  static override _entityName = 'PurchaseLineDiscountAgreements';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the PurchaseLineDiscountAgreements entity.
   */
  ...
  constructor(_entityApi: PurchaseLineDiscountAgreementsApi<T>) {
    super(_entityApi);
  }
}

export interface PurchaseLineDiscountAgreementsType<
  T extends DeSerializers = DefaultDeSerializers
> {
