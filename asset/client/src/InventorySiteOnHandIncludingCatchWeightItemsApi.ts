...
import { InventorySiteOnHandIncludingCatchWeightItemsRequestBuilder } from './InventorySiteOnHandIncludingCatchWeightItemsRequestBuilder';
...
export class InventorySiteOnHandIncludingCatchWeightItemsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      InventorySiteOnHandIncludingCatchWeightItems<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): InventorySiteOnHandIncludingCatchWeightItemsApi<DeSerializersT> {
    return new InventorySiteOnHandIncludingCatchWeightItemsApi(deSerializers);
  }
  ...
  entityConstructor = InventorySiteOnHandIncludingCatchWeightItems;

  requestBuilder(): InventorySiteOnHandIncludingCatchWeightItemsRequestBuilder<DeSerializersT> {
    return new InventorySiteOnHandIncludingCatchWeightItemsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof InventorySiteOnHandIncludingCatchWeightItems,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        InventorySiteOnHandIncludingCatchWeightItems,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      InventorySiteOnHandIncludingCatchWeightItems<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
