...
import type { PayIntV1HcmWorkerPostalAddressesApi } from './PayIntV1HcmWorkerPostalAddressesApi';
import { NoYes } from './NoYes';
import { Timezone } from './Timezone';

/**
 * This class represents the entity "PayIntV1HcmWorkerPostalAddresses" of service "d365_metadata".
 */
export class PayIntV1HcmWorkerPostalAddresses<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements PayIntV1HcmWorkerPostalAddressesType<T>
{
  /**
   * Technical entity name for PayIntV1HcmWorkerPostalAddresses.
   */
  static override _entityName = 'PayIntV1HcmWorkerPostalAddresses';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the PayIntV1HcmWorkerPostalAddresses entity.
   */
  ...
  constructor(_entityApi: PayIntV1HcmWorkerPostalAddressesApi<T>) {
    super(_entityApi);
  }
}

export interface PayIntV1HcmWorkerPostalAddressesType<
  T extends DeSerializers = DefaultDeSerializers
> {
