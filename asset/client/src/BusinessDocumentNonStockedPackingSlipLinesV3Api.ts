...
import { BusinessDocumentNonStockedPackingSlipLinesV3RequestBuilder } from './BusinessDocumentNonStockedPackingSlipLinesV3RequestBuilder';
...
export class BusinessDocumentNonStockedPackingSlipLinesV3Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      BusinessDocumentNonStockedPackingSlipLinesV3<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    ...
    return new BusinessDocumentNonStockedPackingSlipLinesV3Api(deSerializers);
  }
  ...
  entityConstructor = BusinessDocumentNonStockedPackingSlipLinesV3;

  requestBuilder(): BusinessDocumentNonStockedPackingSlipLinesV3RequestBuilder<DeSerializersT> {
    return new BusinessDocumentNonStockedPackingSlipLinesV3RequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof BusinessDocumentNonStockedPackingSlipLinesV3,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      BusinessDocumentNonStockedPackingSlipLinesV3<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
