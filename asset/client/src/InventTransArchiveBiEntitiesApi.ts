...
import { InventTransArchiveBiEntitiesRequestBuilder } from './InventTransArchiveBiEntitiesRequestBuilder';
...
export class InventTransArchiveBiEntitiesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<InventTransArchiveBiEntities<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): InventTransArchiveBiEntitiesApi<DeSerializersT> {
    return new InventTransArchiveBiEntitiesApi(deSerializers);
  }
  ...
  entityConstructor = InventTransArchiveBiEntities;

  requestBuilder(): InventTransArchiveBiEntitiesRequestBuilder<DeSerializersT> {
    return new InventTransArchiveBiEntitiesRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    InventTransArchiveBiEntities<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof InventTransArchiveBiEntities,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        InventTransArchiveBiEntities,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      InventTransArchiveBiEntities<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    INVOICE_RETURNED: EnumField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<InventTransArchiveBiEntities<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', InventTransArchiveBiEntities)
      };
    }
