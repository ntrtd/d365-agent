...
import { MultilineDiscountCustomerGroupsRequestBuilder } from './MultilineDiscountCustomerGroupsRequestBuilder';
...
export class MultilineDiscountCustomerGroupsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<MultilineDiscountCustomerGroups<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new MultilineDiscountCustomerGroupsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    OPEN_SALES_MULTI_LINE_DISCOUNT_JOURNAL_LINE: OneToManyLink<
      MultilineDiscountCustomerGroups<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    linkedApis: [OpenSalesMultiLineDiscountJournalLinesApi<DeSerializersT>]
  ): this {
  ...
  entityConstructor = MultilineDiscountCustomerGroups;

  requestBuilder(): MultilineDiscountCustomerGroupsRequestBuilder<DeSerializersT> {
    return new MultilineDiscountCustomerGroupsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof MultilineDiscountCustomerGroups,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      MultilineDiscountCustomerGroups<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    OPEN_SALES_MULTI_LINE_DISCOUNT_JOURNAL_LINE: OneToManyLink<
      ...
      OpenSalesMultiLineDiscountJournalLinesApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<MultilineDiscountCustomerGroups<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', MultilineDiscountCustomerGroups)
      };
    }
