...
import { ItemHazardousMaterialsDetailsV3RequestBuilder } from './ItemHazardousMaterialsDetailsV3RequestBuilder';
...
export class ItemHazardousMaterialsDetailsV3Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<ItemHazardousMaterialsDetailsV3<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): ItemHazardousMaterialsDetailsV3Api<DeSerializersT> {
    return new ItemHazardousMaterialsDetailsV3Api(deSerializers);
  }
  ...
  entityConstructor = ItemHazardousMaterialsDetailsV3;

  requestBuilder(): ItemHazardousMaterialsDetailsV3RequestBuilder<DeSerializersT> {
    return new ItemHazardousMaterialsDetailsV3RequestBuilder<DeSerializersT>(
      this
    );
  }

  entityBuilder(): EntityBuilderType<
    ItemHazardousMaterialsDetailsV3<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof ItemHazardousMaterialsDetailsV3,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        ItemHazardousMaterialsDetailsV3,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ItemHazardousMaterialsDetailsV3<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    PACK_CODE: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<ItemHazardousMaterialsDetailsV3<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ItemHazardousMaterialsDetailsV3)
      };
    }
