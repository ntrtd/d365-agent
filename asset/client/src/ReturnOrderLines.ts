...
import type { ReturnOrderLinesApi } from './ReturnOrderLinesApi';
...
import {
  ReturnOrderHeaders,
  ReturnOrderHeadersType
} from './ReturnOrderHeaders';
import {
...
/**
 * This class represents the entity "ReturnOrderLines" of service "d365_metadata".
 */
export class ReturnOrderLines<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements ReturnOrderLinesType<T>
{
  /**
   * Technical entity name for ReturnOrderLines.
   */
  static override _entityName = 'ReturnOrderLines';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ReturnOrderLines entity.
   */
  ...
  /**
   * One-to-one navigation property to the {@link ReturnOrderHeaders} entity.
   */
  declare returnOrderHeader?: ReturnOrderHeaders<T> | null;
  /**
   * One-to-one navigation property to the {@link DimensionCombinations} entity.
   */
  declare dimensionCombination?: DimensionCombinations<T> | null;

  constructor(_entityApi: ReturnOrderLinesApi<T>) {
    super(_entityApi);
  }
}

export interface ReturnOrderLinesType<
...
> {
  ...
  returnOrderHeader?: ReturnOrderHeadersType<T> | null;
