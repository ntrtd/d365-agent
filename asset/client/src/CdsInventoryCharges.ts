...
import type { CdsInventoryChargesApi } from './CdsInventoryChargesApi';
...
/**
 * This class represents the entity "CDSInventoryCharges" of service "d365_metadata".
 */
export class CdsInventoryCharges<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements CdsInventoryChargesType<T>
{
  /**
   * Technical entity name for CdsInventoryCharges.
   */
  static override _entityName = 'CDSInventoryCharges';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the CdsInventoryCharges entity.
   */
  ...
  constructor(_entityApi: CdsInventoryChargesApi<T>) {
    super(_entityApi);
  }
}

export interface CdsInventoryChargesType<
