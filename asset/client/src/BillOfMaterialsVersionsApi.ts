...
import { BillOfMaterialsVersionsRequestBuilder } from './BillOfMaterialsVersionsRequestBuilder';
...
export class BillOfMaterialsVersionsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<BillOfMaterialsVersions<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new BillOfMaterialsVersionsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    APPROVING_WORKER: OneToOneLink<
      BillOfMaterialsVersions<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = BillOfMaterialsVersions;

  requestBuilder(): BillOfMaterialsVersionsRequestBuilder<DeSerializersT> {
    return new BillOfMaterialsVersionsRequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof BillOfMaterialsVersions,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      BillOfMaterialsVersions<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    BILL_OF_MATERIALS_HEADER: OneToOneLink<
      ...
      BillOfMaterialsHeadersApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<BillOfMaterialsVersions<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', BillOfMaterialsVersions)
      };
    }
