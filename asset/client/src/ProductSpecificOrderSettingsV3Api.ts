...
import { ProductSpecificOrderSettingsV3RequestBuilder } from './ProductSpecificOrderSettingsV3RequestBuilder';
...
export class ProductSpecificOrderSettingsV3Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<ProductSpecificOrderSettingsV3<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new ProductSpecificOrderSettingsV3Api(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    DV_RELEASED_PRODUCT: OneToOneLink<
      ProductSpecificOrderSettingsV3<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = ProductSpecificOrderSettingsV3;

  requestBuilder(): ProductSpecificOrderSettingsV3RequestBuilder<DeSerializersT> {
    return new ProductSpecificOrderSettingsV3RequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof ProductSpecificOrderSettingsV3,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ProductSpecificOrderSettingsV3<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    INVENTORY_ATP_TIME_FENCE_DAYS: OrderableEdmTypeField<
      ...
      true
    >;
    GUP_DISCOUNT_CLAIM_VENDOR_ACCOUNT: OrderableEdmTypeField<
      ProductSpecificOrderSettingsV3<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    RELEASED_PRODUCT_V_2: OneToOneLink<
      ...
      ReleasedProductsV2Api<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<ProductSpecificOrderSettingsV3<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link gupDiscountClaimVendorAccount} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        GUP_DISCOUNT_CLAIM_VENDOR_ACCOUNT: fieldBuilder.buildEdmTypeField(
          'GUPDiscountClaimVendorAccount',
          'Edm.String',
          true
        ),
        ...this.navigationPropertyFields,
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ProductSpecificOrderSettingsV3)
      };
    }
