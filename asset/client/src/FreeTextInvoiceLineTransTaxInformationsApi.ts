...
import { FreeTextInvoiceLineTransTaxInformationsRequestBuilder } from './FreeTextInvoiceLineTransTaxInformationsRequestBuilder';
...
export class FreeTextInvoiceLineTransTaxInformationsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      FreeTextInvoiceLineTransTaxInformations<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): FreeTextInvoiceLineTransTaxInformationsApi<DeSerializersT> {
    return new FreeTextInvoiceLineTransTaxInformationsApi(deSerializers);
  }
  ...
  entityConstructor = FreeTextInvoiceLineTransTaxInformations;

  requestBuilder(): FreeTextInvoiceLineTransTaxInformationsRequestBuilder<DeSerializersT> {
    return new FreeTextInvoiceLineTransTaxInformationsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof FreeTextInvoiceLineTransTaxInformations,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        FreeTextInvoiceLineTransTaxInformations,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      FreeTextInvoiceLineTransTaxInformations<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', FreeTextInvoiceLineTransTaxInformations)
      };
    }
