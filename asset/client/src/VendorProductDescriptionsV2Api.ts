...
import { VendorProductDescriptionsV2RequestBuilder } from './VendorProductDescriptionsV2RequestBuilder';
...
export class VendorProductDescriptionsV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<VendorProductDescriptionsV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new VendorProductDescriptionsV2Api(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
     ...
     */
    VENDOR: OneToOneLink<
      VendorProductDescriptionsV2<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = VendorProductDescriptionsV2;

  requestBuilder(): VendorProductDescriptionsV2RequestBuilder<DeSerializersT> {
    return new VendorProductDescriptionsV2RequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof VendorProductDescriptionsV2,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      VendorProductDescriptionsV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    RELEASED_PRODUCT: OneToOneLink<
      ...
      ReleasedProductsV2Api<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<VendorProductDescriptionsV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', VendorProductDescriptionsV2)
      };
    }
