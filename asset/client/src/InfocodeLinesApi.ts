...
import { InfocodeLinesRequestBuilder } from './InfocodeLinesRequestBuilder';
...
export class InfocodeLinesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<InfocodeLines<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): InfocodeLinesApi<DeSerializersT> {
    return new InfocodeLinesApi(deSerializers);
  }
  ...
  entityConstructor = InfocodeLines;

  requestBuilder(): InfocodeLinesRequestBuilder<DeSerializersT> {
    return new InfocodeLinesRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    InfocodeLines<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<InfocodeLines<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<InfocodeLines<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof InfocodeLines, DeSerializersT>;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(InfocodeLines, this.deSerializers);
    }
  ...
  private _schema?: {
    ...
    ITEM_TENDER: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<InfocodeLines<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', InfocodeLines)
      };
    }
