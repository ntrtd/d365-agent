...
import { RoyaltyAgreementLineProductSelectionsV2RequestBuilder } from './RoyaltyAgreementLineProductSelectionsV2RequestBuilder';
...
export class RoyaltyAgreementLineProductSelectionsV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      RoyaltyAgreementLineProductSelectionsV2<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    ...
    return new RoyaltyAgreementLineProductSelectionsV2Api(deSerializers);
  }
  ...
  entityConstructor = RoyaltyAgreementLineProductSelectionsV2;

  requestBuilder(): RoyaltyAgreementLineProductSelectionsV2RequestBuilder<DeSerializersT> {
    return new RoyaltyAgreementLineProductSelectionsV2RequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof RoyaltyAgreementLineProductSelectionsV2,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      RoyaltyAgreementLineProductSelectionsV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', RoyaltyAgreementLineProductSelectionsV2)
      };
    }
