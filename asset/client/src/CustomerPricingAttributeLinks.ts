...
import type { CustomerPricingAttributeLinksApi } from './CustomerPricingAttributeLinksApi';
...
/**
 * This class represents the entity "CustomerPricingAttributeLinks" of service "d365_metadata".
 */
export class CustomerPricingAttributeLinks<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements CustomerPricingAttributeLinksType<T>
{
  /**
   * Technical entity name for CustomerPricingAttributeLinks.
   */
  static override _entityName = 'CustomerPricingAttributeLinks';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the CustomerPricingAttributeLinks entity.
   */
  static _keys = [
  ...
  constructor(_entityApi: CustomerPricingAttributeLinksApi<T>) {
    super(_entityApi);
  }
}

export interface CustomerPricingAttributeLinksType<
  T extends DeSerializers = DefaultDeSerializers
> {
