...
import type { ContractorsV2Api } from './ContractorsV2Api';
...
/**
 * This class represents the entity "ContractorsV2" of service "d365_metadata".
 */
export class ContractorsV2<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements ContractorsV2Type<T>
{
  /**
   * Technical entity name for ContractorsV2.
   */
  static override _entityName = 'ContractorsV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ContractorsV2 entity.
   */
  ...
  constructor(_entityApi: ContractorsV2Api<T>) {
    super(_entityApi);
  }
}

export interface ContractorsV2Type<
