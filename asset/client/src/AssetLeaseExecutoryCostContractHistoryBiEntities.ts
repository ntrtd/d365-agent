...
import type { AssetLeaseExecutoryCostContractHistoryBiEntitiesApi } from './AssetLeaseExecutoryCostContractHistoryBiEntitiesApi';
...
/**
 * This class represents the entity "AssetLeaseExecutoryCostContractHistoryBiEntities" of service "d365_metadata".
 */
export class AssetLeaseExecutoryCostContractHistoryBiEntities<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements AssetLeaseExecutoryCostContractHistoryBiEntitiesType<T>
{
  /**
   * Technical entity name for AssetLeaseExecutoryCostContractHistoryBiEntities.
   */
  ...
  /**
   * All key fields of the AssetLeaseExecutoryCostContractHistoryBiEntities entity.
   */
  ...
  constructor(
    _entityApi: AssetLeaseExecutoryCostContractHistoryBiEntitiesApi<T>
  ) {
    super(_entityApi);
  }
}

export interface AssetLeaseExecutoryCostContractHistoryBiEntitiesType<
  T extends DeSerializers = DefaultDeSerializers
> {
