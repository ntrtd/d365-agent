...
import { CallCenterContinuityCustomerPaymentsRequestBuilder } from './CallCenterContinuityCustomerPaymentsRequestBuilder';
...
export class CallCenterContinuityCustomerPaymentsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      CallCenterContinuityCustomerPayments<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): CallCenterContinuityCustomerPaymentsApi<DeSerializersT> {
    return new CallCenterContinuityCustomerPaymentsApi(deSerializers);
  }
  ...
  entityConstructor = CallCenterContinuityCustomerPayments;

  requestBuilder(): CallCenterContinuityCustomerPaymentsRequestBuilder<DeSerializersT> {
    return new CallCenterContinuityCustomerPaymentsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof CallCenterContinuityCustomerPayments,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        CallCenterContinuityCustomerPayments,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      CallCenterContinuityCustomerPayments<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    LINE_NUMBER: OrderableEdmTypeField<
      ...
      true
    >;
    CONTINUITY_INVENTORY_TRANSACTION_ID: OrderableEdmTypeField<
      CallCenterContinuityCustomerPayments<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
    ...
    PAYMENT_SCHED_ID: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<CallCenterContinuityCustomerPayments<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link continuityInventoryTransactionId} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CONTINUITY_INVENTORY_TRANSACTION_ID: fieldBuilder.buildEdmTypeField(
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', CallCenterContinuityCustomerPayments)
      };
    }
