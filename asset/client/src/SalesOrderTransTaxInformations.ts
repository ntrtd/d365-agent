...
import type { SalesOrderTransTaxInformationsApi } from './SalesOrderTransTaxInformationsApi';
...
/**
 * This class represents the entity "SalesOrderTransTaxInformations" of service "d365_metadata".
 */
export class SalesOrderTransTaxInformations<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements SalesOrderTransTaxInformationsType<T>
{
  /**
   * Technical entity name for SalesOrderTransTaxInformations.
   */
  static override _entityName = 'SalesOrderTransTaxInformations';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the SalesOrderTransTaxInformations entity.
   */
  static _keys = [
    'dataAreaId',
    'SalesOrderNumber',
  ...
  constructor(_entityApi: SalesOrderTransTaxInformationsApi<T>) {
    super(_entityApi);
  }
}

export interface SalesOrderTransTaxInformationsType<
  T extends DeSerializers = DefaultDeSerializers
> {
