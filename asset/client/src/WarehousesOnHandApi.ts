...
import { WarehousesOnHandRequestBuilder } from './WarehousesOnHandRequestBuilder';
...
export class WarehousesOnHandApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<WarehousesOnHand<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): WarehousesOnHandApi<DeSerializersT> {
    return new WarehousesOnHandApi(deSerializers);
  }
  ...
  entityConstructor = WarehousesOnHand;

  requestBuilder(): WarehousesOnHandRequestBuilder<DeSerializersT> {
    return new WarehousesOnHandRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    WarehousesOnHand<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<WarehousesOnHand<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  ): CustomField<WarehousesOnHand<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof WarehousesOnHand, DeSerializersT>;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      WarehousesOnHand<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    TOTAL_AVAILABLE_QUANTITY: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<WarehousesOnHand<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', WarehousesOnHand)
      };
    }
