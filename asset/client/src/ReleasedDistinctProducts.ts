...
import type { ReleasedDistinctProductsApi } from './ReleasedDistinctProductsApi';
...
/**
 * This class represents the entity "ReleasedDistinctProducts" of service "d365_metadata".
 */
export class ReleasedDistinctProducts<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ReleasedDistinctProductsType<T>
{
  /**
   * Technical entity name for ReleasedDistinctProducts.
   */
  static override _entityName = 'ReleasedDistinctProducts';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ReleasedDistinctProducts entity.
   */
  ...
  /**
   * Potency Base Attribute Id.
   * @nullable
   */
  declare potencyBaseAttributeId?: DeserializedType<T, 'Edm.String'> | null;
  /**
  ...
  constructor(_entityApi: ReleasedDistinctProductsApi<T>) {
    super(_entityApi);
  }
}

export interface ReleasedDistinctProductsType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  potencyBaseAttributeId?: DeserializedType<T, 'Edm.String'> | null;
