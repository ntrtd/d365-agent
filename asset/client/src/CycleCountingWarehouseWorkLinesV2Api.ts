...
import { CycleCountingWarehouseWorkLinesV2RequestBuilder } from './CycleCountingWarehouseWorkLinesV2RequestBuilder';
...
export class CycleCountingWarehouseWorkLinesV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<CycleCountingWarehouseWorkLinesV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new CycleCountingWarehouseWorkLinesV2Api(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    WAREHOUSE_LOCATION: OneToOneLink<
      CycleCountingWarehouseWorkLinesV2<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = CycleCountingWarehouseWorkLinesV2;

  requestBuilder(): CycleCountingWarehouseWorkLinesV2RequestBuilder<DeSerializersT> {
    return new CycleCountingWarehouseWorkLinesV2RequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof CycleCountingWarehouseWorkLinesV2,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      CycleCountingWarehouseWorkLinesV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    LICENSE_PLATE: OneToOneLink<
      ...
      LicensePlatesApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<CycleCountingWarehouseWorkLinesV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', CycleCountingWarehouseWorkLinesV2)
      };
    }
