...
import type { ShipConsolidationPoliciesV2Api } from './ShipConsolidationPoliciesV2Api';
...
/**
 * This class represents the entity "ShipConsolidationPoliciesV2" of service "d365_metadata".
 */
export class ShipConsolidationPoliciesV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ShipConsolidationPoliciesV2Type<T>
{
  /**
   * Technical entity name for ShipConsolidationPoliciesV2.
   */
  static override _entityName = 'ShipConsolidationPoliciesV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ShipConsolidationPoliciesV2 entity.
   */
  static _keys = [
    'dataAreaId',
  ...
  constructor(_entityApi: ShipConsolidationPoliciesV2Api<T>) {
    super(_entityApi);
  }
}

export interface ShipConsolidationPoliciesV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
