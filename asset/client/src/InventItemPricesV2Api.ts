...
import { InventItemPricesV2RequestBuilder } from './InventItemPricesV2RequestBuilder';
...
export class InventItemPricesV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<InventItemPricesV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): InventItemPricesV2Api<DeSerializersT> {
    return new InventItemPricesV2Api(deSerializers);
  }
  ...
  entityConstructor = InventItemPricesV2;

  requestBuilder(): InventItemPricesV2RequestBuilder<DeSerializersT> {
    return new InventItemPricesV2RequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    InventItemPricesV2<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<InventItemPricesV2<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      InventItemPricesV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    IS_PRICE_INCLUDING_CHARGES: EnumField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<InventItemPricesV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', InventItemPricesV2)
      };
    }
