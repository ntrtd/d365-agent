...
import type { ReleasedProductMastersApi } from './ReleasedProductMastersApi';
...
/**
 * This class represents the entity "ReleasedProductMasters" of service "d365_metadata".
 */
export class ReleasedProductMasters<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ReleasedProductMastersType<T>
{
  /**
   * Technical entity name for ReleasedProductMasters.
   */
  static override _entityName = 'ReleasedProductMasters';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ReleasedProductMasters entity.
   */
  ...
  constructor(_entityApi: ReleasedProductMastersApi<T>) {
    super(_entityApi);
  }
}

export interface ReleasedProductMastersType<
  T extends DeSerializers = DefaultDeSerializers
> {
