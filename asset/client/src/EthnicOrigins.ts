...
import type { EthnicOriginsApi } from './EthnicOriginsApi';
...
/**
 * This class represents the entity "EthnicOrigins" of service "d365_metadata".
 */
export class EthnicOrigins<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements EthnicOriginsType<T>
{
  /**
   * Technical entity name for EthnicOrigins.
   */
  static override _entityName = 'EthnicOrigins';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the EthnicOrigins entity.
   */
  static _keys = ['EthnicOriginId'];
  /**
   * Ethnic Origin Id.
   */
  declare ethnicOriginId: DeserializedType<T, 'Edm.String'>;
  /**
   * Eeo Ethnic Origin.
   * @nullable
   */
  declare eeoEthnicOrigin?: HcmEeoEthnicOrigin | null;
  /**
   * Description.
   * @nullable
   */
  ...
  constructor(_entityApi: EthnicOriginsApi<T>) {
    super(_entityApi);
  }
}

export interface EthnicOriginsType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ethnicOriginId: DeserializedType<T, 'Edm.String'>;
  eeoEthnicOrigin?: HcmEeoEthnicOrigin | null;
