...
import { DualWriteSalesOrderActivitiesV2RequestBuilder } from './DualWriteSalesOrderActivitiesV2RequestBuilder';
...
export class DualWriteSalesOrderActivitiesV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<DualWriteSalesOrderActivitiesV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): DualWriteSalesOrderActivitiesV2Api<DeSerializersT> {
    return new DualWriteSalesOrderActivitiesV2Api(deSerializers);
  }
  ...
  entityConstructor = DualWriteSalesOrderActivitiesV2;

  requestBuilder(): DualWriteSalesOrderActivitiesV2RequestBuilder<DeSerializersT> {
    return new DualWriteSalesOrderActivitiesV2RequestBuilder<DeSerializersT>(
      this
    );
  }

  entityBuilder(): EntityBuilderType<
    DualWriteSalesOrderActivitiesV2<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof DualWriteSalesOrderActivitiesV2,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        DualWriteSalesOrderActivitiesV2,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      DualWriteSalesOrderActivitiesV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    SOURCE: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<DualWriteSalesOrderActivitiesV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', DualWriteSalesOrderActivitiesV2)
      };
    }
