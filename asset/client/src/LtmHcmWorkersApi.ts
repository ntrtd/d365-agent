...
import { LtmHcmWorkersRequestBuilder } from './LtmHcmWorkersRequestBuilder';
import {
  CustomField,
...
export class LtmHcmWorkersApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<LtmHcmWorkers<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): LtmHcmWorkersApi<DeSerializersT> {
    return new LtmHcmWorkersApi(deSerializers);
  }
  ...
  entityConstructor = LtmHcmWorkers;

  requestBuilder(): LtmHcmWorkersRequestBuilder<DeSerializersT> {
    return new LtmHcmWorkersRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    LtmHcmWorkers<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<LtmHcmWorkers<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<LtmHcmWorkers<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof LtmHcmWorkers, DeSerializersT>;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(LtmHcmWorkers, this.deSerializers);
    }
  ...
  private _schema?: {
    ...
    NOTE_1: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<LtmHcmWorkers<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', LtmHcmWorkers)
      };
    }
