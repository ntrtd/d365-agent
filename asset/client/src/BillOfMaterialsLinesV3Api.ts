...
import { BillOfMaterialsLinesV3RequestBuilder } from './BillOfMaterialsLinesV3RequestBuilder';
...
export class BillOfMaterialsLinesV3Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<BillOfMaterialsLinesV3<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new BillOfMaterialsLinesV3Api(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    RECEIVED_PRODUCT_RELEASE_LINES: OneToManyLink<
      BillOfMaterialsLinesV3<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ...
      VENDOR: new OneToOneLink('Vendor', this, linkedApis[2]),
      BILL_OF_MATERIALS_HEADER: new OneToOneLink(
        'BillOfMaterialsHeader',
        this,
        linkedApis[3]
      ),
      ROUTE_HEADER: new OneToOneLink('RouteHeader', this, linkedApis[4]),
  ...
  entityConstructor = BillOfMaterialsLinesV3;

  requestBuilder(): BillOfMaterialsLinesV3RequestBuilder<DeSerializersT> {
    return new BillOfMaterialsLinesV3RequestBuilder<DeSerializersT>(this);
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      BillOfMaterialsLinesV3<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    SUB_BILL_OF_MATERIALS_HEADER: OneToOneLink<
      ...
      BillOfMaterialsHeadersApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<BillOfMaterialsLinesV3<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', BillOfMaterialsLinesV3)
      };
    }
