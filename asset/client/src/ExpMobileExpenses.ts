...
import type { ExpMobileExpensesApi } from './ExpMobileExpensesApi';
...
/**
 * This class represents the entity "ExpMobileExpenses" of service "d365_metadata".
 */
export class ExpMobileExpenses<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements ExpMobileExpensesType<T>
{
  /**
   * Technical entity name for ExpMobileExpenses.
   */
  static override _entityName = 'ExpMobileExpenses';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ExpMobileExpenses entity.
   */
  ...
  constructor(_entityApi: ExpMobileExpensesApi<T>) {
    super(_entityApi);
  }
}

export interface ExpMobileExpensesType<
