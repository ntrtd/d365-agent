...
import type { InventTransBiEntitiesApi } from './InventTransBiEntitiesApi';
...
/**
 * This class represents the entity "InventTransBiEntities" of service "d365_metadata".
 */
export class InventTransBiEntities<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements InventTransBiEntitiesType<T>
{
  /**
   * Technical entity name for InventTransBiEntities.
   */
  static override _entityName = 'InventTransBiEntities';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the InventTransBiEntities entity.
   */
  ...
  constructor(_entityApi: InventTransBiEntitiesApi<T>) {
    super(_entityApi);
  }
}

export interface InventTransBiEntitiesType<
  T extends DeSerializers = DefaultDeSerializers
> {
