...
import { InventoryMovementJournalEntriesV4RequestBuilder } from './InventoryMovementJournalEntriesV4RequestBuilder';
...
export class InventoryMovementJournalEntriesV4Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<InventoryMovementJournalEntriesV4<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): InventoryMovementJournalEntriesV4Api<DeSerializersT> {
    return new InventoryMovementJournalEntriesV4Api(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    DIMENSION_SET: OneToOneLink<
      InventoryMovementJournalEntriesV4<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = InventoryMovementJournalEntriesV4;

  requestBuilder(): InventoryMovementJournalEntriesV4RequestBuilder<DeSerializersT> {
    return new InventoryMovementJournalEntriesV4RequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof InventoryMovementJournalEntriesV4,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      InventoryMovementJournalEntriesV4<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    DIMENSION_COMBINATION: OneToOneLink<
      ...
      DimensionCombinationsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<InventoryMovementJournalEntriesV4<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', InventoryMovementJournalEntriesV4)
      };
    }
