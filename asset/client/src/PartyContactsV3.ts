...
import type { PartyContactsV3Api } from './PartyContactsV3Api';
...
/**
 * This class represents the entity "PartyContactsV3" of service "d365_metadata".
 */
export class PartyContactsV3<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements PartyContactsV3Type<T>
{
  /**
   * Technical entity name for PartyContactsV3.
   */
  static override _entityName = 'PartyContactsV3';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the PartyContactsV3 entity.
   */
  ...
  constructor(_entityApi: PartyContactsV3Api<T>) {
    super(_entityApi);
  }
}

export interface PartyContactsV3Type<
