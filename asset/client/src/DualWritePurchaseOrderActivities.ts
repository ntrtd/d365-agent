...
import type { DualWritePurchaseOrderActivitiesApi } from './DualWritePurchaseOrderActivitiesApi';
...
/**
 * This class represents the entity "DualWritePurchaseOrderActivities" of service "d365_metadata".
 */
export class DualWritePurchaseOrderActivities<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements DualWritePurchaseOrderActivitiesType<T>
{
  /**
   * Technical entity name for DualWritePurchaseOrderActivities.
   */
  static override _entityName = 'DualWritePurchaseOrderActivities';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the DualWritePurchaseOrderActivities entity.
   */
  ...
  constructor(_entityApi: DualWritePurchaseOrderActivitiesApi<T>) {
    super(_entityApi);
  }
}

export interface DualWritePurchaseOrderActivitiesType<
  T extends DeSerializers = DefaultDeSerializers
> {
