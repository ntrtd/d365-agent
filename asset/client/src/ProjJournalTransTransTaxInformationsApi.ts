...
import { ProjJournalTransTransTaxInformationsRequestBuilder } from './ProjJournalTransTransTaxInformationsRequestBuilder';
...
export class ProjJournalTransTransTaxInformationsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      ProjJournalTransTransTaxInformations<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): ProjJournalTransTransTaxInformationsApi<DeSerializersT> {
    return new ProjJournalTransTransTaxInformationsApi(deSerializers);
  }
  ...
  entityConstructor = ProjJournalTransTransTaxInformations;

  requestBuilder(): ProjJournalTransTransTaxInformationsRequestBuilder<DeSerializersT> {
    return new ProjJournalTransTransTaxInformationsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof ProjJournalTransTransTaxInformations,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        ProjJournalTransTransTaxInformations,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ProjJournalTransTransTaxInformations<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    EXCISE_IS_SCRAP: EnumField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<ProjJournalTransTransTaxInformations<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ProjJournalTransTransTaxInformations)
      };
    }
