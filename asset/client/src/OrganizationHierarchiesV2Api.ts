...
import { OrganizationHierarchiesV2RequestBuilder } from './OrganizationHierarchiesV2RequestBuilder';
import {
  CustomField,
...
export class OrganizationHierarchiesV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<OrganizationHierarchiesV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): OrganizationHierarchiesV2Api<DeSerializersT> {
    return new OrganizationHierarchiesV2Api(deSerializers);
  }
  ...
  entityConstructor = OrganizationHierarchiesV2;

  requestBuilder(): OrganizationHierarchiesV2RequestBuilder<DeSerializersT> {
    return new OrganizationHierarchiesV2RequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    OrganizationHierarchiesV2<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof OrganizationHierarchiesV2,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        OrganizationHierarchiesV2,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    HIERARCHY_TYPE: OrderableEdmTypeField<
      OrganizationHierarchiesV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    PARENT_ORGANIZATION_NAME: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<OrganizationHierarchiesV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', OrganizationHierarchiesV2)
      };
    }
