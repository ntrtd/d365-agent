...
import { ContractorsRequestBuilder } from './ContractorsRequestBuilder';
...
> implements EntityApi<Contractors<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new ContractorsApi(deSerializers);
  }
  ...
  entityConstructor = Contractors;

  requestBuilder(): ContractorsRequestBuilder<DeSerializersT> {
    return new ContractorsRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<Contractors<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<Contractors<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof Contractors, DeSerializersT>;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(Contractors, this.deSerializers);
    }
  ...
  private _schema?: {
    ...
    WORK_CALENDAR: OneToOneLink<
      ...
      WorkCalendarsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<Contractors<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', Contractors)
      };
    }
