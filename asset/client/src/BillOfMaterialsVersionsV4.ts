...
import type { BillOfMaterialsVersionsV4Api } from './BillOfMaterialsVersionsV4Api';
...
/**
 * This class represents the entity "BillOfMaterialsVersionsV4" of service "d365_metadata".
 */
export class BillOfMaterialsVersionsV4<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements BillOfMaterialsVersionsV4Type<T>
{
  /**
   * Technical entity name for BillOfMaterialsVersionsV4.
   */
  static override _entityName = 'BillOfMaterialsVersionsV4';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the BillOfMaterialsVersionsV4 entity.
   */
  static _keys = [
    'dataAreaId',
  ...
  constructor(_entityApi: BillOfMaterialsVersionsV4Api<T>) {
    super(_entityApi);
  }
}

export interface BillOfMaterialsVersionsV4Type<
  T extends DeSerializers = DefaultDeSerializers
> {
