...
import { InventTransBiEntitiesRequestBuilder } from './InventTransBiEntitiesRequestBuilder';
...
export class InventTransBiEntitiesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<InventTransBiEntities<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): InventTransBiEntitiesApi<DeSerializersT> {
    return new InventTransBiEntitiesApi(deSerializers);
  }
  ...
  entityConstructor = InventTransBiEntities;

  requestBuilder(): InventTransBiEntitiesRequestBuilder<DeSerializersT> {
    return new InventTransBiEntitiesRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    InventTransBiEntities<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<InventTransBiEntities<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      InventTransBiEntities<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    VOUCHER_PHYSICAL: OrderableEdmTypeField<
      ...
      true
    >;
    INVENT_TRANS_ORIGIN_SALES_RU: OrderableEdmTypeField<
      InventTransBiEntities<DeSerializers>,
      DeSerializersT,
      'Edm.Int64',
      false,
    ...
    INVOICE_RETURNED: EnumField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<InventTransBiEntities<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link inventTransOriginSalesRu} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        INVENT_TRANS_ORIGIN_SALES_RU: fieldBuilder.buildEdmTypeField(
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', InventTransBiEntities)
      };
    }
