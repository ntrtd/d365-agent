...
import { PriceAdjustmentInquiryResultsRequestBuilder } from './PriceAdjustmentInquiryResultsRequestBuilder';
...
export class PriceAdjustmentInquiryResultsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<PriceAdjustmentInquiryResults<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): PriceAdjustmentInquiryResultsApi<DeSerializersT> {
    return new PriceAdjustmentInquiryResultsApi(deSerializers);
  }
  ...
  entityConstructor = PriceAdjustmentInquiryResults;

  requestBuilder(): PriceAdjustmentInquiryResultsRequestBuilder<DeSerializersT> {
    return new PriceAdjustmentInquiryResultsRequestBuilder<DeSerializersT>(
      this
    );
  }

  entityBuilder(): EntityBuilderType<
    PriceAdjustmentInquiryResults<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof PriceAdjustmentInquiryResults,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        PriceAdjustmentInquiryResults,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      PriceAdjustmentInquiryResults<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    PRICE_ATTRIBUTE_GROUP_NAME: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<PriceAdjustmentInquiryResults<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PriceAdjustmentInquiryResults)
      };
    }
