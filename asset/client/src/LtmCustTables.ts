...
import type { LtmCustTablesApi } from './LtmCustTablesApi';

/**
 * This class represents the entity "LTMCustTables" of service "d365_metadata".
 */
export class LtmCustTables<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements LtmCustTablesType<T>
{
  /**
   * Technical entity name for LtmCustTables.
   */
  static override _entityName = 'LTMCustTables';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the LtmCustTables entity.
   */
   ...
   * @nullable
   */
  declare accountTypeGroupId?: DeserializedType<T, 'Edm.String'> | null;
  /**
   * Tax Payer Type Id.
   * @nullable
   */
  ...
  constructor(_entityApi: LtmCustTablesApi<T>) {
    super(_entityApi);
  }
}

export interface LtmCustTablesType<
...
> {
  ...
  accountTypeGroupId?: DeserializedType<T, 'Edm.String'> | null;
