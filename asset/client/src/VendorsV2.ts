...
import type { VendorsV2Api } from './VendorsV2Api';
...
import {
  ...
  VendorDocumentAttachmentsType
} from './VendorDocumentAttachments';
...
import {
  ...
  PurchaseOrderResponseHeadersType
} from './PurchaseOrderResponseHeaders';
...
/**
 * This class represents the entity "VendorsV2" of service "d365_metadata".
 */
export class VendorsV2<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements VendorsV2Type<T>
{
  /**
   * Technical entity name for VendorsV2.
   */
  static override _entityName = 'VendorsV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the VendorsV2 entity.
   */
  ...
  /**
   * Purchase Ship Calendar Id.
   * @nullable
   */
  declare purchaseShipCalendarId?: DeserializedType<T, 'Edm.String'> | null;
  /**
   * Vendor Type.
   * @nullable
   */
  ...
  /**
   * Default Agent Vendor Account Number.
   * @nullable
   */
  declare defaultAgentVendorAccountNumber?: DeserializedType<
    T,
    'Edm.String'
  > | null;
  /**
  ...
  > | null;
  /**
   * Is Transportation Services Provider.
   * @nullable
   */
  declare isTransportationServicesProvider?: NoYes | null;
  /**
   * Shipping Vendor Type.
   * @nullable
   */
  declare shippingVendorType?: ItmVendType | null;
  /**
   * Vendor Cost Type Group.
   * @nullable
   */
  declare vendorCostTypeGroup?: DeserializedType<T, 'Edm.String'> | null;
  /**
   * Default From Shipping Port Id.
   * @nullable
   */
  declare defaultFromShippingPortId?: DeserializedType<T, 'Edm.String'> | null;
  /**
   * Is Import Costing Vendor.
   * @nullable
   */
  declare isImportCostingVendor?: NoYes | null;
  /**
  ...
  /**
   * One-to-many navigation property to the {@link VendorDocumentAttachments} entity.
   */
  declare vendorDocumentAttachmentEntity: VendorDocumentAttachments<T>[];
  /**
   ...
   */
  declare purchaseAgreementHeaders: PurchaseAgreementConfirmationLines<T>[];
  /**
   * One-to-many navigation property to the {@link PurchaseAgreementConfirmationLines} entity.
   */
  declare purchaseAgreementConfirmationHeaders: PurchaseAgreementConfirmationLines<T>[];
  /**
  ...
  /**
   * One-to-many navigation property to the {@link PurchaseOrderResponseHeaders} entity.
   */
  declare purchaseOrderResponseHeaders: PurchaseOrderResponseHeaders<T>[];
  /**
   * One-to-many navigation property to the {@link FixedAssetBooksV2} entity.
   */
  declare assetBookV2VendorsAsset: FixedAssetBooksV2<T>[];
  /**
  ...
  /**
   * One-to-one navigation property to the {@link TradeAllowanceAgreementMerchandisingEventLumpSums} entity.
   */
  declare tradeAllowanceAgreementMerchandisingEventLumpSums?: TradeAllowanceAgreementMerchandisingEventLumpSums<T> | null;
  /**
  ...
  constructor(_entityApi: VendorsV2Api<T>) {
    super(_entityApi);
  }
}

export interface VendorsV2Type<T extends DeSerializers = DefaultDeSerializers> {
  ...
  purchaseShipCalendarId?: DeserializedType<T, 'Edm.String'> | null;
  ...
  defaultAgentVendorAccountNumber?: DeserializedType<T, 'Edm.String'> | null;
  vendorOverUnderdeliveryToleranceGroupId?: DeserializedType<
    T,
    'Edm.String'
  > | null;
  isTransportationServicesProvider?: NoYes | null;
  shippingVendorType?: ItmVendType | null;
  vendorCostTypeGroup?: DeserializedType<T, 'Edm.String'> | null;
  defaultFromShippingPortId?: DeserializedType<T, 'Edm.String'> | null;
  isImportCostingVendor?: NoYes | null;
  ...
  vendorDocumentAttachmentEntity: VendorDocumentAttachmentsType<T>[];
  formulaLinesV2: FormulaLinesV2Type<T>[];
  purchaseAgreementHeaders: PurchaseAgreementConfirmationLinesType<T>[];
  purchaseAgreementConfirmationHeaders: PurchaseAgreementConfirmationLinesType<T>[];
  ...
  purchaseOrderResponseHeaders: PurchaseOrderResponseHeadersType<T>[];
  assetBookV2VendorsAsset: FixedAssetBooksV2Type<T>[];
  ...
  tradeAllowanceAgreementMerchandisingEventLumpSums?: TradeAllowanceAgreementMerchandisingEventLumpSumsType<T> | null;
