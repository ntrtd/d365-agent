...
import { EngineeringChangeOrderProductsRequestBuilder } from './EngineeringChangeOrderProductsRequestBuilder';
...
export class EngineeringChangeOrderProductsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<EngineeringChangeOrderProducts<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new EngineeringChangeOrderProductsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    ENGINEERING_CHANGE_ORDER_PRODUCT_ATTRIBUTES: OneToManyLink<
      EngineeringChangeOrderProducts<DeSerializersT>,
      DeSerializersT,
    ...
    >;
    /**
     * Static representation of the one-to-many navigation property {@link engineeringChangeOrderProductBillOfMaterialsHeaders} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ENGINEERING_CHANGE_ORDER_PRODUCT_BILL_OF_MATERIALS_HEADERS: OneToManyLink<
      EngineeringChangeOrderProducts<DeSerializersT>,
      DeSerializersT,
    ...
    >;
    /**
     * Static representation of the one-to-many navigation property {@link engineeringChangeOrderProductRouteHeaders} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ENGINEERING_CHANGE_ORDER_PRODUCT_ROUTE_HEADERS: OneToManyLink<
      EngineeringChangeOrderProducts<DeSerializersT>,
      DeSerializersT,
    ...
    >;
    /**
     * Static representation of the one-to-one navigation property {@link currentProductVersion} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CURRENT_PRODUCT_VERSION: OneToOneLink<
      EngineeringChangeOrderProducts<DeSerializersT>,
      DeSerializersT,
    ...
    >;
    /**
     * Static representation of the one-to-one navigation property {@link newProductVersion} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    NEW_PRODUCT_VERSION: OneToOneLink<
      EngineeringChangeOrderProducts<DeSerializersT>,
      DeSerializersT,
      ProductVersionsApi<DeSerializersT>
    >;
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ...
      ENGINEERING_CHANGE_ORDER_PRODUCT_BILL_OF_MATERIALS_HEADERS:
        new OneToManyLink(
      ...
      ENGINEERING_CHANGE_ORDER_PRODUCT_ROUTE_HEADERS: new OneToManyLink(
      ...
      CURRENT_PRODUCT_VERSION: new OneToOneLink(
        'CurrentProductVersion',
        this,
        linkedApis[13]
      ),
      PRODUCT_OWNER: new OneToOneLink('ProductOwner', this, linkedApis[14]),
      NEW_PRODUCT_VERSION: new OneToOneLink(
        'NewProductVersion',
        this,
        linkedApis[15]
      ),
  ...
  entityConstructor = EngineeringChangeOrderProducts;

  requestBuilder(): EngineeringChangeOrderProductsRequestBuilder<DeSerializersT> {
    return new EngineeringChangeOrderProductsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof EngineeringChangeOrderProducts,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      EngineeringChangeOrderProducts<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    PRODUCT_DESCRIPTION: OrderableEdmTypeField<
      ...
      true
    >;
    ENGINEERING_CHANGE_IMPACT_TYPE: EnumField<
      EngineeringChangeOrderProducts<DeSerializers>,
      DeSerializersT,
      EngChgEcmImpact,
      true,
    ...
    ENGINEERING_CHANGE_ORDER_PRODUCT_ROUTE_HEADERS_V_2: OneToManyLink<
      ...
      EngineeringChangeOrderProductRouteHeadersV2Api<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<EngineeringChangeOrderProducts<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link engineeringChangeImpactType} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ENGINEERING_CHANGE_IMPACT_TYPE: fieldBuilder.buildEnumField(
          'EngineeringChangeImpactType',
          EngChgEcmImpact,
          true
        ),
        /**
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', EngineeringChangeOrderProducts)
      };
    }
