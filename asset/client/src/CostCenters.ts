...
import type { CostCentersApi } from './CostCentersApi';
import { NoYes } from './NoYes';
import { Timezone } from './Timezone';
import { OmOperatingUnitType } from './OmOperatingUnitType';

/**
 * This class represents the entity "CostCenters" of service "d365_metadata".
 */
export class CostCenters<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements CostCentersType<T>
{
  /**
   * Technical entity name for CostCenters.
   */
  static override _entityName = 'CostCenters';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the CostCenters entity.
   */
  ...
  constructor(_entityApi: CostCentersApi<T>) {
    super(_entityApi);
  }
}
