...
import { PurchaseRequisitionLinesRequestBuilder } from './PurchaseRequisitionLinesRequestBuilder';
...
export class PurchaseRequisitionLinesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<PurchaseRequisitionLines<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new PurchaseRequisitionLinesApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    DIMENSION_SET: OneToOneLink<
      PurchaseRequisitionLines<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = PurchaseRequisitionLines;

  requestBuilder(): PurchaseRequisitionLinesRequestBuilder<DeSerializersT> {
    return new PurchaseRequisitionLinesRequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof PurchaseRequisitionLines,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    REQUISITION_NUMBER: OrderableEdmTypeField<
      PurchaseRequisitionLines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    PURCHASE_REQUISITION_HEADER: OneToOneLink<
      ...
      PurchaseRequisitionHeadersApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<PurchaseRequisitionLines<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PurchaseRequisitionLines)
      };
    }
