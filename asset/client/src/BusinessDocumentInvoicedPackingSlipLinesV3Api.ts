...
import { BusinessDocumentInvoicedPackingSlipLinesV3RequestBuilder } from './BusinessDocumentInvoicedPackingSlipLinesV3RequestBuilder';
...
export class BusinessDocumentInvoicedPackingSlipLinesV3Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      BusinessDocumentInvoicedPackingSlipLinesV3<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    ...
    return new BusinessDocumentInvoicedPackingSlipLinesV3Api(deSerializers);
  }
  ...
  entityConstructor = BusinessDocumentInvoicedPackingSlipLinesV3;

  requestBuilder(): BusinessDocumentInvoicedPackingSlipLinesV3RequestBuilder<DeSerializersT> {
    return new BusinessDocumentInvoicedPackingSlipLinesV3RequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof BusinessDocumentInvoicedPackingSlipLinesV3,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      BusinessDocumentInvoicedPackingSlipLinesV3<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
