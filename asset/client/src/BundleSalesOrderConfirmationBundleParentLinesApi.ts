...
import { BundleSalesOrderConfirmationBundleParentLinesRequestBuilder } from './BundleSalesOrderConfirmationBundleParentLinesRequestBuilder';
...
export class BundleSalesOrderConfirmationBundleParentLinesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      BundleSalesOrderConfirmationBundleParentLines<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    ...
    return new BundleSalesOrderConfirmationBundleParentLinesApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    >;
    /**
     * Static representation of the one-to-many navigation property {@link bundleSalesOrderConfirmationBundleRootParentLines} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BUNDLE_SALES_ORDER_CONFIRMATION_BUNDLE_ROOT_PARENT_LINES: OneToManyLink<
      BundleSalesOrderConfirmationBundleParentLines<DeSerializersT>,
      DeSerializersT,
      BundleSalesOrderConfirmationBundleParentLinesApi<DeSerializersT>
    >;
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      CURRENCIES: new OneToOneLink('Currencies', this, linkedApis[0]),
      ...
      BUNDLE_SALES_ORDER_CONFIRMATION_BUNDLE_ROOT_PARENT_LINES:
        new OneToManyLink(
          'BundleSalesOrderConfirmationBundleRootParentLines',
          this,
          linkedApis[4]
        ),
      ...
      DELIVERY_TERMS: new OneToOneLink('DeliveryTerms', this, linkedApis[11]),
  ...
  entityConstructor = BundleSalesOrderConfirmationBundleParentLines;

  requestBuilder(): BundleSalesOrderConfirmationBundleParentLinesRequestBuilder<DeSerializersT> {
    return new BundleSalesOrderConfirmationBundleParentLinesRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof BundleSalesOrderConfirmationBundleParentLines,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      BundleSalesOrderConfirmationBundleParentLines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
