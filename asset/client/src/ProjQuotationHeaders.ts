...
import type { ProjQuotationHeadersApi } from './ProjQuotationHeadersApi';
...
/**
 * This class represents the entity "ProjQuotationHeaders" of service "d365_metadata".
 */
export class ProjQuotationHeaders<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ProjQuotationHeadersType<T>
{
  /**
   * Technical entity name for ProjQuotationHeaders.
   */
  static override _entityName = 'ProjQuotationHeaders';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ProjQuotationHeaders entity.
   */
  static _keys = ['dataAreaId', 'ProjQuotationNumber'];
  /**
   * Data Area Id.
   */
   ...
   */
  declare projQuotationNumber: DeserializedType<T, 'Edm.String'>;
  /**
  ...
  /**
   * Psa Est Proj Start Date.
   */
  declare psaEstProjStartDate: DeserializedType<T, 'Edm.DateTimeOffset'>;
  /**
   ...
   * @nullable
   */
  declare projQuotationName?: DeserializedType<T, 'Edm.String'> | null;
  /**
  ...
  > | null;
  /**
   * Psa External Description.
   * @nullable
   */
  declare psaExternalDescription?: DeserializedType<T, 'Edm.String'> | null;
  /**
  ...
  /**
   * Proj Quotation Expiry Date.
   */
  declare projQuotationExpiryDate: DeserializedType<T, 'Edm.DateTimeOffset'>;
  /**
  ...
  /**
   * Psa Estd Proj Duration.
   */
  declare psaEstdProjDuration: DeserializedType<T, 'Edm.Decimal'>;
  /**
   * Url.
   * @nullable
   */
  ...
  /**
   * Psa Est Proj End Date.
   */
  declare psaEstProjEndDate: DeserializedType<T, 'Edm.DateTimeOffset'>;
  /**
  ...
  /**
   * Psa Internal Description.
   * @nullable
   */
  declare psaInternalDescription?: DeserializedType<T, 'Edm.String'> | null;
  /**
   * Fixed Due Date.
   */
  ...
  >;
  /**
   * Proj Quotation Follow Up Date.
   */
  declare projQuotationFollowUpDate: DeserializedType<T, 'Edm.DateTimeOffset'>;
  /**
   ...
   */
  declare projQuotationLines: ProjQuotationLines<T>[];
  /**
   * One-to-one navigation property to the {@link DimensionSets} entity.
   */
  declare dimensionSet?: DimensionSets<T> | null;

  constructor(_entityApi: ProjQuotationHeadersApi<T>) {
    super(_entityApi);
  }
}

export interface ProjQuotationHeadersType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  psaEstProjStartDate: DeserializedType<T, 'Edm.DateTimeOffset'>;
  ...
  projQuotationName?: DeserializedType<T, 'Edm.String'> | null;
  ...
  psaExternalDescription?: DeserializedType<T, 'Edm.String'> | null;
  ...
  projQuotationExpiryDate: DeserializedType<T, 'Edm.DateTimeOffset'>;
  ...
  psaEstdProjDuration: DeserializedType<T, 'Edm.Decimal'>;
  url?: DeserializedType<T, 'Edm.String'> | null;
  currencyCode?: DeserializedType<T, 'Edm.String'> | null;
  psaEstProjEndDate: DeserializedType<T, 'Edm.DateTimeOffset'>;
  ...
  psaInternalDescription?: DeserializedType<T, 'Edm.String'> | null;
  ...
  projQuotationFollowUpDate: DeserializedType<T, 'Edm.DateTimeOffset'>;
  ...
  projQuotationLines: ProjQuotationLinesType<T>[];
