...
import { SalesBookVatProcessParametersRequestBuilder } from './SalesBookVatProcessParametersRequestBuilder';
...
export class SalesBookVatProcessParametersApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<SalesBookVatProcessParameters<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): SalesBookVatProcessParametersApi<DeSerializersT> {
    return new SalesBookVatProcessParametersApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    DIMENSION_SET: OneToOneLink<
      SalesBookVatProcessParameters<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = SalesBookVatProcessParameters;

  requestBuilder(): SalesBookVatProcessParametersRequestBuilder<DeSerializersT> {
    return new SalesBookVatProcessParametersRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof SalesBookVatProcessParameters,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      SalesBookVatProcessParameters<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    IS_DEFAULT: EnumField<
      ...
      true
    >;
    RESTORATION_TYPE: EnumField<
      SalesBookVatProcessParameters<DeSerializers>,
      DeSerializersT,
      SalesBookVatRestoringTypeRu,
      true,
      true
    >;
    ...
    DIMENSION_SET: OneToOneLink<
      ...
      DimensionSetsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<SalesBookVatProcessParameters<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link restorationType} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        RESTORATION_TYPE: fieldBuilder.buildEnumField(
          'RestorationType',
          SalesBookVatRestoringTypeRu,
          true
        ),
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', SalesBookVatProcessParameters)
      };
    }
