...
import { ItemSpecificBillOfMaterialsHeadersRequestBuilder } from './ItemSpecificBillOfMaterialsHeadersRequestBuilder';
...
export class ItemSpecificBillOfMaterialsHeadersApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      ItemSpecificBillOfMaterialsHeaders<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    ...
    return new ItemSpecificBillOfMaterialsHeadersApi(deSerializers);
  }
  ...
  entityConstructor = ItemSpecificBillOfMaterialsHeaders;

  requestBuilder(): ItemSpecificBillOfMaterialsHeadersRequestBuilder<DeSerializersT> {
    return new ItemSpecificBillOfMaterialsHeadersRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof ItemSpecificBillOfMaterialsHeaders,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ItemSpecificBillOfMaterialsHeaders<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    ENG_CHG_ENGINEERING_BOM_REFERENCE: OrderableEdmTypeField<
      ...
      true
    >;
    ENG_CHG_ENGINEERING_VERSION: OrderableEdmTypeField<
      ItemSpecificBillOfMaterialsHeaders<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    APPROVING_WORKER: OneToOneLink<
      ...
      WorkersApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<ItemSpecificBillOfMaterialsHeaders<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link engChgEngineeringVersion} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ENG_CHG_ENGINEERING_VERSION: fieldBuilder.buildEdmTypeField(
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ItemSpecificBillOfMaterialsHeaders)
      };
    }
