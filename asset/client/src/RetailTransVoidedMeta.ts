...
import type { RetailTransVoidedMetaApi } from './RetailTransVoidedMetaApi';

/**
 * This class represents the entity "RetailTransVoidedMeta" of service "d365_metadata".
 */
export class RetailTransVoidedMeta<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements RetailTransVoidedMetaType<T>
{
  /**
   * Technical entity name for RetailTransVoidedMeta.
   */
  static override _entityName = 'RetailTransVoidedMeta';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the RetailTransVoidedMeta entity.
   */
  static _keys = [
    'YearOffset',
    'RetailChannelId',
  ...
  constructor(_entityApi: RetailTransVoidedMetaApi<T>) {
    super(_entityApi);
  }
}

export interface RetailTransVoidedMetaType<
  T extends DeSerializers = DefaultDeSerializers
> {
