...
import { BusinessDocumentStockedPackingSlipLinesV3RequestBuilder } from './BusinessDocumentStockedPackingSlipLinesV3RequestBuilder';
...
export class BusinessDocumentStockedPackingSlipLinesV3Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      BusinessDocumentStockedPackingSlipLinesV3<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    ...
    return new BusinessDocumentStockedPackingSlipLinesV3Api(deSerializers);
  }
  ...
  entityConstructor = BusinessDocumentStockedPackingSlipLinesV3;

  requestBuilder(): BusinessDocumentStockedPackingSlipLinesV3RequestBuilder<DeSerializersT> {
    return new BusinessDocumentStockedPackingSlipLinesV3RequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof BusinessDocumentStockedPackingSlipLinesV3,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      BusinessDocumentStockedPackingSlipLinesV3<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
