...
import { VendInvoiceRegisterLinesV2RequestBuilder } from './VendInvoiceRegisterLinesV2RequestBuilder';
...
export class VendInvoiceRegisterLinesV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<VendInvoiceRegisterLinesV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new VendInvoiceRegisterLinesV2Api(deSerializers);
  }

  private navigationPropertyFields!: {
    /**
     * Static representation of the one-to-one navigation property {@link vendInvoiceRegisterLineV2EntityOffsetAccountDimensionCombination} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    VEND_INVOICE_REGISTER_LINE_V_2_ENTITY_OFFSET_ACCOUNT_DIMENSION_COMBINATION: OneToOneLink<
      VendInvoiceRegisterLinesV2<DeSerializersT>,
      DeSerializersT,
    ...
    >;
    /**
     * Static representation of the one-to-one navigation property {@link vendInvoiceRegisterLineV2EntityAccountDimensionCombination} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    VEND_INVOICE_REGISTER_LINE_V_2_ENTITY_ACCOUNT_DIMENSION_COMBINATION: OneToOneLink<
      VendInvoiceRegisterLinesV2<DeSerializersT>,
      DeSerializersT,
      DimensionCombinationsApi<DeSerializersT>
    >;
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      VEND_INVOICE_REGISTER_LINE_V_2_ENTITY_OFFSET_ACCOUNT_DIMENSION_COMBINATION:
        new OneToOneLink(
          'VendInvoiceRegisterLineV2EntityOffsetAccountDimensionCombination',
          this,
          linkedApis[0]
        ),
      ...
      VEND_INVOICE_REGISTER_LINE_V_2_ENTITY_ACCOUNT_DIMENSION_COMBINATION:
        new OneToOneLink(
          'VendInvoiceRegisterLineV2EntityAccountDimensionCombination',
          this,
          linkedApis[2]
        )
    };
  ...
  entityConstructor = VendInvoiceRegisterLinesV2;

  requestBuilder(): VendInvoiceRegisterLinesV2RequestBuilder<DeSerializersT> {
    return new VendInvoiceRegisterLinesV2RequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof VendInvoiceRegisterLinesV2,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      VendInvoiceRegisterLinesV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    VEND_INVOICE_REGISTER_LINE_V_2_ENTITY_ACCOUNT_DIMENSION_COMBINATION: OneToOneLink<
      ...
      DimensionCombinationsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<VendInvoiceRegisterLinesV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', VendInvoiceRegisterLinesV2)
      };
    }
