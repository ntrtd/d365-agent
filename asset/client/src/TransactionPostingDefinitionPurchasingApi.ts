...
import { TransactionPostingDefinitionPurchasingRequestBuilder } from './TransactionPostingDefinitionPurchasingRequestBuilder';
...
export class TransactionPostingDefinitionPurchasingApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      TransactionPostingDefinitionPurchasing<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): TransactionPostingDefinitionPurchasingApi<DeSerializersT> {
    return new TransactionPostingDefinitionPurchasingApi(deSerializers);
  }
  ...
  entityConstructor = TransactionPostingDefinitionPurchasing;

  requestBuilder(): TransactionPostingDefinitionPurchasingRequestBuilder<DeSerializersT> {
    return new TransactionPostingDefinitionPurchasingRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof TransactionPostingDefinitionPurchasing,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        TransactionPostingDefinitionPurchasing,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      TransactionPostingDefinitionPurchasing<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    >;
    PURCHASING_TRANSACTION_TYPE: EnumField<
      TransactionPostingDefinitionPurchasing<DeSerializers>,
      DeSerializersT,
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link purchasingTransactionType} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PURCHASING_TRANSACTION_TYPE: fieldBuilder.buildEnumField(
          'PurchasingTransactionType',
          PurchasingTransactionType,
          true
        ),
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', TransactionPostingDefinitionPurchasing)
      };
    }
