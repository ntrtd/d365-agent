...
import type { FreightInvoiceHeadersV2Api } from './FreightInvoiceHeadersV2Api';
import { TmsInvoiceStatus } from './TmsInvoiceStatus';
import { NoYes } from './NoYes';
import {
  FreightInvoiceLinesV2,
  FreightInvoiceLinesV2Type
} from './FreightInvoiceLinesV2';

/**
 * This class represents the entity "FreightInvoiceHeadersV2" of service "d365_metadata".
 */
export class FreightInvoiceHeadersV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements FreightInvoiceHeadersV2Type<T>
{
  /**
   * Technical entity name for FreightInvoiceHeadersV2.
   */
  static override _entityName = 'FreightInvoiceHeadersV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the FreightInvoiceHeadersV2 entity.
   */
  ...
  /**
   * One-to-many navigation property to the {@link FreightInvoiceLinesV2} entity.
   */
  declare freightInvoiceLineV2: FreightInvoiceLinesV2<T>[];

  constructor(_entityApi: FreightInvoiceHeadersV2Api<T>) {
    super(_entityApi);
  }
}

export interface FreightInvoiceHeadersV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  freightInvoiceLineV2: FreightInvoiceLinesV2Type<T>[];
}
