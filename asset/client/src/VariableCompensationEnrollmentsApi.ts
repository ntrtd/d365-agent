...
import { VariableCompensationEnrollmentsRequestBuilder } from './VariableCompensationEnrollmentsRequestBuilder';
...
export class VariableCompensationEnrollmentsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<VariableCompensationEnrollments<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new VariableCompensationEnrollmentsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    VARIABLE_COMPENSATION_PLAN: OneToOneLink<
      VariableCompensationEnrollments<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = VariableCompensationEnrollments;

  requestBuilder(): VariableCompensationEnrollmentsRequestBuilder<DeSerializersT> {
    return new VariableCompensationEnrollmentsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof VariableCompensationEnrollments,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      VariableCompensationEnrollments<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    DIMENSION_SET: OneToOneLink<
      ...
      DimensionSetsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<VariableCompensationEnrollments<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', VariableCompensationEnrollments)
      };
    }
