...
/**
 * This class represents the entity "Vendors" of service "d365_metadata".
 */
export class Vendors<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements VendorsType<T>
{
  /**
   * Technical entity name for Vendors.
   */
  static override _entityName = 'Vendors';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the Vendors entity.
   */
   ...
   */
  declare valueModelVendors: FixedAssetValueModels<T>[];

  constructor(_entityApi: VendorsApi<T>) {
    super(_entityApi);
  }
}

export interface VendorsType<T extends DeSerializers = DefaultDeSerializers> {
  ...
  valueModelVendors: FixedAssetValueModelsType<T>[];
}
