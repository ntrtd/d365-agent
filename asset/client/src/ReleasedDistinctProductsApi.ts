...
import { ReleasedDistinctProductsRequestBuilder } from './ReleasedDistinctProductsRequestBuilder';
...
export class ReleasedDistinctProductsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<ReleasedDistinctProducts<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new ReleasedDistinctProductsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    DISTINCT_PRODUCT: OneToOneLink<
      ReleasedDistinctProducts<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = ReleasedDistinctProducts;

  requestBuilder(): ReleasedDistinctProductsRequestBuilder<DeSerializersT> {
    return new ReleasedDistinctProductsRequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof ReleasedDistinctProducts,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ReleasedDistinctProducts<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    BATCH_NUMBER_GROUP_CODE: OrderableEdmTypeField<
      ...
      true
    >;
    POTENCY_BASE_ATTRIBUTE_ID: OrderableEdmTypeField<
      ReleasedDistinctProducts<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    PRODUCT_TRANSLATION: OneToManyLink<
      ...
      ProductTranslationsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<ReleasedDistinctProducts<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link potencyBaseAttributeId} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        POTENCY_BASE_ATTRIBUTE_ID: fieldBuilder.buildEdmTypeField(
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ReleasedDistinctProducts)
      };
    }
