...
import type { BusinessDocumentNonStockedPackingSlipLinesV2Api } from './BusinessDocumentNonStockedPackingSlipLinesV2Api';
import {
...
/**
 * This class represents the entity "BusinessDocumentNonStockedPackingSlipLinesV2" of service "d365_metadata".
 */
export class BusinessDocumentNonStockedPackingSlipLinesV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements BusinessDocumentNonStockedPackingSlipLinesV2Type<T>
{
  /**
   * Technical entity name for BusinessDocumentNonStockedPackingSlipLinesV2.
   */
  static override _entityName = 'BusinessDocumentNonStockedPackingSlipLinesV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the BusinessDocumentNonStockedPackingSlipLinesV2 entity.
   */
  static _keys = [
    'dataAreaId',
    'SalesId',
  ...
  constructor(_entityApi: BusinessDocumentNonStockedPackingSlipLinesV2Api<T>) {
    super(_entityApi);
  }
}

export interface BusinessDocumentNonStockedPackingSlipLinesV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
