...
import { InboundLoadPackingStructureLinesV3RequestBuilder } from './InboundLoadPackingStructureLinesV3RequestBuilder';
...
export class InboundLoadPackingStructureLinesV3Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      InboundLoadPackingStructureLinesV3<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    ...
    return new InboundLoadPackingStructureLinesV3Api(deSerializers);
  }
  ...
  entityConstructor = InboundLoadPackingStructureLinesV3;

  requestBuilder(): InboundLoadPackingStructureLinesV3RequestBuilder<DeSerializersT> {
    return new InboundLoadPackingStructureLinesV3RequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof InboundLoadPackingStructureLinesV3,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      InboundLoadPackingStructureLinesV3<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    LOAD_PACKING_STRUCTURE: OneToOneLink<
      ...
      InboundLoadPackingStructuresApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<InboundLoadPackingStructureLinesV3<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', InboundLoadPackingStructureLinesV3)
      };
    }
