...
import { IntrastatCommodityCodesRequestBuilder } from './IntrastatCommodityCodesRequestBuilder';
...
export class IntrastatCommodityCodesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<IntrastatCommodityCodes<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): IntrastatCommodityCodesApi<DeSerializersT> {
    return new IntrastatCommodityCodesApi(deSerializers);
  }
  ...
  entityConstructor = IntrastatCommodityCodes;

  requestBuilder(): IntrastatCommodityCodesRequestBuilder<DeSerializersT> {
    return new IntrastatCommodityCodesRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    IntrastatCommodityCodes<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof IntrastatCommodityCodes,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        IntrastatCommodityCodes,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    COMMODITY_HIERARCHY_NAME: OrderableEdmTypeField<
      IntrastatCommodityCodes<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    OPTIONAL_WEIGHT: EnumField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<IntrastatCommodityCodes<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', IntrastatCommodityCodes)
      };
    }
