...
import type { LeaveBankTransactionsApi } from './LeaveBankTransactionsApi';
...
/**
 * This class represents the entity "LeaveBankTransactions" of service "d365_metadata".
 */
export class LeaveBankTransactions<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements LeaveBankTransactionsType<T>
{
  /**
   * Technical entity name for LeaveBankTransactions.
   */
  static override _entityName = 'LeaveBankTransactions';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the LeaveBankTransactions entity.
   */
  static _keys = [
    'dataAreaId',
    'PersonnelNumber',
  ...
  constructor(_entityApi: LeaveBankTransactionsApi<T>) {
    super(_entityApi);
  }
}

export interface LeaveBankTransactionsType<
  T extends DeSerializers = DefaultDeSerializers
> {
