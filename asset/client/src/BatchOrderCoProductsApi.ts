...
import { BatchOrderCoProductsRequestBuilder } from './BatchOrderCoProductsRequestBuilder';
...
export class BatchOrderCoProductsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<BatchOrderCoProducts<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new BatchOrderCoProductsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    BATCH_ORDER_HEADER: OneToOneLink<
      BatchOrderCoProducts<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = BatchOrderCoProducts;

  requestBuilder(): BatchOrderCoProductsRequestBuilder<DeSerializersT> {
    return new BatchOrderCoProductsRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<BatchOrderCoProducts<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      BatchOrderCoProducts<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    DIMENSION_SET: OneToOneLink<
      ...
      DimensionSetsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<BatchOrderCoProducts<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', BatchOrderCoProducts)
      };
    }
