...
import type { ProspectiveVendorRegistrationVendorPostalAddressesApi } from './ProspectiveVendorRegistrationVendorPostalAddressesApi';
import { NoYes } from './NoYes';
import { Timezone } from './Timezone';

/**
 * This class represents the entity "ProspectiveVendorRegistrationVendorPostalAddresses" of service "d365_metadata".
 */
export class ProspectiveVendorRegistrationVendorPostalAddresses<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ProspectiveVendorRegistrationVendorPostalAddressesType<T>
{
  /**
   * Technical entity name for ProspectiveVendorRegistrationVendorPostalAddresses.
   */
  ...
  /**
   * All key fields of the ProspectiveVendorRegistrationVendorPostalAddresses entity.
   */
  ...
  constructor(
    _entityApi: ProspectiveVendorRegistrationVendorPostalAddressesApi<T>
  ) {
    super(_entityApi);
  }
}

export interface ProspectiveVendorRegistrationVendorPostalAddressesType<
  T extends DeSerializers = DefaultDeSerializers
> {
