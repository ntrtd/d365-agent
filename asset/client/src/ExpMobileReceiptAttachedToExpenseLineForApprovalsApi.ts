...
import { ExpMobileReceiptAttachedToExpenseLineForApprovalsRequestBuilder } from './ExpMobileReceiptAttachedToExpenseLineForApprovalsRequestBuilder';
...
export class ExpMobileReceiptAttachedToExpenseLineForApprovalsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      ExpMobileReceiptAttachedToExpenseLineForApprovals<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): ExpMobileReceiptAttachedToExpenseLineForApprovalsApi<DeSerializersT> {
    return new ExpMobileReceiptAttachedToExpenseLineForApprovalsApi(
      deSerializers
    );
  }
  ...
  entityConstructor = ExpMobileReceiptAttachedToExpenseLineForApprovals;

  requestBuilder(): ExpMobileReceiptAttachedToExpenseLineForApprovalsRequestBuilder<DeSerializersT> {
    return new ExpMobileReceiptAttachedToExpenseLineForApprovalsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof ExpMobileReceiptAttachedToExpenseLineForApprovals,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    ENT_REC_ID: OrderableEdmTypeField<
      ExpMobileReceiptAttachedToExpenseLineForApprovals<DeSerializers>,
      DeSerializersT,
      'Edm.Int64',
      false,
      true
