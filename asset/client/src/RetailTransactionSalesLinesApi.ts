...
import { RetailTransactionSalesLinesRequestBuilder } from './RetailTransactionSalesLinesRequestBuilder';
...
export class RetailTransactionSalesLinesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<RetailTransactionSalesLines<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): RetailTransactionSalesLinesApi<DeSerializersT> {
    return new RetailTransactionSalesLinesApi(deSerializers);
  }
  ...
  entityConstructor = RetailTransactionSalesLines;

  requestBuilder(): RetailTransactionSalesLinesRequestBuilder<DeSerializersT> {
    return new RetailTransactionSalesLinesRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    RetailTransactionSalesLines<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof RetailTransactionSalesLines,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      RetailTransactionSalesLines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    PICKUP_END_TIME: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<RetailTransactionSalesLines<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', RetailTransactionSalesLines)
      };
    }
