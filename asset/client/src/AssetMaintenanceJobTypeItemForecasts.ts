...
import type { AssetMaintenanceJobTypeItemForecastsApi } from './AssetMaintenanceJobTypeItemForecastsApi';

/**
 * This class represents the entity "AssetMaintenanceJobTypeItemForecasts" of service "d365_metadata".
 */
export class AssetMaintenanceJobTypeItemForecasts<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements AssetMaintenanceJobTypeItemForecastsType<T>
{
  /**
   * Technical entity name for AssetMaintenanceJobTypeItemForecasts.
   */
  static override _entityName = 'AssetMaintenanceJobTypeItemForecasts';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the AssetMaintenanceJobTypeItemForecasts entity.
   */
  static _keys = [
    'dataAreaId',
    'MaintenanceAssetId',
  ...
  constructor(_entityApi: AssetMaintenanceJobTypeItemForecastsApi<T>) {
    super(_entityApi);
  }
}

export interface AssetMaintenanceJobTypeItemForecastsType<
  T extends DeSerializers = DefaultDeSerializers
> {
