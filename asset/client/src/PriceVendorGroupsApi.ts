...
import { PriceVendorGroupsRequestBuilder } from './PriceVendorGroupsRequestBuilder';
...
export class PriceVendorGroupsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<PriceVendorGroups<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new PriceVendorGroupsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    OPEN_PURCHASE_PRICE_JOURNAL_LINE: OneToManyLink<
      PriceVendorGroups<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = PriceVendorGroups;

  requestBuilder(): PriceVendorGroupsRequestBuilder<DeSerializersT> {
    return new PriceVendorGroupsRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<PriceVendorGroups<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  ): CustomField<PriceVendorGroups<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      PriceVendorGroups<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    OPEN_PURCHASE_PRICE_JOURNAL_LINE_V_2: OneToManyLink<
      ...
      OpenPurchasePriceJournalLinesV2Api<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<PriceVendorGroups<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PriceVendorGroups)
      };
    }
