...
import type { TransferOrderLinesV2Api } from './TransferOrderLinesV2Api';
...
/**
 * This class represents the entity "TransferOrderLinesV2" of service "d365_metadata".
 */
export class TransferOrderLinesV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements TransferOrderLinesV2Type<T>
{
  /**
   * Technical entity name for TransferOrderLinesV2.
   */
  static override _entityName = 'TransferOrderLinesV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the TransferOrderLinesV2 entity.
   */
  ...
  constructor(_entityApi: TransferOrderLinesV2Api<T>) {
    super(_entityApi);
  }
}

export interface TransferOrderLinesV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
