...
import { TaxServiceTaxRegistrationNumberVendorsRequestBuilder } from './TaxServiceTaxRegistrationNumberVendorsRequestBuilder';
import {
  CustomField,
...
export class TaxServiceTaxRegistrationNumberVendorsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      TaxServiceTaxRegistrationNumberVendors<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): TaxServiceTaxRegistrationNumberVendorsApi<DeSerializersT> {
    return new TaxServiceTaxRegistrationNumberVendorsApi(deSerializers);
  }
  ...
  entityConstructor = TaxServiceTaxRegistrationNumberVendors;

  requestBuilder(): TaxServiceTaxRegistrationNumberVendorsRequestBuilder<DeSerializersT> {
    return new TaxServiceTaxRegistrationNumberVendorsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof TaxServiceTaxRegistrationNumberVendors,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    TAX_REGSTRATION_TYPE: OrderableEdmTypeField<
      TaxServiceTaxRegistrationNumberVendors<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', TaxServiceTaxRegistrationNumberVendors)
      };
    }
