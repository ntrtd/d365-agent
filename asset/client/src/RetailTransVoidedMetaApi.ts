...
import { RetailTransVoidedMetaRequestBuilder } from './RetailTransVoidedMetaRequestBuilder';
import {
  CustomField,
...
export class RetailTransVoidedMetaApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<RetailTransVoidedMeta<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): RetailTransVoidedMetaApi<DeSerializersT> {
    return new RetailTransVoidedMetaApi(deSerializers);
  }
  ...
  entityConstructor = RetailTransVoidedMeta;

  requestBuilder(): RetailTransVoidedMetaRequestBuilder<DeSerializersT> {
    return new RetailTransVoidedMetaRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    RetailTransVoidedMeta<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<RetailTransVoidedMeta<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof RetailTransVoidedMeta,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        RetailTransVoidedMeta,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    YEAR_OFFSET: OrderableEdmTypeField<
      RetailTransVoidedMeta<DeSerializers>,
      DeSerializersT,
      'Edm.Int64',
      false,
      true
    ...
    TRANSACTION_AMOUNT: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<RetailTransVoidedMeta<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', RetailTransVoidedMeta)
      };
    }
