...
import { AggregatedStatisticalEntriesWithCostObjectHierarchyAndStatisticalHierarchyRequestBuilder } from './AggregatedStatisticalEntriesWithCostObjectHierarchyAndStatisticalHierarchyRequestBuilder';
...
export class AggregatedStatisticalEntriesWithCostObjectHierarchyAndStatisticalHierarchyApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      AggregatedStatisticalEntriesWithCostObjectHierarchyAndStatisticalHierarchy<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): AggregatedStatisticalEntriesWithCostObjectHierarchyAndStatisticalHierarchyApi<DeSerializersT> {
    return new AggregatedStatisticalEntriesWithCostObjectHierarchyAndStatisticalHierarchyApi(
      deSerializers
    );
  }
  ...
  requestBuilder(): AggregatedStatisticalEntriesWithCostObjectHierarchyAndStatisticalHierarchyRequestBuilder<DeSerializersT> {
    return new AggregatedStatisticalEntriesWithCostObjectHierarchyAndStatisticalHierarchyRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof AggregatedStatisticalEntriesWithCostObjectHierarchyAndStatisticalHierarchy,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    COST_CONTROL_UNIT_NAME: OrderableEdmTypeField<
      AggregatedStatisticalEntriesWithCostObjectHierarchyAndStatisticalHierarchy<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    YEAR_NAME: OrderableEdmTypeField<
      ...
      true
    >;
    COST_OBJECT_DIMENSION_HIERARCHY_NAME: OrderableEdmTypeField<
      AggregatedStatisticalEntriesWithCostObjectHierarchyAndStatisticalHierarchy<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link costObjectDimensionHierarchyName} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        COST_OBJECT_DIMENSION_HIERARCHY_NAME: fieldBuilder.buildEdmTypeField(
          'CostObjectDimensionHierarchyName',
          'Edm.String',
          true
        ),
        /**
