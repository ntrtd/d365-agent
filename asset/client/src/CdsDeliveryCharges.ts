...
import type { CdsDeliveryChargesApi } from './CdsDeliveryChargesApi';
...
/**
 * This class represents the entity "CDSDeliveryCharges" of service "d365_metadata".
 */
export class CdsDeliveryCharges<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements CdsDeliveryChargesType<T>
{
  /**
   * Technical entity name for CdsDeliveryCharges.
   */
  static override _entityName = 'CDSDeliveryCharges';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the CdsDeliveryCharges entity.
   */
  ...
  constructor(_entityApi: CdsDeliveryChargesApi<T>) {
    super(_entityApi);
  }
}

export interface CdsDeliveryChargesType<
