...
import type { CdsSalesQuotationLinesApi } from './CdsSalesQuotationLinesApi';
...
/**
 * This class represents the entity "CDSSalesQuotationLines" of service "d365_metadata".
 */
export class CdsSalesQuotationLines<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements CdsSalesQuotationLinesType<T>
{
  /**
   * Technical entity name for CdsSalesQuotationLines.
   */
  static override _entityName = 'CDSSalesQuotationLines';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the CdsSalesQuotationLines entity.
   */
  static _keys = [
    'dataAreaId',
  ...
  constructor(_entityApi: CdsSalesQuotationLinesApi<T>) {
    super(_entityApi);
  }
}

export interface CdsSalesQuotationLinesType<
  T extends DeSerializers = DefaultDeSerializers
> {
