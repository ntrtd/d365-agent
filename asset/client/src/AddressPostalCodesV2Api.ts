...
import { AddressPostalCodesV2RequestBuilder } from './AddressPostalCodesV2RequestBuilder';
...
export class AddressPostalCodesV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<AddressPostalCodesV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): AddressPostalCodesV2Api<DeSerializersT> {
    return new AddressPostalCodesV2Api(deSerializers);
  }
  ...
  entityConstructor = AddressPostalCodesV2;

  requestBuilder(): AddressPostalCodesV2RequestBuilder<DeSerializersT> {
    return new AddressPostalCodesV2RequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    AddressPostalCodesV2<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<AddressPostalCodesV2<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof AddressPostalCodesV2,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        AddressPostalCodesV2,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    ZIP_CODE: OrderableEdmTypeField<
      AddressPostalCodesV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    STREET: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<AddressPostalCodesV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', AddressPostalCodesV2)
      };
    }
