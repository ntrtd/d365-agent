...
import type { WorkerBankAccountsApi } from './WorkerBankAccountsApi';
...
import {
  ...
  BankAccountDisbursementsDualWriteType
} from './BankAccountDisbursementsDualWrite';
...
/**
 * This class represents the entity "WorkerBankAccounts" of service "d365_metadata".
 */
export class WorkerBankAccounts<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements WorkerBankAccountsType<T>
{
  /**
   * Technical entity name for WorkerBankAccounts.
   */
  static override _entityName = 'WorkerBankAccounts';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the WorkerBankAccounts entity.
   */
  ...
  /**
   * One-to-one navigation property to the {@link BankAccountDisbursements} entity.
   */
  declare bankAccountDisbursement?: BankAccountDisbursements<T> | null;
  /**
   * One-to-one navigation property to the {@link BankAccountDisbursementsDualWrite} entity.
   */
  declare bankAccountDisbursementDualWrite?: BankAccountDisbursementsDualWrite<T> | null;
  /**
  ...
  constructor(_entityApi: WorkerBankAccountsApi<T>) {
    super(_entityApi);
  }
}

export interface WorkerBankAccountsType<
...
> {
  ...
  bankAccountDisbursement?: BankAccountDisbursementsType<T> | null;
  bankAccountDisbursementDualWrite?: BankAccountDisbursementsDualWriteType<T> | null;
