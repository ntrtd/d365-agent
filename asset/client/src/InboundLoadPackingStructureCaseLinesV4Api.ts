...
import { InboundLoadPackingStructureCaseLinesV4RequestBuilder } from './InboundLoadPackingStructureCaseLinesV4RequestBuilder';
...
export class InboundLoadPackingStructureCaseLinesV4Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      InboundLoadPackingStructureCaseLinesV4<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): InboundLoadPackingStructureCaseLinesV4Api<DeSerializersT> {
    return new InboundLoadPackingStructureCaseLinesV4Api(deSerializers);
  }
  ...
  entityConstructor = InboundLoadPackingStructureCaseLinesV4;

  requestBuilder(): InboundLoadPackingStructureCaseLinesV4RequestBuilder<DeSerializersT> {
    return new InboundLoadPackingStructureCaseLinesV4RequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof InboundLoadPackingStructureCaseLinesV4,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        InboundLoadPackingStructureCaseLinesV4,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      InboundLoadPackingStructureCaseLinesV4<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', InboundLoadPackingStructureCaseLinesV4)
      };
    }
