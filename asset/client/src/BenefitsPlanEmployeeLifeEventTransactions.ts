...
import type { BenefitsPlanEmployeeLifeEventTransactionsApi } from './BenefitsPlanEmployeeLifeEventTransactionsApi';
import { BenefitEmployeePlanStatus } from './BenefitEmployeePlanStatus';

/**
 * This class represents the entity "BenefitsPlanEmployeeLifeEventTransactions" of service "d365_metadata".
 */
export class BenefitsPlanEmployeeLifeEventTransactions<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements BenefitsPlanEmployeeLifeEventTransactionsType<T>
{
  /**
   * Technical entity name for BenefitsPlanEmployeeLifeEventTransactions.
   */
  static override _entityName = 'BenefitsPlanEmployeeLifeEventTransactions';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the BenefitsPlanEmployeeLifeEventTransactions entity.
   */
  static _keys = [
    'PersonnelNumber',
    'PlanPeriodId',
   ...
   * @nullable
   */
  declare planEmployeeAfterLifeEventPlanId?: DeserializedType<
    T,
    'Edm.String'
  > | null;
  /**
  ...
  constructor(_entityApi: BenefitsPlanEmployeeLifeEventTransactionsApi<T>) {
    super(_entityApi);
  }
}

export interface BenefitsPlanEmployeeLifeEventTransactionsType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  planEmployeeAfterLifeEventPlanId?: DeserializedType<T, 'Edm.String'> | null;
