...
import { TransferOrderLinesRequestBuilder } from './TransferOrderLinesRequestBuilder';
...
export class TransferOrderLinesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<TransferOrderLines<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new TransferOrderLinesApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    DIMENSION_SET: OneToOneLink<
      TransferOrderLines<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = TransferOrderLines;

  requestBuilder(): TransferOrderLinesRequestBuilder<DeSerializersT> {
    return new TransferOrderLinesRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<TransferOrderLines<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      TransferOrderLines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    TAX_ITEM_GROUP: OrderableEdmTypeField<
      ...
      true
    >;
    DEFAULT_DIMENSION: OrderableEdmTypeField<
      TransferOrderLines<DeSerializers>,
      DeSerializersT,
      'Edm.Int64',
      false,
    ...
    TRANSFER_ORDER_HEADER: OneToOneLink<
      ...
      TransferOrderHeadersApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<TransferOrderLines<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link defaultDimension} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        DEFAULT_DIMENSION: fieldBuilder.buildEdmTypeField(
          'DefaultDimension',
          'Edm.Int64',
          false
        ),
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', TransferOrderLines)
      };
    }
