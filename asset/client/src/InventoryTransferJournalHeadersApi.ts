...
import { InventoryTransferJournalHeadersRequestBuilder } from './InventoryTransferJournalHeadersRequestBuilder';
import { InventoryTransferJournalEntriesApi } from './InventoryTransferJournalEntriesApi';
...
export class InventoryTransferJournalHeadersApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<InventoryTransferJournalHeaders<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new InventoryTransferJournalHeadersApi(deSerializers);
  }

  private navigationPropertyFields!: {
    /**
     * Static representation of the one-to-many navigation property {@link inventoryTransferJournalEntry} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    INVENTORY_TRANSFER_JOURNAL_ENTRY: OneToManyLink<
      InventoryTransferJournalHeaders<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    linkedApis: [InventoryTransferJournalEntriesApi<DeSerializersT>]
  ): this {
    this.navigationPropertyFields = {
      INVENTORY_TRANSFER_JOURNAL_ENTRY: new OneToManyLink(
        'InventoryTransferJournalEntry',
        this,
        linkedApis[0]
      )
    };
  ...
  entityConstructor = InventoryTransferJournalHeaders;

  requestBuilder(): InventoryTransferJournalHeadersRequestBuilder<DeSerializersT> {
    return new InventoryTransferJournalHeadersRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof InventoryTransferJournalHeaders,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      InventoryTransferJournalHeaders<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    INVENTORY_TRANSFER_JOURNAL_ENTRY: OneToManyLink<
      ...
      InventoryTransferJournalEntriesApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<InventoryTransferJournalHeaders<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', InventoryTransferJournalHeaders)
      };
    }
