...
import { CdsOpenPurchasePriceJournalLinesRequestBuilder } from './CdsOpenPurchasePriceJournalLinesRequestBuilder';
...
export class CdsOpenPurchasePriceJournalLinesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<CdsOpenPurchasePriceJournalLines<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): CdsOpenPurchasePriceJournalLinesApi<DeSerializersT> {
    return new CdsOpenPurchasePriceJournalLinesApi(deSerializers);
  }
  ...
  entityConstructor = CdsOpenPurchasePriceJournalLines;

  requestBuilder(): CdsOpenPurchasePriceJournalLinesRequestBuilder<DeSerializersT> {
    return new CdsOpenPurchasePriceJournalLinesRequestBuilder<DeSerializersT>(
      this
    );
  }

  entityBuilder(): EntityBuilderType<
    CdsOpenPurchasePriceJournalLines<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof CdsOpenPurchasePriceJournalLines,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        CdsOpenPurchasePriceJournalLines,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      CdsOpenPurchasePriceJournalLines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    PROCESSING_LOG: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<CdsOpenPurchasePriceJournalLines<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', CdsOpenPurchasePriceJournalLines)
      };
    }
