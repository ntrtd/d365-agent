...
import { PersonCountrySpecificFieldsV3RequestBuilder } from './PersonCountrySpecificFieldsV3RequestBuilder';
...
export class PersonCountrySpecificFieldsV3Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<PersonCountrySpecificFieldsV3<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new PersonCountrySpecificFieldsV3Api(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
     ...
     */
    PERSON: OneToOneLink<
      PersonCountrySpecificFieldsV3<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = PersonCountrySpecificFieldsV3;

  requestBuilder(): PersonCountrySpecificFieldsV3RequestBuilder<DeSerializersT> {
    return new PersonCountrySpecificFieldsV3RequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof PersonCountrySpecificFieldsV3,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    PARTY_NUMBER: OrderableEdmTypeField<
      PersonCountrySpecificFieldsV3<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    FR_PROFESSIONAL_STATUS: OrderableEdmTypeField<
      ...
      true
    >;
    DE_OCC_NAME_V_2: OrderableEdmTypeField<
      PersonCountrySpecificFieldsV3<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    ES_COLLECTIVE_AGREEMENT_CODE: OrderableEdmTypeField<
      ...
      true
    >;
    DEBICV_2: OrderableEdmTypeField<
      PersonCountrySpecificFieldsV3<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    IN_SECONDARY_NATIONAL_IDENTIFIER: OrderableEdmTypeField<
      ...
      true
    >;
    DE_ADDITIONAL_JOB_V_2: OrderableEdmTypeField<
      PersonCountrySpecificFieldsV3<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    FR_TYPE_OF_NOTICE_PERIOD: OrderableEdmTypeField<
      ...
      true
    >;
    DE_OCCUPATION_NUMBER_V_2: OrderableEdmTypeField<
      PersonCountrySpecificFieldsV3<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    JP_PENSION_ISSUE_DATE: OrderableEdmTypeField<
      ...
      true
    >;
    DEIBANV_2: OrderableEdmTypeField<
      PersonCountrySpecificFieldsV3<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    PERSON: OneToOneLink<
      ...
      PeopleApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<PersonCountrySpecificFieldsV3<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link deOccNameV2} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        DE_OCC_NAME_V_2: fieldBuilder.buildEdmTypeField(
          'DEOcc_NameV2',
          'Edm.String',
          true
        ),
        ...
        /**
         * Static representation of the {@link debicv2} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        DEBICV_2: fieldBuilder.buildEdmTypeField('DEBICV2', 'Edm.String', true),
        /**
        ...
        /**
         * Static representation of the {@link deAdditionalJobV2} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        DE_ADDITIONAL_JOB_V_2: fieldBuilder.buildEdmTypeField(
          'DEAdditionalJobV2',
          'Edm.String',
          true
        ),
        ...
        /**
         * Static representation of the {@link deOccupationNumberV2} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        DE_OCCUPATION_NUMBER_V_2: fieldBuilder.buildEdmTypeField(
          'DEOccupationNumberV2',
          'Edm.String',
          true
        ),
        /**
        ...
        /**
         * Static representation of the {@link deibanv2} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        DEIBANV_2: fieldBuilder.buildEdmTypeField(
          'DEIBANV2',
          'Edm.String',
          true
        ),
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PersonCountrySpecificFieldsV3)
      };
    }
