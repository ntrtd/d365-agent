...
import { WarehouseInventoryStatusesOnHandV2RequestBuilder } from './WarehouseInventoryStatusesOnHandV2RequestBuilder';
...
export class WarehouseInventoryStatusesOnHandV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      WarehouseInventoryStatusesOnHandV2<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): WarehouseInventoryStatusesOnHandV2Api<DeSerializersT> {
    return new WarehouseInventoryStatusesOnHandV2Api(deSerializers);
  }
  ...
  entityConstructor = WarehouseInventoryStatusesOnHandV2;

  requestBuilder(): WarehouseInventoryStatusesOnHandV2RequestBuilder<DeSerializersT> {
    return new WarehouseInventoryStatusesOnHandV2RequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof WarehouseInventoryStatusesOnHandV2,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        WarehouseInventoryStatusesOnHandV2,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      WarehouseInventoryStatusesOnHandV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    TOTAL_AVAILABLE_QUANTITY: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<WarehouseInventoryStatusesOnHandV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', WarehouseInventoryStatusesOnHandV2)
      };
    }
