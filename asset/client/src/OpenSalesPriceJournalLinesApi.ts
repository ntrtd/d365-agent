...
import { OpenSalesPriceJournalLinesRequestBuilder } from './OpenSalesPriceJournalLinesRequestBuilder';
...
export class OpenSalesPriceJournalLinesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<OpenSalesPriceJournalLines<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new OpenSalesPriceJournalLinesApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    OPERATIONAL_SITE: OneToOneLink<
      OpenSalesPriceJournalLines<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = OpenSalesPriceJournalLines;

  requestBuilder(): OpenSalesPriceJournalLinesRequestBuilder<DeSerializersT> {
    return new OpenSalesPriceJournalLinesRequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof OpenSalesPriceJournalLines,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      OpenSalesPriceJournalLines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    CUSTOMER_V_3: OneToOneLink<
      ...
      CustomersV3Api<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<OpenSalesPriceJournalLines<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', OpenSalesPriceJournalLines)
      };
    }
