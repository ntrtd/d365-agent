...
import { LtmCustInvoiceJourRequestBuilder } from './LtmCustInvoiceJourRequestBuilder';
...
export class LtmCustInvoiceJourApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<LtmCustInvoiceJour<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): LtmCustInvoiceJourApi<DeSerializersT> {
    return new LtmCustInvoiceJourApi(deSerializers);
  }
  ...
  entityConstructor = LtmCustInvoiceJour;

  requestBuilder(): LtmCustInvoiceJourRequestBuilder<DeSerializersT> {
    return new LtmCustInvoiceJourRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    LtmCustInvoiceJour<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<LtmCustInvoiceJour<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      LtmCustInvoiceJour<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    SALES_POINT_ID: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<LtmCustInvoiceJour<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link psEnable} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PS_ENABLE: fieldBuilder.buildEnumField('PSEnable', NoYes, true),
        /**
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', LtmCustInvoiceJour)
      };
    }
