...
import type { JobTemplateAdaRequirementsApi } from './JobTemplateAdaRequirementsApi';
...
/**
 * This class represents the entity "JobTemplateADARequirements" of service "d365_metadata".
 */
export class JobTemplateAdaRequirements<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements JobTemplateAdaRequirementsType<T>
{
  /**
   * Technical entity name for JobTemplateAdaRequirements.
   */
  static override _entityName = 'JobTemplateADARequirements';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the JobTemplateAdaRequirements entity.
   */
  static _keys = ['JobTemplateId'];
  /**
   * Job Template Id.
   */
   ...
   */
  declare job?: JobTemplates<T> | null;

  constructor(_entityApi: JobTemplateAdaRequirementsApi<T>) {
    super(_entityApi);
  }
}

export interface JobTemplateAdaRequirementsType<
  T extends DeSerializers = DefaultDeSerializers
> {
