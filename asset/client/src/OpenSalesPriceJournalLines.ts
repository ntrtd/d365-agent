...
import type { OpenSalesPriceJournalLinesApi } from './OpenSalesPriceJournalLinesApi';
...
/**
 * This class represents the entity "OpenSalesPriceJournalLines" of service "d365_metadata".
 */
export class OpenSalesPriceJournalLines<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements OpenSalesPriceJournalLinesType<T>
{
  /**
   * Technical entity name for OpenSalesPriceJournalLines.
   */
  static override _entityName = 'OpenSalesPriceJournalLines';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the OpenSalesPriceJournalLines entity.
   */
  ...
  constructor(_entityApi: OpenSalesPriceJournalLinesApi<T>) {
    super(_entityApi);
  }
}

export interface OpenSalesPriceJournalLinesType<
  T extends DeSerializers = DefaultDeSerializers
> {
