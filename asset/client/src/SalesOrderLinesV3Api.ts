...
import { SalesOrderLinesV3RequestBuilder } from './SalesOrderLinesV3RequestBuilder';
...
export class SalesOrderLinesV3Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<SalesOrderLinesV3<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new SalesOrderLinesV3Api(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    SALES_ORDER_HEADER: OneToOneLink<
      SalesOrderLinesV3<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = SalesOrderLinesV3;

  requestBuilder(): SalesOrderLinesV3RequestBuilder<DeSerializersT> {
    return new SalesOrderLinesV3RequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<SalesOrderLinesV3<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  ): CustomField<SalesOrderLinesV3<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      SalesOrderLinesV3<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    DIMENSION_COMBINATION: OneToOneLink<
      ...
      DimensionCombinationsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<SalesOrderLinesV3<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', SalesOrderLinesV3)
      };
    }
