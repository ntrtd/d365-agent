...
import type { DualWriteVendorActivitiesApi } from './DualWriteVendorActivitiesApi';
...
/**
 * This class represents the entity "DualWriteVendorActivities" of service "d365_metadata".
 */
export class DualWriteVendorActivities<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements DualWriteVendorActivitiesType<T>
{
  /**
   * Technical entity name for DualWriteVendorActivities.
   */
  static override _entityName = 'DualWriteVendorActivities';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the DualWriteVendorActivities entity.
   */
  ...
  constructor(_entityApi: DualWriteVendorActivitiesApi<T>) {
    super(_entityApi);
  }
}

export interface DualWriteVendorActivitiesType<
  T extends DeSerializers = DefaultDeSerializers
> {
