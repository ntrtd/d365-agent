...
import { ProductSizeGroupsRequestBuilder } from './ProductSizeGroupsRequestBuilder';
...
export class ProductSizeGroupsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<ProductSizeGroups<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new ProductSizeGroupsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    PRODUCT_SIZE_GROUP_LINES: OneToManyLink<
      ProductSizeGroups<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = ProductSizeGroups;

  requestBuilder(): ProductSizeGroupsRequestBuilder<DeSerializersT> {
    return new ProductSizeGroupsRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<ProductSizeGroups<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  ): CustomField<ProductSizeGroups<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _schema?: {
    GROUP_ID: OrderableEdmTypeField<
      ProductSizeGroups<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    PRODUCTS: OneToManyLink<
      ...
      ProductsV2Api<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<ProductSizeGroups<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ProductSizeGroups)
      };
    }
