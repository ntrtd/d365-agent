...
import { SalesChargeRequestBuilder } from './SalesChargeRequestBuilder';
...
export class SalesChargeApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<SalesCharge<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new SalesChargeApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    DIMENSION_COMBINATION: OneToOneLink<
      SalesCharge<DeSerializersT>,
      DeSerializersT,
      DimensionCombinationsApi<DeSerializersT>
    >;
    /**
     * Static representation of the one-to-many navigation property {@link salesFreightCharges} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SALES_FREIGHT_CHARGES: OneToManyLink<
      SalesCharge<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ...
      SALES_FREIGHT_CHARGES: new OneToManyLink(
        'SalesFreightCharges',
        this,
        linkedApis[1]
      ),
  ...
  entityConstructor = SalesCharge;

  requestBuilder(): SalesChargeRequestBuilder<DeSerializersT> {
    return new SalesChargeRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<SalesCharge<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<SalesCharge<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof SalesCharge, DeSerializersT>;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(SalesCharge, this.deSerializers);
    }
  ...
  private _schema?: {
    ...
    PERIOD_CHARGE_RULE_LINE_CUSTOMERS: OneToManyLink<
      ...
      PeriodChargeRuleLineCustomersApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<SalesCharge<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', SalesCharge)
      };
    }
