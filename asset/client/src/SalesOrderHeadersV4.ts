...
import type { SalesOrderHeadersV4Api } from './SalesOrderHeadersV4Api';
...
/**
 * This class represents the entity "SalesOrderHeadersV4" of service "d365_metadata".
 */
export class SalesOrderHeadersV4<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements SalesOrderHeadersV4Type<T>
{
  /**
   * Technical entity name for SalesOrderHeadersV4.
   */
  static override _entityName = 'SalesOrderHeadersV4';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the SalesOrderHeadersV4 entity.
   */
  ...
  constructor(_entityApi: SalesOrderHeadersV4Api<T>) {
    super(_entityApi);
  }
}

export interface SalesOrderHeadersV4Type<
