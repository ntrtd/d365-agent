...
import { ProductAttributeValuesRequestBuilder } from './ProductAttributeValuesRequestBuilder';
...
export class ProductAttributeValuesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<ProductAttributeValues<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): ProductAttributeValuesApi<DeSerializersT> {
    return new ProductAttributeValuesApi(deSerializers);
  }
  ...
  entityConstructor = ProductAttributeValues;

  requestBuilder(): ProductAttributeValuesRequestBuilder<DeSerializersT> {
    return new ProductAttributeValuesRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    ProductAttributeValues<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _schema?: {
    PRODUCT_NUMBER: OrderableEdmTypeField<
      ProductAttributeValues<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    TEXT_VALUE: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<ProductAttributeValues<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ProductAttributeValues)
      };
    }
