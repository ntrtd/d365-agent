...
import { ItemCoverageSettingsRequestBuilder } from './ItemCoverageSettingsRequestBuilder';
...
export class ItemCoverageSettingsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<ItemCoverageSettings<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new ItemCoverageSettingsApi(deSerializers);
  }

  private navigationPropertyFields!: {
    /**
     * Static representation of the one-to-one navigation property {@link coverageWarehouse} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    COVERAGE_WAREHOUSE: OneToOneLink<
      ItemCoverageSettings<DeSerializersT>,
      DeSerializersT,
    ...
    >;
    /**
     * Static representation of the one-to-one navigation property {@link coverageSite} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    COVERAGE_SITE: OneToOneLink<
      ItemCoverageSettings<DeSerializersT>,
      DeSerializersT,
      OperationalSitesApi<DeSerializersT>
    >;
    /**
     * Static representation of the one-to-one navigation property {@link coverageWarehouseLocation} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    COVERAGE_WAREHOUSE_LOCATION: OneToOneLink<
      ItemCoverageSettings<DeSerializersT>,
      DeSerializersT,
    ...
    >;
    /**
     * Static representation of the one-to-one navigation property {@link defaultPlannedTransferOrderFromWarehouse} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DEFAULT_PLANNED_TRANSFER_ORDER_FROM_WAREHOUSE: OneToOneLink<
      ItemCoverageSettings<DeSerializersT>,
      DeSerializersT,
      WarehousesApi<DeSerializersT>
    >;
    /**
     * Static representation of the one-to-one navigation property {@link planningFormulaReleasedProduct} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PLANNING_FORMULA_RELEASED_PRODUCT: OneToOneLink<
      ItemCoverageSettings<DeSerializersT>,
      DeSerializersT,
      ReleasedProductsV2Api<DeSerializersT>
    >;
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      COVERAGE_WAREHOUSE: new OneToOneLink(
        'CoverageWarehouse',
        this,
        linkedApis[0]
      ),
      VENDOR: new OneToOneLink('Vendor', this, linkedApis[1]),
      COVERAGE_SITE: new OneToOneLink('CoverageSite', this, linkedApis[2]),
      COVERAGE_WAREHOUSE_LOCATION: new OneToOneLink(
        'CoverageWarehouseLocation',
        this,
        linkedApis[3]
      ),
      ...
      DEFAULT_PLANNED_TRANSFER_ORDER_FROM_WAREHOUSE: new OneToOneLink(
        'DefaultPlannedTransferOrderFromWarehouse',
        this,
        linkedApis[5]
      ),
      PLANNING_FORMULA_RELEASED_PRODUCT: new OneToOneLink(
        'PlanningFormulaReleasedProduct',
        this,
        linkedApis[6]
      )
    };
  ...
  entityConstructor = ItemCoverageSettings;

  requestBuilder(): ItemCoverageSettingsRequestBuilder<DeSerializersT> {
    return new ItemCoverageSettingsRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<ItemCoverageSettings<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ItemCoverageSettings<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    PLANNING_FORMULA_RELEASED_PRODUCT: OneToOneLink<
      ...
      ReleasedProductsV2Api<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<ItemCoverageSettings<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ItemCoverageSettings)
      };
    }
