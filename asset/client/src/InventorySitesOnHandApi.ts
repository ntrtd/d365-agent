...
import { InventorySitesOnHandRequestBuilder } from './InventorySitesOnHandRequestBuilder';
...
export class InventorySitesOnHandApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<InventorySitesOnHand<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): InventorySitesOnHandApi<DeSerializersT> {
    return new InventorySitesOnHandApi(deSerializers);
  }
  ...
  entityConstructor = InventorySitesOnHand;

  requestBuilder(): InventorySitesOnHandRequestBuilder<DeSerializersT> {
    return new InventorySitesOnHandRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    InventorySitesOnHand<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<InventorySitesOnHand<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof InventorySitesOnHand,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        InventorySitesOnHand,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      InventorySitesOnHand<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    TOTAL_AVAILABLE_QUANTITY: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<InventorySitesOnHand<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', InventorySitesOnHand)
      };
    }
