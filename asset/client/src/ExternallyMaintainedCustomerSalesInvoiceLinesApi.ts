...
import { ExternallyMaintainedCustomerSalesInvoiceLinesRequestBuilder } from './ExternallyMaintainedCustomerSalesInvoiceLinesRequestBuilder';
import {
  CustomField,
...
export class ExternallyMaintainedCustomerSalesInvoiceLinesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      ExternallyMaintainedCustomerSalesInvoiceLines<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): ExternallyMaintainedCustomerSalesInvoiceLinesApi<DeSerializersT> {
    return new ExternallyMaintainedCustomerSalesInvoiceLinesApi(deSerializers);
  }
  ...
  entityConstructor = ExternallyMaintainedCustomerSalesInvoiceLines;

  requestBuilder(): ExternallyMaintainedCustomerSalesInvoiceLinesRequestBuilder<DeSerializersT> {
    return new ExternallyMaintainedCustomerSalesInvoiceLinesRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof ExternallyMaintainedCustomerSalesInvoiceLines,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ExternallyMaintainedCustomerSalesInvoiceLines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
