...
import { ClmIntegrationPurchaseAgreementsRequestBuilder } from './ClmIntegrationPurchaseAgreementsRequestBuilder';
...
import { ClmIntegrationPurchaseAgreementOwnershipType } from './ClmIntegrationPurchaseAgreementOwnershipType';
...
export class ClmIntegrationPurchaseAgreementsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<ClmIntegrationPurchaseAgreements<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new ClmIntegrationPurchaseAgreementsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    CLM_INTEGRATION_PURCHASE_AGREEMENT_LINES: OneToManyLink<
      ClmIntegrationPurchaseAgreements<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ...
      INVOICE_VENDOR: new OneToOneLink('InvoiceVendor', this, linkedApis[5]),
      PAYMENT_TERMS: new OneToOneLink('PaymentTerms', this, linkedApis[6]),
      ...
      CONTACT_PERSON: new OneToOneLink('ContactPerson', this, linkedApis[10]),
      DEFAULT_LEDGER_DIMENSION_DIMENSION_SET: new OneToOneLink(
        'DefaultLedgerDimensionDimensionSet',
        this,
        linkedApis[11]
      ),
      PROJECT: new OneToOneLink('Project', this, linkedApis[12]),
      DELIVERY_MODE: new OneToOneLink('DeliveryMode', this, linkedApis[13]),
      SECONDARY_RESPONSIBLE_WORKER: new OneToOneLink(
        'SecondaryResponsibleWorker',
        this,
        linkedApis[14]
      ),
      CASH_DISCOUNT: new OneToOneLink('CashDiscount', this, linkedApis[15]),
      DELIVERY_TERMS: new OneToOneLink('DeliveryTerms', this, linkedApis[16]),
  ...
  entityConstructor = ClmIntegrationPurchaseAgreements;

  requestBuilder(): ClmIntegrationPurchaseAgreementsRequestBuilder<DeSerializersT> {
    return new ClmIntegrationPurchaseAgreementsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof ClmIntegrationPurchaseAgreements,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ClmIntegrationPurchaseAgreements<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    AGREEMENT_WORKFLOW_STATUS: EnumField<
      ...
      true
    >;
    AGREEMENT_OWNERSHIP: EnumField<
      ClmIntegrationPurchaseAgreements<DeSerializers>,
      DeSerializersT,
      ClmIntegrationPurchaseAgreementOwnershipType,
      true,
      true
    >;
    ...
    DELIVERY_ADDRESS_TIME_ZONE: EnumField<
      ...
      true
    >;
    SECONDARY_RESPONSIBLE_WORKER_EMAIL: OrderableEdmTypeField<
      ClmIntegrationPurchaseAgreements<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
      true
    >;
    CONTRACT_LEGAL_ENTITY_ID: OrderableEdmTypeField<
      ClmIntegrationPurchaseAgreements<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    DELIVERY_MODE_CODE: OrderableEdmTypeField<
      ...
      true
    >;
    PRIMARY_RESPONSIBLE_WORKER_EMAIL: OrderableEdmTypeField<
      ClmIntegrationPurchaseAgreements<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    VENDOR_PAYMENT_METHOD_SPECIFICATION: OneToOneLink<
      ...
      VendorPaymentMethodSpecificationsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<ClmIntegrationPurchaseAgreements<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link agreementOwnership} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        AGREEMENT_OWNERSHIP: fieldBuilder.buildEnumField(
          'AgreementOwnership',
          ClmIntegrationPurchaseAgreementOwnershipType,
          true
        ),
        ...
        /**
         * Static representation of the {@link secondaryResponsibleWorkerEmail} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        SECONDARY_RESPONSIBLE_WORKER_EMAIL: fieldBuilder.buildEdmTypeField(
          'SecondaryResponsibleWorkerEmail',
          'Edm.String',
          true
        ),
        /**
         * Static representation of the {@link contractLegalEntityId} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CONTRACT_LEGAL_ENTITY_ID: fieldBuilder.buildEdmTypeField(
        ...
        /**
         * Static representation of the {@link primaryResponsibleWorkerEmail} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PRIMARY_RESPONSIBLE_WORKER_EMAIL: fieldBuilder.buildEdmTypeField(
          'PrimaryResponsibleWorkerEmail',
          'Edm.String',
          true
        ),
        /**
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ClmIntegrationPurchaseAgreements)
      };
    }
