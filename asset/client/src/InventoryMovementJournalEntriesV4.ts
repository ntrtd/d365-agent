...
import type { InventoryMovementJournalEntriesV4Api } from './InventoryMovementJournalEntriesV4Api';
...
/**
 * This class represents the entity "InventoryMovementJournalEntriesV4" of service "d365_metadata".
 */
export class InventoryMovementJournalEntriesV4<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements InventoryMovementJournalEntriesV4Type<T>
{
  /**
   * Technical entity name for InventoryMovementJournalEntriesV4.
   */
  static override _entityName = 'InventoryMovementJournalEntriesV4';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the InventoryMovementJournalEntriesV4 entity.
   */
  static _keys = [
    'dataAreaId',
    'JournalNumber',
  ...
  constructor(_entityApi: InventoryMovementJournalEntriesV4Api<T>) {
    super(_entityApi);
  }
}

export interface InventoryMovementJournalEntriesV4Type<
  T extends DeSerializers = DefaultDeSerializers
> {
