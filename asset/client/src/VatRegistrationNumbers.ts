...
import type { VatRegistrationNumbersApi } from './VatRegistrationNumbersApi';
...
/**
 * This class represents the entity "VATRegistrationNumbers" of service "d365_metadata".
 */
export class VatRegistrationNumbers<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements VatRegistrationNumbersType<T>
{
  /**
   * Technical entity name for VatRegistrationNumbers.
   */
  static override _entityName = 'VATRegistrationNumbers';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the VatRegistrationNumbers entity.
   */
  ...
  constructor(_entityApi: VatRegistrationNumbersApi<T>) {
    super(_entityApi);
  }
}

export interface VatRegistrationNumbersType<
  T extends DeSerializers = DefaultDeSerializers
> {
