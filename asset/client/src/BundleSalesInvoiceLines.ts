...
import type { BundleSalesInvoiceLinesApi } from './BundleSalesInvoiceLinesApi';
...
/**
 * This class represents the entity "BundleSalesInvoiceLines" of service "d365_metadata".
 */
export class BundleSalesInvoiceLines<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements BundleSalesInvoiceLinesType<T>
{
  /**
   * Technical entity name for BundleSalesInvoiceLines.
   */
  static override _entityName = 'BundleSalesInvoiceLines';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the BundleSalesInvoiceLines entity.
   */
  static _keys = [
    'dataAreaId',
    'InvoiceNumber',
  ...
  constructor(_entityApi: BundleSalesInvoiceLinesApi<T>) {
    super(_entityApi);
  }
}

export interface BundleSalesInvoiceLinesType<
  T extends DeSerializers = DefaultDeSerializers
> {
