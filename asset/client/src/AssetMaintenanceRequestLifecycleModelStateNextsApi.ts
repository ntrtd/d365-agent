...
import { AssetMaintenanceRequestLifecycleModelStateNextsRequestBuilder } from './AssetMaintenanceRequestLifecycleModelStateNextsRequestBuilder';
import {
  CustomField,
...
export class AssetMaintenanceRequestLifecycleModelStateNextsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      AssetMaintenanceRequestLifecycleModelStateNexts<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): AssetMaintenanceRequestLifecycleModelStateNextsApi<DeSerializersT> {
    return new AssetMaintenanceRequestLifecycleModelStateNextsApi(
      deSerializers
    );
  }
  ...
  entityConstructor = AssetMaintenanceRequestLifecycleModelStateNexts;

  requestBuilder(): AssetMaintenanceRequestLifecycleModelStateNextsRequestBuilder<DeSerializersT> {
    return new AssetMaintenanceRequestLifecycleModelStateNextsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof AssetMaintenanceRequestLifecycleModelStateNexts,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      AssetMaintenanceRequestLifecycleModelStateNexts<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
