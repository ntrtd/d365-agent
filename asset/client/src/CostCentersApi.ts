...
import { CostCentersRequestBuilder } from './CostCentersRequestBuilder';
...
export class CostCentersApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<CostCenters<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): CostCentersApi<DeSerializersT> {
    return new CostCentersApi(deSerializers);
  }
  ...
  entityConstructor = CostCenters;

  requestBuilder(): CostCentersRequestBuilder<DeSerializersT> {
    return new CostCentersRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    CostCenters<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<CostCenters<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<CostCenters<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof CostCenters, DeSerializersT>;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(CostCenters, this.deSerializers);
    }
  ...
  private _schema?: {
    ...
    ADDRESS_VALID_TO: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<CostCenters<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', CostCenters)
      };
    }
