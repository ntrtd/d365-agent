...
import { RetailTransactionTaxTransGtebiEntitiesRequestBuilder } from './RetailTransactionTaxTransGtebiEntitiesRequestBuilder';
...
export class RetailTransactionTaxTransGtebiEntitiesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      RetailTransactionTaxTransGtebiEntities<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): RetailTransactionTaxTransGtebiEntitiesApi<DeSerializersT> {
    return new RetailTransactionTaxTransGtebiEntitiesApi(deSerializers);
  }
  ...
  entityConstructor = RetailTransactionTaxTransGtebiEntities;

  requestBuilder(): RetailTransactionTaxTransGtebiEntitiesRequestBuilder<DeSerializersT> {
    return new RetailTransactionTaxTransGtebiEntitiesRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof RetailTransactionTaxTransGtebiEntities,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        RetailTransactionTaxTransGtebiEntities,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      RetailTransactionTaxTransGtebiEntities<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', RetailTransactionTaxTransGtebiEntities)
      };
    }
