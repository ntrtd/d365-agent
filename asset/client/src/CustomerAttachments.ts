...
import type { CustomerAttachmentsApi } from './CustomerAttachmentsApi';
import { NoYes } from './NoYes';
import { DocuRestriction } from './DocuRestriction';
import { CustomersV3, CustomersV3Type } from './CustomersV3';

/**
 * This class represents the entity "CustomerAttachments" of service "d365_metadata".
 */
export class CustomerAttachments<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements CustomerAttachmentsType<T>
{
  /**
   * Technical entity name for CustomerAttachments.
   */
  static override _entityName = 'CustomerAttachments';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the CustomerAttachments entity.
   */
   ...
   */
  declare customerAttachmentsEntity?: CustomersV3<T> | null;

  constructor(_entityApi: CustomerAttachmentsApi<T>) {
    super(_entityApi);
  }
}

export interface CustomerAttachmentsType<
...
> {
  ...
  customerAttachmentsEntity?: CustomersV3Type<T> | null;
}
