...
import type { CycleCountingWarehouseWorkLinesV2Api } from './CycleCountingWarehouseWorkLinesV2Api';
...
/**
 * This class represents the entity "CycleCountingWarehouseWorkLinesV2" of service "d365_metadata".
 */
export class CycleCountingWarehouseWorkLinesV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements CycleCountingWarehouseWorkLinesV2Type<T>
{
  /**
   * Technical entity name for CycleCountingWarehouseWorkLinesV2.
   */
  static override _entityName = 'CycleCountingWarehouseWorkLinesV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the CycleCountingWarehouseWorkLinesV2 entity.
   */
  static _keys = [
    'dataAreaId',
    'InventoryOwnerId',
  ...
  constructor(_entityApi: CycleCountingWarehouseWorkLinesV2Api<T>) {
    super(_entityApi);
  }
}

export interface CycleCountingWarehouseWorkLinesV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
