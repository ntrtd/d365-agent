...
import type { MssLeaveRequestWorkflowsApi } from './MssLeaveRequestWorkflowsApi';

/**
 * This class represents the entity "MssLeaveRequestWorkflows" of service "d365_metadata".
 */
export class MssLeaveRequestWorkflows<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements MssLeaveRequestWorkflowsType<T>
{
  /**
   * Technical entity name for MssLeaveRequestWorkflows.
   */
  static override _entityName = 'MssLeaveRequestWorkflows';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the MssLeaveRequestWorkflows entity.
   */
  ...
  constructor(_entityApi: MssLeaveRequestWorkflowsApi<T>) {
    super(_entityApi);
  }
}

export interface MssLeaveRequestWorkflowsType<
  T extends DeSerializers = DefaultDeSerializers
> {
