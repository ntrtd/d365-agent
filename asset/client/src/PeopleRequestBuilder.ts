...
> extends RequestBuilder<People<T>, T> {
   ...
   * @param partyNumber Key property. See {@link People.partyNumber}.
   ...
   */
  delete(partyNumber: string): DeleteRequestBuilder<People<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `People`.
  ...
  delete(partyNumberOrEntity: any): DeleteRequestBuilder<People<T>, T> {
    return new DeleteRequestBuilder<People<T>, T>(
      this.entityApi,
      partyNumberOrEntity instanceof People
        ? partyNumberOrEntity
