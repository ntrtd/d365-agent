...
import type { RouteVersionsApi } from './RouteVersionsApi';
import { NoYes } from './NoYes';
import { RouteHeaders, RouteHeadersType } from './RouteHeaders';
import { Workers, WorkersType } from './Workers';

/**
 * This class represents the entity "RouteVersions" of service "d365_metadata".
 */
export class RouteVersions<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements RouteVersionsType<T>
{
  /**
   * Technical entity name for RouteVersions.
   */
  static override _entityName = 'RouteVersions';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the RouteVersions entity.
   */
  static _keys = [
    'dataAreaId',
    'ValidFromQuantity',
  ...
  constructor(_entityApi: RouteVersionsApi<T>) {
    super(_entityApi);
  }
}

export interface RouteVersionsType<
