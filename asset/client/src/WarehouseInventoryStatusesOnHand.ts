...
import type { WarehouseInventoryStatusesOnHandApi } from './WarehouseInventoryStatusesOnHandApi';
import { NoYes } from './NoYes';

/**
 * This class represents the entity "WarehouseInventoryStatusesOnHand" of service "d365_metadata".
 */
export class WarehouseInventoryStatusesOnHand<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements WarehouseInventoryStatusesOnHandType<T>
{
  /**
   * Technical entity name for WarehouseInventoryStatusesOnHand.
   */
  static override _entityName = 'WarehouseInventoryStatusesOnHand';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the WarehouseInventoryStatusesOnHand entity.
   */
  static _keys = [
    'dataAreaId',
    'ItemNumber',
  ...
  constructor(_entityApi: WarehouseInventoryStatusesOnHandApi<T>) {
    super(_entityApi);
  }
}

export interface WarehouseInventoryStatusesOnHandType<
  T extends DeSerializers = DefaultDeSerializers
> {
