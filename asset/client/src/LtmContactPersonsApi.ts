...
import { LtmContactPersonsRequestBuilder } from './LtmContactPersonsRequestBuilder';
import {
  CustomField,
...
export class LtmContactPersonsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<LtmContactPersons<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): LtmContactPersonsApi<DeSerializersT> {
    return new LtmContactPersonsApi(deSerializers);
  }
  ...
  entityConstructor = LtmContactPersons;

  requestBuilder(): LtmContactPersonsRequestBuilder<DeSerializersT> {
    return new LtmContactPersonsRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    LtmContactPersons<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<LtmContactPersons<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  ): CustomField<LtmContactPersons<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      LtmContactPersons<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    NOTE_1: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<LtmContactPersons<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', LtmContactPersons)
      };
    }
