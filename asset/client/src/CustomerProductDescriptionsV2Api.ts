...
import { CustomerProductDescriptionsV2RequestBuilder } from './CustomerProductDescriptionsV2RequestBuilder';
...
export class CustomerProductDescriptionsV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<CustomerProductDescriptionsV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new CustomerProductDescriptionsV2Api(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    CUSTOMER: OneToOneLink<
      CustomerProductDescriptionsV2<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = CustomerProductDescriptionsV2;

  requestBuilder(): CustomerProductDescriptionsV2RequestBuilder<DeSerializersT> {
    return new CustomerProductDescriptionsV2RequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof CustomerProductDescriptionsV2,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      CustomerProductDescriptionsV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    RELEASED_PRODUCT: OneToOneLink<
      ...
      ReleasedProductsV2Api<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<CustomerProductDescriptionsV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', CustomerProductDescriptionsV2)
      };
    }
