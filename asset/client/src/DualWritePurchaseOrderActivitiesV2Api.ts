...
import { DualWritePurchaseOrderActivitiesV2RequestBuilder } from './DualWritePurchaseOrderActivitiesV2RequestBuilder';
...
export class DualWritePurchaseOrderActivitiesV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      DualWritePurchaseOrderActivitiesV2<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): DualWritePurchaseOrderActivitiesV2Api<DeSerializersT> {
    return new DualWritePurchaseOrderActivitiesV2Api(deSerializers);
  }
  ...
  entityConstructor = DualWritePurchaseOrderActivitiesV2;

  requestBuilder(): DualWritePurchaseOrderActivitiesV2RequestBuilder<DeSerializersT> {
    return new DualWritePurchaseOrderActivitiesV2RequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof DualWritePurchaseOrderActivitiesV2,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        DualWritePurchaseOrderActivitiesV2,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      DualWritePurchaseOrderActivitiesV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    SOURCE: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<DualWritePurchaseOrderActivitiesV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', DualWritePurchaseOrderActivitiesV2)
      };
    }
