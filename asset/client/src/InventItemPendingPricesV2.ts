...
import type { InventItemPendingPricesV2Api } from './InventItemPendingPricesV2Api';
import { CostingVersionPriceType } from './CostingVersionPriceType';
import { NoYes } from './NoYes';

/**
 * This class represents the entity "InventItemPendingPricesV2" of service "d365_metadata".
 */
export class InventItemPendingPricesV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements InventItemPendingPricesV2Type<T>
{
  /**
   * Technical entity name for InventItemPendingPricesV2.
   */
  static override _entityName = 'InventItemPendingPricesV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the InventItemPendingPricesV2 entity.
   */
  static _keys = [
    'dataAreaId',
    'ItemNumber',
  ...
  constructor(_entityApi: InventItemPendingPricesV2Api<T>) {
    super(_entityApi);
  }
}

export interface InventItemPendingPricesV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
