...
import type { ItemHazardousMaterialsDetailsV2Api } from './ItemHazardousMaterialsDetailsV2Api';
import { NoYes } from './NoYes';
import { HmimAirType } from './HmimAirType';

/**
 * This class represents the entity "ItemHazardousMaterialsDetailsV2" of service "d365_metadata".
 */
export class ItemHazardousMaterialsDetailsV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ItemHazardousMaterialsDetailsV2Type<T>
{
  /**
   * Technical entity name for ItemHazardousMaterialsDetailsV2.
   */
  static override _entityName = 'ItemHazardousMaterialsDetailsV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ItemHazardousMaterialsDetailsV2 entity.
   */
  ...
  constructor(_entityApi: ItemHazardousMaterialsDetailsV2Api<T>) {
    super(_entityApi);
  }
}

export interface ItemHazardousMaterialsDetailsV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
