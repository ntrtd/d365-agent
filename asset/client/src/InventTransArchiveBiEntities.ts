...
import type { InventTransArchiveBiEntitiesApi } from './InventTransArchiveBiEntitiesApi';
...
/**
 * This class represents the entity "InventTransArchiveBiEntities" of service "d365_metadata".
 */
export class InventTransArchiveBiEntities<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements InventTransArchiveBiEntitiesType<T>
{
  /**
   * Technical entity name for InventTransArchiveBiEntities.
   */
  static override _entityName = 'InventTransArchiveBiEntities';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the InventTransArchiveBiEntities entity.
   */
  ...
  constructor(_entityApi: InventTransArchiveBiEntitiesApi<T>) {
    super(_entityApi);
  }
}

export interface InventTransArchiveBiEntitiesType<
  T extends DeSerializers = DefaultDeSerializers
> {
