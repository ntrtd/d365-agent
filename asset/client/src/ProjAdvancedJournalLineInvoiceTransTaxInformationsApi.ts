...
import { ProjAdvancedJournalLineInvoiceTransTaxInformationsRequestBuilder } from './ProjAdvancedJournalLineInvoiceTransTaxInformationsRequestBuilder';
...
export class ProjAdvancedJournalLineInvoiceTransTaxInformationsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      ProjAdvancedJournalLineInvoiceTransTaxInformations<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): ProjAdvancedJournalLineInvoiceTransTaxInformationsApi<DeSerializersT> {
    return new ProjAdvancedJournalLineInvoiceTransTaxInformationsApi(
      deSerializers
    );
  }
  ...
  entityConstructor = ProjAdvancedJournalLineInvoiceTransTaxInformations;

  requestBuilder(): ProjAdvancedJournalLineInvoiceTransTaxInformationsRequestBuilder<DeSerializersT> {
    return new ProjAdvancedJournalLineInvoiceTransTaxInformationsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof ProjAdvancedJournalLineInvoiceTransTaxInformations,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ProjAdvancedJournalLineInvoiceTransTaxInformations<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
