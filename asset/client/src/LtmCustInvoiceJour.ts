...
import type { LtmCustInvoiceJourApi } from './LtmCustInvoiceJourApi';
import { NoYes } from './NoYes';

/**
 * This class represents the entity "LTMCustInvoiceJour" of service "d365_metadata".
 */
export class LtmCustInvoiceJour<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements LtmCustInvoiceJourType<T>
{
  /**
   * Technical entity name for LtmCustInvoiceJour.
   */
  static override _entityName = 'LTMCustInvoiceJour';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the LtmCustInvoiceJour entity.
   */
  ...
  constructor(_entityApi: LtmCustInvoiceJourApi<T>) {
    super(_entityApi);
  }
}

export interface LtmCustInvoiceJourType<
