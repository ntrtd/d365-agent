...
import type { ProductColorsApi } from './ProductColorsApi';
import {
...
/**
 * This class represents the entity "ProductColors" of service "d365_metadata".
 */
export class ProductColors<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements ProductColorsType<T>
{
  /**
   * Technical entity name for ProductColors.
   */
  static override _entityName = 'ProductColors';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ProductColors entity.
   */
   ...
   */
  declare maintenanceAssetBillOfMaterialsProductColor: AssetMaintenanceAssetBillOfMaterialsV2<T>[];
  /**
   ...
   */
  declare entAssetReleasedProductsAlternativeProductColor: AssetMaintenanceReleasedProducts<T>[];
  /**
   * One-to-many navigation property to the {@link AssetMaintenanceReleasedProducts} entity.
   */
  declare entAssetReleasedProductsDefaultProductColor: AssetMaintenanceReleasedProducts<T>[];
  /**
   * One-to-many navigation property to the {@link AssetMaintenanceWorkOrderLineProductJournals} entity.
   */
  declare workOrderLineProductConsumptionLinesProductColor: AssetMaintenanceWorkOrderLineProductJournals<T>[];
  /**
  ...
  constructor(_entityApi: ProductColorsApi<T>) {
    super(_entityApi);
  }
}

export interface ProductColorsType<
...
> {
  ...
  maintenanceAssetBillOfMaterialsProductColor: AssetMaintenanceAssetBillOfMaterialsV2Type<T>[];
  ...
  entAssetReleasedProductsAlternativeProductColor: AssetMaintenanceReleasedProductsType<T>[];
  entAssetReleasedProductsDefaultProductColor: AssetMaintenanceReleasedProductsType<T>[];
  workOrderLineProductConsumptionLinesProductColor: AssetMaintenanceWorkOrderLineProductJournalsType<T>[];
