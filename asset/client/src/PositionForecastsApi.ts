...
import { PositionForecastsRequestBuilder } from './PositionForecastsRequestBuilder';
...
export class PositionForecastsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<PositionForecasts<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): PositionForecastsApi<DeSerializersT> {
    return new PositionForecastsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    DIMENSION_COMBINATION: OneToOneLink<
      PositionForecasts<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = PositionForecasts;

  requestBuilder(): PositionForecastsRequestBuilder<DeSerializersT> {
    return new PositionForecastsRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<PositionForecasts<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  ): CustomField<PositionForecasts<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _schema?: {
    FORECAST_POSITION_ID: OrderableEdmTypeField<
      PositionForecasts<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    DIMENSION_COMBINATION: OneToOneLink<
      ...
      DimensionCombinationsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<PositionForecasts<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PositionForecasts)
      };
    }
