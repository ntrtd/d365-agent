...
import { InventJournalTransTransTaxInformationsRequestBuilder } from './InventJournalTransTransTaxInformationsRequestBuilder';
...
export class InventJournalTransTransTaxInformationsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      InventJournalTransTransTaxInformations<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): InventJournalTransTransTaxInformationsApi<DeSerializersT> {
    return new InventJournalTransTransTaxInformationsApi(deSerializers);
  }
  ...
  entityConstructor = InventJournalTransTransTaxInformations;

  requestBuilder(): InventJournalTransTransTaxInformationsRequestBuilder<DeSerializersT> {
    return new InventJournalTransTransTaxInformationsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof InventJournalTransTransTaxInformations,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        InventJournalTransTransTaxInformations,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      InventJournalTransTransTaxInformations<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', InventJournalTransTransTaxInformations)
      };
    }
