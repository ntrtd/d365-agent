...
import type { ProjTableTransTaxInformationsApi } from './ProjTableTransTaxInformationsApi';
...
/**
 * This class represents the entity "ProjTableTransTaxInformations" of service "d365_metadata".
 */
export class ProjTableTransTaxInformations<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ProjTableTransTaxInformationsType<T>
{
  /**
   * Technical entity name for ProjTableTransTaxInformations.
   */
  static override _entityName = 'ProjTableTransTaxInformations';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ProjTableTransTaxInformations entity.
   */
  ...
  constructor(_entityApi: ProjTableTransTaxInformationsApi<T>) {
    super(_entityApi);
  }
}

export interface ProjTableTransTaxInformationsType<
  T extends DeSerializers = DefaultDeSerializers
> {
