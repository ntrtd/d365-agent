...
import type { SalesQuotationHeadersApi } from './SalesQuotationHeadersApi';
...
/**
 * This class represents the entity "SalesQuotationHeaders" of service "d365_metadata".
 */
export class SalesQuotationHeaders<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements SalesQuotationHeadersType<T>
{
  /**
   * Technical entity name for SalesQuotationHeaders.
   */
  static override _entityName = 'SalesQuotationHeaders';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the SalesQuotationHeaders entity.
   */
  ...
  constructor(_entityApi: SalesQuotationHeadersApi<T>) {
    super(_entityApi);
  }
}

export interface SalesQuotationHeadersType<
  T extends DeSerializers = DefaultDeSerializers
> {
