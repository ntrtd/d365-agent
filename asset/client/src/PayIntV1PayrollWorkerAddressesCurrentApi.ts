...
import { PayIntV1PayrollWorkerAddressesCurrentRequestBuilder } from './PayIntV1PayrollWorkerAddressesCurrentRequestBuilder';
...
export class PayIntV1PayrollWorkerAddressesCurrentApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      PayIntV1PayrollWorkerAddressesCurrent<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    ...
    return new PayIntV1PayrollWorkerAddressesCurrentApi(deSerializers);
  }
  ...
  entityConstructor = PayIntV1PayrollWorkerAddressesCurrent;

  requestBuilder(): PayIntV1PayrollWorkerAddressesCurrentRequestBuilder<DeSerializersT> {
    return new PayIntV1PayrollWorkerAddressesCurrentRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof PayIntV1PayrollWorkerAddressesCurrent,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    PERSONNEL_NUMBER: OrderableEdmTypeField<
      PayIntV1PayrollWorkerAddressesCurrent<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    BASE_WORKER: OneToOneLink<
      ...
      BaseWorkersApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<PayIntV1PayrollWorkerAddressesCurrent<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PayIntV1PayrollWorkerAddressesCurrent)
      };
    }
