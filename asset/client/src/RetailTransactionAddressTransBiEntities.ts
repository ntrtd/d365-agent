...
import type { RetailTransactionAddressTransBiEntitiesApi } from './RetailTransactionAddressTransBiEntitiesApi';

/**
 * This class represents the entity "RetailTransactionAddressTransBIEntities" of service "d365_metadata".
 */
export class RetailTransactionAddressTransBiEntities<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements RetailTransactionAddressTransBiEntitiesType<T>
{
  /**
   * Technical entity name for RetailTransactionAddressTransBiEntities.
   */
  static override _entityName = 'RetailTransactionAddressTransBIEntities';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the RetailTransactionAddressTransBiEntities entity.
   */
  static _keys = [
    'dataAreaId',
    'store',
  ...
  constructor(_entityApi: RetailTransactionAddressTransBiEntitiesApi<T>) {
    super(_entityApi);
  }
}

export interface RetailTransactionAddressTransBiEntitiesType<
  T extends DeSerializers = DefaultDeSerializers
> {
