...
import type { InventorySitesOnHandApi } from './InventorySitesOnHandApi';
import { NoYes } from './NoYes';

/**
 * This class represents the entity "InventorySitesOnHand" of service "d365_metadata".
 */
export class InventorySitesOnHand<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements InventorySitesOnHandType<T>
{
  /**
   * Technical entity name for InventorySitesOnHand.
   */
  static override _entityName = 'InventorySitesOnHand';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the InventorySitesOnHand entity.
   */
  static _keys = [
    'dataAreaId',
    'ItemNumber',
  ...
  constructor(_entityApi: InventorySitesOnHandApi<T>) {
    super(_entityApi);
  }
}

export interface InventorySitesOnHandType<
  T extends DeSerializers = DefaultDeSerializers
> {
