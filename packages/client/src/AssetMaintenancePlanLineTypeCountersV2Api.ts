...
import { AssetMaintenancePlanLineTypeCountersV2RequestBuilder } from './AssetMaintenancePlanLineTypeCountersV2RequestBuilder';
...
export class AssetMaintenancePlanLineTypeCountersV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      AssetMaintenancePlanLineTypeCountersV2<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): AssetMaintenancePlanLineTypeCountersV2Api<DeSerializersT> {
    return new AssetMaintenancePlanLineTypeCountersV2Api(deSerializers);
  }
  ...
  entityConstructor = AssetMaintenancePlanLineTypeCountersV2;

  requestBuilder(): AssetMaintenancePlanLineTypeCountersV2RequestBuilder<DeSerializersT> {
    return new AssetMaintenancePlanLineTypeCountersV2RequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof AssetMaintenancePlanLineTypeCountersV2,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        AssetMaintenancePlanLineTypeCountersV2,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      AssetMaintenancePlanLineTypeCountersV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    JOB_VARIANT_ID: OrderableEdmTypeField<
      ...
      true
    >;
    ACTIVITY_INTERVAL_TYPE: EnumField<
      AssetMaintenancePlanLineTypeCountersV2<DeSerializers>,
      DeSerializersT,
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACTIVITY_INTERVAL_TYPE: fieldBuilder.buildEnumField(
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', AssetMaintenancePlanLineTypeCountersV2)
      };
    }
