...
import type { RetailTransactionSafeTenderTransBiEntitiesApi } from './RetailTransactionSafeTenderTransBiEntitiesApi';
import { NoYes } from './NoYes';
import { RetailEntryStatus } from './RetailEntryStatus';
import { RetailSafeStatusTypeBase } from './RetailSafeStatusTypeBase';

/**
 * This class represents the entity "RetailTransactionSafeTenderTransBIEntities" of service "d365_metadata".
 */
export class RetailTransactionSafeTenderTransBiEntities<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements RetailTransactionSafeTenderTransBiEntitiesType<T>
{
  /**
   * Technical entity name for RetailTransactionSafeTenderTransBiEntities.
   */
  static override _entityName = 'RetailTransactionSafeTenderTransBIEntities';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the RetailTransactionSafeTenderTransBiEntities entity.
   */
  static _keys = [
    'dataAreaId',
    'Store',
   ...
   * @nullable
   */
  declare statusType?: RetailSafeStatusTypeBase | null;
  /**
   * Managers Key Live.
   * @nullable
   */
  ...
  constructor(_entityApi: RetailTransactionSafeTenderTransBiEntitiesApi<T>) {
    super(_entityApi);
  }
}

export interface RetailTransactionSafeTenderTransBiEntitiesType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  statusType?: RetailSafeStatusTypeBase | null;
