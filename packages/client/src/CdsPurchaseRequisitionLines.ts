...
import type { CdsPurchaseRequisitionLinesApi } from './CdsPurchaseRequisitionLinesApi';
...
/**
 * This class represents the entity "CDSPurchaseRequisitionLines" of service "d365_metadata".
 */
export class CdsPurchaseRequisitionLines<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements CdsPurchaseRequisitionLinesType<T>
{
  /**
   * Technical entity name for CdsPurchaseRequisitionLines.
   */
  static override _entityName = 'CDSPurchaseRequisitionLines';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the CdsPurchaseRequisitionLines entity.
   */
  ...
  constructor(_entityApi: CdsPurchaseRequisitionLinesApi<T>) {
    super(_entityApi);
  }
}

export interface CdsPurchaseRequisitionLinesType<
  T extends DeSerializers = DefaultDeSerializers
> {
