...
import { DualWriteCustomerActivitiesRequestBuilder } from './DualWriteCustomerActivitiesRequestBuilder';
...
export class DualWriteCustomerActivitiesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<DualWriteCustomerActivities<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): DualWriteCustomerActivitiesApi<DeSerializersT> {
    return new DualWriteCustomerActivitiesApi(deSerializers);
  }
  ...
  entityConstructor = DualWriteCustomerActivities;

  requestBuilder(): DualWriteCustomerActivitiesRequestBuilder<DeSerializersT> {
    return new DualWriteCustomerActivitiesRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    DualWriteCustomerActivities<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof DualWriteCustomerActivities,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        DualWriteCustomerActivities,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      DualWriteCustomerActivities<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    SOURCE: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<DualWriteCustomerActivities<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', DualWriteCustomerActivities)
      };
    }
