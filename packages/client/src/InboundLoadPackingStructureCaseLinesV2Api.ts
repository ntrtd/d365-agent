...
import { InboundLoadPackingStructureCaseLinesV2RequestBuilder } from './InboundLoadPackingStructureCaseLinesV2RequestBuilder';
...
export class InboundLoadPackingStructureCaseLinesV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      InboundLoadPackingStructureCaseLinesV2<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    ...
    return new InboundLoadPackingStructureCaseLinesV2Api(deSerializers);
  }
  ...
  entityConstructor = InboundLoadPackingStructureCaseLinesV2;

  requestBuilder(): InboundLoadPackingStructureCaseLinesV2RequestBuilder<DeSerializersT> {
    return new InboundLoadPackingStructureCaseLinesV2RequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof InboundLoadPackingStructureCaseLinesV2,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      InboundLoadPackingStructureCaseLinesV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', InboundLoadPackingStructureCaseLinesV2)
      };
    }
