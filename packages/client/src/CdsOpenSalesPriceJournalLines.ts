...
import type { CdsOpenSalesPriceJournalLinesApi } from './CdsOpenSalesPriceJournalLinesApi';
import { NoYes } from './NoYes';

/**
 * This class represents the entity "CDSOpenSalesPriceJournalLines" of service "d365_metadata".
 */
export class CdsOpenSalesPriceJournalLines<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements CdsOpenSalesPriceJournalLinesType<T>
{
  /**
   * Technical entity name for CdsOpenSalesPriceJournalLines.
   */
  static override _entityName = 'CDSOpenSalesPriceJournalLines';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the CdsOpenSalesPriceJournalLines entity.
   */
  ...
  constructor(_entityApi: CdsOpenSalesPriceJournalLinesApi<T>) {
    super(_entityApi);
  }
}

export interface CdsOpenSalesPriceJournalLinesType<
  T extends DeSerializers = DefaultDeSerializers
> {
