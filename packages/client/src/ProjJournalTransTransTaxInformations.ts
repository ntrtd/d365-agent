...
import type { ProjJournalTransTransTaxInformationsApi } from './ProjJournalTransTransTaxInformationsApi';
...
/**
 * This class represents the entity "ProjJournalTransTransTaxInformations" of service "d365_metadata".
 */
export class ProjJournalTransTransTaxInformations<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ProjJournalTransTransTaxInformationsType<T>
{
  /**
   * Technical entity name for ProjJournalTransTransTaxInformations.
   */
  static override _entityName = 'ProjJournalTransTransTaxInformations';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ProjJournalTransTransTaxInformations entity.
   */
  ...
  constructor(_entityApi: ProjJournalTransTransTaxInformationsApi<T>) {
    super(_entityApi);
  }
}

export interface ProjJournalTransTransTaxInformationsType<
  T extends DeSerializers = DefaultDeSerializers
> {
