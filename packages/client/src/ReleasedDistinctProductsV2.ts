...
import type { ReleasedDistinctProductsV2Api } from './ReleasedDistinctProductsV2Api';
...
/**
 * This class represents the entity "ReleasedDistinctProductsV2" of service "d365_metadata".
 */
export class ReleasedDistinctProductsV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ReleasedDistinctProductsV2Type<T>
{
  /**
   * Technical entity name for ReleasedDistinctProductsV2.
   */
  static override _entityName = 'ReleasedDistinctProductsV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ReleasedDistinctProductsV2 entity.
   */
  ...
  constructor(_entityApi: ReleasedDistinctProductsV2Api<T>) {
    super(_entityApi);
  }
}

export interface ReleasedDistinctProductsV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
