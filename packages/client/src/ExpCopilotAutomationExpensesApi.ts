...
import { ExpCopilotAutomationExpensesRequestBuilder } from './ExpCopilotAutomationExpensesRequestBuilder';
...
export class ExpCopilotAutomationExpensesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<ExpCopilotAutomationExpenses<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): ExpCopilotAutomationExpensesApi<DeSerializersT> {
    return new ExpCopilotAutomationExpensesApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    DIMENSION_SET: OneToOneLink<
      ExpCopilotAutomationExpenses<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = ExpCopilotAutomationExpenses;

  requestBuilder(): ExpCopilotAutomationExpensesRequestBuilder<DeSerializersT> {
    return new ExpCopilotAutomationExpensesRequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof ExpCopilotAutomationExpenses,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      ExpCopilotAutomationExpenses<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    TRV_HCM_WORKER_PERSONNEL_NUMBER: OrderableEdmTypeField<
      ...
      true
    >;
    DETACH_UNATTACHED_REC_ID: OrderableEdmTypeField<
      ExpCopilotAutomationExpenses<DeSerializers>,
      DeSerializersT,
      'Edm.Int32',
      false,
    ...
    POST_ACCOUNT_TYPE: EnumField<
      ...
      true
    >;
    UNATTACHED_RECEIPT_REC_IDS: OrderableEdmTypeField<
      ExpCopilotAutomationExpenses<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    DIMENSION_SET: OneToOneLink<
      ...
      DimensionSetsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<ExpCopilotAutomationExpenses<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link detachUnattachedRecId} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        DETACH_UNATTACHED_REC_ID: fieldBuilder.buildEdmTypeField(
          'DetachUnattachedRecId',
          'Edm.Int32',
          false
        ),
        /**
        ...
        /**
         * Static representation of the {@link unattachedReceiptRecIds} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        UNATTACHED_RECEIPT_REC_IDS: fieldBuilder.buildEdmTypeField(
          'UnattachedReceiptRecIds',
          'Edm.String',
          true
        ),
        /**
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ExpCopilotAutomationExpenses)
      };
    }
