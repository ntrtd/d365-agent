...
import type { SalesInvoiceHeadersV2Api } from './SalesInvoiceHeadersV2Api';
import {
...
import {
  SalesInvoiceV2Lines,
  SalesInvoiceV2LinesType
} from './SalesInvoiceV2Lines';
import {
  SalesInvoiceV3Lines,
  SalesInvoiceV3LinesType
} from './SalesInvoiceV3Lines';

/**
 * This class represents the entity "SalesInvoiceHeadersV2" of service "d365_metadata".
 */
export class SalesInvoiceHeadersV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements SalesInvoiceHeadersV2Type<T>
{
  /**
   * Technical entity name for SalesInvoiceHeadersV2.
   */
  static override _entityName = 'SalesInvoiceHeadersV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the SalesInvoiceHeadersV2 entity.
   */
  static _keys = [
    'dataAreaId',
    'InvoiceNumber',
  ...
  /**
   * One-to-many navigation property to the {@link SalesInvoiceV2Lines} entity.
   */
  declare salesInvoiceLinesV2: SalesInvoiceV2Lines<T>[];
  /**
   * One-to-many navigation property to the {@link SalesInvoiceV3Lines} entity.
   */
  declare salesInvoiceLinesV3: SalesInvoiceV3Lines<T>[];

  constructor(_entityApi: SalesInvoiceHeadersV2Api<T>) {
    super(_entityApi);
  }
}

export interface SalesInvoiceHeadersV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  salesInvoiceLinesV2: SalesInvoiceV2LinesType<T>[];
  salesInvoiceLinesV3: SalesInvoiceV3LinesType<T>[];
}
