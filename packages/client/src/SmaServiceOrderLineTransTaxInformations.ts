...
import type { SmaServiceOrderLineTransTaxInformationsApi } from './SmaServiceOrderLineTransTaxInformationsApi';
...
/**
 * This class represents the entity "SMAServiceOrderLineTransTaxInformations" of service "d365_metadata".
 */
export class SmaServiceOrderLineTransTaxInformations<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements SmaServiceOrderLineTransTaxInformationsType<T>
{
  /**
   * Technical entity name for SmaServiceOrderLineTransTaxInformations.
   */
  static override _entityName = 'SMAServiceOrderLineTransTaxInformations';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the SmaServiceOrderLineTransTaxInformations entity.
   */
  ...
  constructor(_entityApi: SmaServiceOrderLineTransTaxInformationsApi<T>) {
    super(_entityApi);
  }
}

export interface SmaServiceOrderLineTransTaxInformationsType<
  T extends DeSerializers = DefaultDeSerializers
> {
