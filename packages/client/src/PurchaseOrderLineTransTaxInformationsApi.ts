...
import { PurchaseOrderLineTransTaxInformationsRequestBuilder } from './PurchaseOrderLineTransTaxInformationsRequestBuilder';
...
export class PurchaseOrderLineTransTaxInformationsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      PurchaseOrderLineTransTaxInformations<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): PurchaseOrderLineTransTaxInformationsApi<DeSerializersT> {
    return new PurchaseOrderLineTransTaxInformationsApi(deSerializers);
  }
  ...
  entityConstructor = PurchaseOrderLineTransTaxInformations;

  requestBuilder(): PurchaseOrderLineTransTaxInformationsRequestBuilder<DeSerializersT> {
    return new PurchaseOrderLineTransTaxInformationsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof PurchaseOrderLineTransTaxInformations,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        PurchaseOrderLineTransTaxInformations,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      PurchaseOrderLineTransTaxInformations<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    EXCISE_IS_SCRAP: EnumField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<PurchaseOrderLineTransTaxInformations<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PurchaseOrderLineTransTaxInformations)
      };
    }
