...
import { InboundLoadPackingStructureLinesV4RequestBuilder } from './InboundLoadPackingStructureLinesV4RequestBuilder';
...
export class InboundLoadPackingStructureLinesV4Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      InboundLoadPackingStructureLinesV4<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): InboundLoadPackingStructureLinesV4Api<DeSerializersT> {
    return new InboundLoadPackingStructureLinesV4Api(deSerializers);
  }
  ...
  entityConstructor = InboundLoadPackingStructureLinesV4;

  requestBuilder(): InboundLoadPackingStructureLinesV4RequestBuilder<DeSerializersT> {
    return new InboundLoadPackingStructureLinesV4RequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof InboundLoadPackingStructureLinesV4,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        InboundLoadPackingStructureLinesV4,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      InboundLoadPackingStructureLinesV4<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    CAPTURED_WEIGHT: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<InboundLoadPackingStructureLinesV4<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', InboundLoadPackingStructureLinesV4)
      };
    }
