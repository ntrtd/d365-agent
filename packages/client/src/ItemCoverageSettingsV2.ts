...
import type { ItemCoverageSettingsV2Api } from './ItemCoverageSettingsV2Api';
...
/**
 * This class represents the entity "ItemCoverageSettingsV2" of service "d365_metadata".
 */
export class ItemCoverageSettingsV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ItemCoverageSettingsV2Type<T>
{
  /**
   * Technical entity name for ItemCoverageSettingsV2.
   */
  static override _entityName = 'ItemCoverageSettingsV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ItemCoverageSettingsV2 entity.
   */
  static _keys = [
    'dataAreaId',
    'ItemNumber',
  ...
  constructor(_entityApi: ItemCoverageSettingsV2Api<T>) {
    super(_entityApi);
  }
}

export interface ItemCoverageSettingsV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
