...
import type { PurchaseRequisitionLineTransTaxInformationsApi } from './PurchaseRequisitionLineTransTaxInformationsApi';
...
/**
 * This class represents the entity "PurchaseRequisitionLineTransTaxInformations" of service "d365_metadata".
 */
export class PurchaseRequisitionLineTransTaxInformations<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements PurchaseRequisitionLineTransTaxInformationsType<T>
{
  /**
   * Technical entity name for PurchaseRequisitionLineTransTaxInformations.
   */
  static override _entityName = 'PurchaseRequisitionLineTransTaxInformations';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the PurchaseRequisitionLineTransTaxInformations entity.
   */
  static _keys = ['dataAreaId', 'SequenceNumber', 'PurchReqTable'];
  /**
   * Data Area Id.
   */
  ...
  constructor(_entityApi: PurchaseRequisitionLineTransTaxInformationsApi<T>) {
    super(_entityApi);
  }
}

export interface PurchaseRequisitionLineTransTaxInformationsType<
  T extends DeSerializers = DefaultDeSerializers
> {
