...
import type { EmployeesV2Api } from './EmployeesV2Api';
...
/**
 * This class represents the entity "EmployeesV2" of service "d365_metadata".
 */
export class EmployeesV2<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements EmployeesV2Type<T>
{
  /**
   * Technical entity name for EmployeesV2.
   */
  static override _entityName = 'EmployeesV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the EmployeesV2 entity.
   */
  ...
  constructor(_entityApi: EmployeesV2Api<T>) {
    super(_entityApi);
  }
}

export interface EmployeesV2Type<
