...
import { RetailTransactionAuditableSafeDropRequestBuilder } from './RetailTransactionAuditableSafeDropRequestBuilder';
...
export class RetailTransactionAuditableSafeDropApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      RetailTransactionAuditableSafeDrop<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): RetailTransactionAuditableSafeDropApi<DeSerializersT> {
    return new RetailTransactionAuditableSafeDropApi(deSerializers);
  }
  ...
  entityConstructor = RetailTransactionAuditableSafeDrop;

  requestBuilder(): RetailTransactionAuditableSafeDropRequestBuilder<DeSerializersT> {
    return new RetailTransactionAuditableSafeDropRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof RetailTransactionAuditableSafeDrop,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        RetailTransactionAuditableSafeDrop,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      RetailTransactionAuditableSafeDrop<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    TRANSACTION_TIME: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<RetailTransactionAuditableSafeDrop<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', RetailTransactionAuditableSafeDrop)
      };
    }
