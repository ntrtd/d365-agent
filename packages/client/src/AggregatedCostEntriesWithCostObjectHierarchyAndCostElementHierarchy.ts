...
import type { AggregatedCostEntriesWithCostObjectHierarchyAndCostElementHierarchyApi } from './AggregatedCostEntriesWithCostObjectHierarchyAndCostElementHierarchyApi';
...
/**
 * This class represents the entity "AggregatedCostEntriesWithCostObjectHierarchyAndCostElementHierarchy" of service "d365_metadata".
 */
export class AggregatedCostEntriesWithCostObjectHierarchyAndCostElementHierarchy<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements
    AggregatedCostEntriesWithCostObjectHierarchyAndCostElementHierarchyType<T>
{
  /**
   * Technical entity name for AggregatedCostEntriesWithCostObjectHierarchyAndCostElementHierarchy.
   */
  ...
  /**
   * All key fields of the AggregatedCostEntriesWithCostObjectHierarchyAndCostElementHierarchy entity.
   */
  static _keys = [
    'CostControlUnitName',
  ...
  constructor(
    _entityApi: AggregatedCostEntriesWithCostObjectHierarchyAndCostElementHierarchyApi<T>
  ) {
    super(_entityApi);
  }
}

export interface AggregatedCostEntriesWithCostObjectHierarchyAndCostElementHierarchyType<
  T extends DeSerializers = DefaultDeSerializers
> {
