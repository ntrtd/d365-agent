...
import type { UbuyPurchaseRequisitionLinesApi } from './UbuyPurchaseRequisitionLinesApi';
...
import {
  ...
  UbuyPurchaseRequisitionHeadersType
} from './UbuyPurchaseRequisitionHeaders';

/**
 * This class represents the entity "UbuyPurchaseRequisitionLines" of service "d365_metadata".
 */
export class UbuyPurchaseRequisitionLines<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements UbuyPurchaseRequisitionLinesType<T>
{
  /**
   * Technical entity name for UbuyPurchaseRequisitionLines.
   */
  static override _entityName = 'UbuyPurchaseRequisitionLines';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the UbuyPurchaseRequisitionLines entity.
   */
  ...
  /**
   * One-to-one navigation property to the {@link UbuyPurchaseRequisitionHeaders} entity.
   */
  declare ubuyPurchaseRequisitionHeader?: UbuyPurchaseRequisitionHeaders<T> | null;

  constructor(_entityApi: UbuyPurchaseRequisitionLinesApi<T>) {
    super(_entityApi);
  }
}

export interface UbuyPurchaseRequisitionLinesType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  ubuyPurchaseRequisitionHeader?: UbuyPurchaseRequisitionHeadersType<T> | null;
}
