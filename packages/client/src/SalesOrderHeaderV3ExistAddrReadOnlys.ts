...
import type { SalesOrderHeaderV3ExistAddrReadOnlysApi } from './SalesOrderHeaderV3ExistAddrReadOnlysApi';
...
/**
 * This class represents the entity "SalesOrderHeaderV3ExistAddrReadOnlys" of service "d365_metadata".
 */
export class SalesOrderHeaderV3ExistAddrReadOnlys<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements SalesOrderHeaderV3ExistAddrReadOnlysType<T>
{
  /**
   * Technical entity name for SalesOrderHeaderV3ExistAddrReadOnlys.
   */
  static override _entityName = 'SalesOrderHeaderV3ExistAddrReadOnlys';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the SalesOrderHeaderV3ExistAddrReadOnlys entity.
   */
  static _keys = [
    'dataAreaId',
    'SalesOrderNumber',
  ...
  constructor(_entityApi: SalesOrderHeaderV3ExistAddrReadOnlysApi<T>) {
    super(_entityApi);
  }
}

export interface SalesOrderHeaderV3ExistAddrReadOnlysType<
  T extends DeSerializers = DefaultDeSerializers
> {
