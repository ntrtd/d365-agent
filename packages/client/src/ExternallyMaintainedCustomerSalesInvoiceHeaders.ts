...
import type { ExternallyMaintainedCustomerSalesInvoiceHeadersApi } from './ExternallyMaintainedCustomerSalesInvoiceHeadersApi';
import { SalesOriginType } from './SalesOriginType';

/**
 * This class represents the entity "ExternallyMaintainedCustomerSalesInvoiceHeaders" of service "d365_metadata".
 */
export class ExternallyMaintainedCustomerSalesInvoiceHeaders<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ExternallyMaintainedCustomerSalesInvoiceHeadersType<T>
{
  /**
   * Technical entity name for ExternallyMaintainedCustomerSalesInvoiceHeaders.
   */
  ...
  /**
   * All key fields of the ExternallyMaintainedCustomerSalesInvoiceHeaders entity.
   */
  static _keys = [
    'dataAreaId',
    'InvoiceNumber',
  ...
  constructor(
    _entityApi: ExternallyMaintainedCustomerSalesInvoiceHeadersApi<T>
  ) {
    super(_entityApi);
  }
}

export interface ExternallyMaintainedCustomerSalesInvoiceHeadersType<
  T extends DeSerializers = DefaultDeSerializers
> {
