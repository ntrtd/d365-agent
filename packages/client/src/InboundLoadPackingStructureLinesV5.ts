...
import type { InboundLoadPackingStructureLinesV5Api } from './InboundLoadPackingStructureLinesV5Api';
import { WhsModule } from './WhsModule';

/**
 * This class represents the entity "InboundLoadPackingStructureLinesV5" of service "d365_metadata".
 */
export class InboundLoadPackingStructureLinesV5<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements InboundLoadPackingStructureLinesV5Type<T>
{
  /**
   * Technical entity name for InboundLoadPackingStructureLinesV5.
   */
  static override _entityName = 'InboundLoadPackingStructureLinesV5';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the InboundLoadPackingStructureLinesV5 entity.
   */
  static _keys = [
    'dataAreaId',
    'InboundShipmentId',
  ...
  constructor(_entityApi: InboundLoadPackingStructureLinesV5Api<T>) {
    super(_entityApi);
  }
}

export interface InboundLoadPackingStructureLinesV5Type<
  T extends DeSerializers = DefaultDeSerializers
> {
