...
import { RetailTransactionAddressLinesRequestBuilder } from './RetailTransactionAddressLinesRequestBuilder';
import {
  CustomField,
...
export class RetailTransactionAddressLinesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<RetailTransactionAddressLines<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): RetailTransactionAddressLinesApi<DeSerializersT> {
    return new RetailTransactionAddressLinesApi(deSerializers);
  }
  ...
  entityConstructor = RetailTransactionAddressLines;

  requestBuilder(): RetailTransactionAddressLinesRequestBuilder<DeSerializersT> {
    return new RetailTransactionAddressLinesRequestBuilder<DeSerializersT>(
      this
    );
  }

  entityBuilder(): EntityBuilderType<
    RetailTransactionAddressLines<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof RetailTransactionAddressLines,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        RetailTransactionAddressLines,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      RetailTransactionAddressLines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    STATE: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<RetailTransactionAddressLines<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', RetailTransactionAddressLines)
      };
    }
