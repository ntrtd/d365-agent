...
import { SalesInvoiceV3LinesRequestBuilder } from './SalesInvoiceV3LinesRequestBuilder';
...
export class SalesInvoiceV3LinesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<SalesInvoiceV3Lines<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new SalesInvoiceV3LinesApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    SALES_INVOICE_HEADER_V_2: OneToOneLink<
      SalesInvoiceV3Lines<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = SalesInvoiceV3Lines;

  requestBuilder(): SalesInvoiceV3LinesRequestBuilder<DeSerializersT> {
    return new SalesInvoiceV3LinesRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<SalesInvoiceV3Lines<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      SalesInvoiceV3Lines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    SALES_INVOICE_HEADER_V_2: OneToOneLink<
      ...
      SalesInvoiceHeadersV2Api<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<SalesInvoiceV3Lines<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', SalesInvoiceV3Lines)
      };
    }
