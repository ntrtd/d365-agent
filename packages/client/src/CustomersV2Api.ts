...
import { CustomersV2RequestBuilder } from './CustomersV2RequestBuilder';
...
> implements EntityApi<CustomersV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): CustomersV2Api<DeSerializersT> {
    return new CustomersV2Api(deSerializers);
  }
  ...
  entityConstructor = CustomersV2;

  requestBuilder(): CustomersV2RequestBuilder<DeSerializersT> {
    return new CustomersV2RequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<CustomersV2<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<CustomersV2<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof CustomersV2, DeSerializersT>;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(CustomersV2, this.deSerializers);
    }
  ...
  private _schema?: {
    ...
    DIMENSION_SET: OneToOneLink<
      ...
      DimensionSetsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<CustomersV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', CustomersV2)
      };
    }
