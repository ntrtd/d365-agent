...
import type { IntrastatsV2Api } from './IntrastatsV2Api';
...
/**
 * This class represents the entity "IntrastatsV2" of service "d365_metadata".
 */
export class IntrastatsV2<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements IntrastatsV2Type<T>
{
  /**
   * Technical entity name for IntrastatsV2.
   */
  static override _entityName = 'IntrastatsV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the IntrastatsV2 entity.
   */
  ...
  constructor(_entityApi: IntrastatsV2Api<T>) {
    super(_entityApi);
  }
}

export interface IntrastatsV2Type<
