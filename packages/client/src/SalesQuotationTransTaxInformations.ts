...
import type { SalesQuotationTransTaxInformationsApi } from './SalesQuotationTransTaxInformationsApi';
...
/**
 * This class represents the entity "SalesQuotationTransTaxInformations" of service "d365_metadata".
 */
export class SalesQuotationTransTaxInformations<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements SalesQuotationTransTaxInformationsType<T>
{
  /**
   * Technical entity name for SalesQuotationTransTaxInformations.
   */
  static override _entityName = 'SalesQuotationTransTaxInformations';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the SalesQuotationTransTaxInformations entity.
   */
  static _keys = ['dataAreaId', 'QuotationId', 'LineCreationSequenceNumber'];
  /**
   * Data Area Id.
   */
  ...
  constructor(_entityApi: SalesQuotationTransTaxInformationsApi<T>) {
    super(_entityApi);
  }
}

export interface SalesQuotationTransTaxInformationsType<
  T extends DeSerializers = DefaultDeSerializers
> {
