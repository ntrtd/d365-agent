...
import type { LedgerJournalLineTransTaxInformationsApi } from './LedgerJournalLineTransTaxInformationsApi';
...
/**
 * This class represents the entity "LedgerJournalLineTransTaxInformations" of service "d365_metadata".
 */
export class LedgerJournalLineTransTaxInformations<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements LedgerJournalLineTransTaxInformationsType<T>
{
  /**
   * Technical entity name for LedgerJournalLineTransTaxInformations.
   */
  static override _entityName = 'LedgerJournalLineTransTaxInformations';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the LedgerJournalLineTransTaxInformations entity.
   */
  ...
  constructor(_entityApi: LedgerJournalLineTransTaxInformationsApi<T>) {
    super(_entityApi);
  }
}

export interface LedgerJournalLineTransTaxInformationsType<
  T extends DeSerializers = DefaultDeSerializers
> {
