...
import { SalesQuotationTransTaxInformationsRequestBuilder } from './SalesQuotationTransTaxInformationsRequestBuilder';
...
export class SalesQuotationTransTaxInformationsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      SalesQuotationTransTaxInformations<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): SalesQuotationTransTaxInformationsApi<DeSerializersT> {
    return new SalesQuotationTransTaxInformationsApi(deSerializers);
  }
  ...
  entityConstructor = SalesQuotationTransTaxInformations;

  requestBuilder(): SalesQuotationTransTaxInformationsRequestBuilder<DeSerializersT> {
    return new SalesQuotationTransTaxInformationsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof SalesQuotationTransTaxInformations,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        SalesQuotationTransTaxInformations,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      SalesQuotationTransTaxInformations<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    EXCISE_IS_SCRAP: EnumField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<SalesQuotationTransTaxInformations<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', SalesQuotationTransTaxInformations)
      };
    }
