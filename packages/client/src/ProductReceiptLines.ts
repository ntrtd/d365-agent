...
import type { ProductReceiptLinesApi } from './ProductReceiptLinesApi';

/**
 * This class represents the entity "ProductReceiptLines" of service "d365_metadata".
 */
export class ProductReceiptLines<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements ProductReceiptLinesType<T>
{
  /**
   * Technical entity name for ProductReceiptLines.
   */
  static override _entityName = 'ProductReceiptLines';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ProductReceiptLines entity.
   */
  ...
  constructor(_entityApi: ProductReceiptLinesApi<T>) {
    super(_entityApi);
  }
}

export interface ProductReceiptLinesType<
