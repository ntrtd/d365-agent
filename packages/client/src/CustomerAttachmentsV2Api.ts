...
import { CustomerAttachmentsV2RequestBuilder } from './CustomerAttachmentsV2RequestBuilder';
...
export class CustomerAttachmentsV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<CustomerAttachmentsV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new CustomerAttachmentsV2Api(deSerializers);
  }

  private navigationPropertyFields!: {
    /**
     * Static representation of the one-to-one navigation property {@link customerAttachmentsV2Entity} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CUSTOMER_ATTACHMENTS_V_2_ENTITY: OneToOneLink<
      CustomerAttachmentsV2<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(linkedApis: [CustomersV3Api<DeSerializersT>]): this {
    this.navigationPropertyFields = {
      CUSTOMER_ATTACHMENTS_V_2_ENTITY: new OneToOneLink(
  ...
  entityConstructor = CustomerAttachmentsV2;

  requestBuilder(): CustomerAttachmentsV2RequestBuilder<DeSerializersT> {
    return new CustomerAttachmentsV2RequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<CustomerAttachmentsV2<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      CustomerAttachmentsV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    CUSTOMER_ATTACHMENTS_V_2_ENTITY: OneToOneLink<
      ...
      CustomersV3Api<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<CustomerAttachmentsV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', CustomerAttachmentsV2)
      };
    }
