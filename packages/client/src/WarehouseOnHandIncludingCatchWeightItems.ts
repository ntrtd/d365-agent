...
import type { WarehouseOnHandIncludingCatchWeightItemsApi } from './WarehouseOnHandIncludingCatchWeightItemsApi';
import { NoYes } from './NoYes';

/**
 * This class represents the entity "WarehouseOnHandIncludingCatchWeightItems" of service "d365_metadata".
 */
export class WarehouseOnHandIncludingCatchWeightItems<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements WarehouseOnHandIncludingCatchWeightItemsType<T>
{
  /**
   * Technical entity name for WarehouseOnHandIncludingCatchWeightItems.
   */
  static override _entityName = 'WarehouseOnHandIncludingCatchWeightItems';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the WarehouseOnHandIncludingCatchWeightItems entity.
   */
  static _keys = [
    'dataAreaId',
    'ItemNumber',
  ...
  constructor(_entityApi: WarehouseOnHandIncludingCatchWeightItemsApi<T>) {
    super(_entityApi);
  }
}

export interface WarehouseOnHandIncludingCatchWeightItemsType<
  T extends DeSerializers = DefaultDeSerializers
> {
