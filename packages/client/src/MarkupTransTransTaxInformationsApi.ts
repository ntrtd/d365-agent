...
import { MarkupTransTransTaxInformationsRequestBuilder } from './MarkupTransTransTaxInformationsRequestBuilder';
...
export class MarkupTransTransTaxInformationsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<MarkupTransTransTaxInformations<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): MarkupTransTransTaxInformationsApi<DeSerializersT> {
    return new MarkupTransTransTaxInformationsApi(deSerializers);
  }
  ...
  entityConstructor = MarkupTransTransTaxInformations;

  requestBuilder(): MarkupTransTransTaxInformationsRequestBuilder<DeSerializersT> {
    return new MarkupTransTransTaxInformationsRequestBuilder<DeSerializersT>(
      this
    );
  }

  entityBuilder(): EntityBuilderType<
    MarkupTransTransTaxInformations<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof MarkupTransTransTaxInformations,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        MarkupTransTransTaxInformations,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      MarkupTransTransTaxInformations<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    EXCISE_IS_SCRAP: EnumField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<MarkupTransTransTaxInformations<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', MarkupTransTransTaxInformations)
      };
    }
