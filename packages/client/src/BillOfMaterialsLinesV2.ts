...
import type { BillOfMaterialsLinesV2Api } from './BillOfMaterialsLinesV2Api';
...
/**
 * This class represents the entity "BillOfMaterialsLinesV2" of service "d365_metadata".
 */
export class BillOfMaterialsLinesV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements BillOfMaterialsLinesV2Type<T>
{
  /**
   * Technical entity name for BillOfMaterialsLinesV2.
   */
  static override _entityName = 'BillOfMaterialsLinesV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the BillOfMaterialsLinesV2 entity.
   */
  ...
  constructor(_entityApi: BillOfMaterialsLinesV2Api<T>) {
    super(_entityApi);
  }
}

export interface BillOfMaterialsLinesV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
