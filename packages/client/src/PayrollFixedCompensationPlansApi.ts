...
import { PayrollFixedCompensationPlansRequestBuilder } from './PayrollFixedCompensationPlansRequestBuilder';
...
export class PayrollFixedCompensationPlansApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<PayrollFixedCompensationPlans<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new PayrollFixedCompensationPlansApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    POSITION_V_2: OneToOneLink<
      PayrollFixedCompensationPlans<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = PayrollFixedCompensationPlans;

  requestBuilder(): PayrollFixedCompensationPlansRequestBuilder<DeSerializersT> {
    return new PayrollFixedCompensationPlansRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof PayrollFixedCompensationPlans,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      PayrollFixedCompensationPlans<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    PAY_INT_V_1_PAYROLL_POSITION: OneToOneLink<
      ...
      PayIntV1PayrollPositionsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<PayrollFixedCompensationPlans<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PayrollFixedCompensationPlans)
      };
    }
