...
import { PurchasePriceAgreementsRequestBuilder } from './PurchasePriceAgreementsRequestBuilder';
...
export class PurchasePriceAgreementsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<PurchasePriceAgreements<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): PurchasePriceAgreementsApi<DeSerializersT> {
    return new PurchasePriceAgreementsApi(deSerializers);
  }
  ...
  entityConstructor = PurchasePriceAgreements;

  requestBuilder(): PurchasePriceAgreementsRequestBuilder<DeSerializersT> {
    return new PurchasePriceAgreementsRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    PurchasePriceAgreements<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof PurchasePriceAgreements,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      PurchasePriceAgreements<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    PRODUCT_STYLE_ID: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<PurchasePriceAgreements<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        RELATION: fieldBuilder.buildEnumField('Relation', PriceType, true),
        /**
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PurchasePriceAgreements)
      };
    }
