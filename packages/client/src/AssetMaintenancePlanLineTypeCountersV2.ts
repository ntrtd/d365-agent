...
import type { AssetMaintenancePlanLineTypeCountersV2Api } from './AssetMaintenancePlanLineTypeCountersV2Api';
import { NoYes } from './NoYes';
import { EntAssetMaintenancePlanLineIntervalType } from './EntAssetMaintenancePlanLineIntervalType';

/**
 * This class represents the entity "AssetMaintenancePlanLineTypeCountersV2" of service "d365_metadata".
 */
export class AssetMaintenancePlanLineTypeCountersV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements AssetMaintenancePlanLineTypeCountersV2Type<T>
{
  /**
   * Technical entity name for AssetMaintenancePlanLineTypeCountersV2.
   */
  static override _entityName = 'AssetMaintenancePlanLineTypeCountersV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the AssetMaintenancePlanLineTypeCountersV2 entity.
   */
   ...
   * @nullable
   */
  declare activityIntervalType?: EntAssetMaintenancePlanLineIntervalType | null;
  /**
   * Expected End Hours.
   */
  ...
  constructor(_entityApi: AssetMaintenancePlanLineTypeCountersV2Api<T>) {
    super(_entityApi);
  }
}

export interface AssetMaintenancePlanLineTypeCountersV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  activityIntervalType?: EntAssetMaintenancePlanLineIntervalType | null;
