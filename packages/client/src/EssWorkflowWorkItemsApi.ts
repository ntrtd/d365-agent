...
import { EssWorkflowWorkItemsRequestBuilder } from './EssWorkflowWorkItemsRequestBuilder';
...
export class EssWorkflowWorkItemsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<EssWorkflowWorkItems<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): EssWorkflowWorkItemsApi<DeSerializersT> {
    return new EssWorkflowWorkItemsApi(deSerializers);
  }
  ...
  entityConstructor = EssWorkflowWorkItems;

  requestBuilder(): EssWorkflowWorkItemsRequestBuilder<DeSerializersT> {
    return new EssWorkflowWorkItemsRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    EssWorkflowWorkItems<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<EssWorkflowWorkItems<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof EssWorkflowWorkItems,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        EssWorkflowWorkItems,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    ID: OrderableEdmTypeField<
      EssWorkflowWorkItems<DeSerializers>,
      DeSerializersT,
      'Edm.Guid',
      false,
      true
    ...
    DUE_DATE_TIME: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<EssWorkflowWorkItems<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', EssWorkflowWorkItems)
      };
    }
