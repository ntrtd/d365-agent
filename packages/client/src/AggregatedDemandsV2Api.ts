...
import { AggregatedDemandsV2RequestBuilder } from './AggregatedDemandsV2RequestBuilder';
...
export class AggregatedDemandsV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<AggregatedDemandsV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): AggregatedDemandsV2Api<DeSerializersT> {
    return new AggregatedDemandsV2Api(deSerializers);
  }
  ...
  entityConstructor = AggregatedDemandsV2;

  requestBuilder(): AggregatedDemandsV2RequestBuilder<DeSerializersT> {
    return new AggregatedDemandsV2RequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    AggregatedDemandsV2<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<AggregatedDemandsV2<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      AggregatedDemandsV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    DEMAND_QUANTITY: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<AggregatedDemandsV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', AggregatedDemandsV2)
      };
    }
