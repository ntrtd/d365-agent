...
import type { PurchaseOrderLineTransTaxInformationsApi } from './PurchaseOrderLineTransTaxInformationsApi';
...
/**
 * This class represents the entity "PurchaseOrderLineTransTaxInformations" of service "d365_metadata".
 */
export class PurchaseOrderLineTransTaxInformations<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements PurchaseOrderLineTransTaxInformationsType<T>
{
  /**
   * Technical entity name for PurchaseOrderLineTransTaxInformations.
   */
  static override _entityName = 'PurchaseOrderLineTransTaxInformations';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the PurchaseOrderLineTransTaxInformations entity.
   */
  static _keys = [
    'dataAreaId',
  ...
  constructor(_entityApi: PurchaseOrderLineTransTaxInformationsApi<T>) {
    super(_entityApi);
  }
}

export interface PurchaseOrderLineTransTaxInformationsType<
  T extends DeSerializers = DefaultDeSerializers
> {
