...
import type { PurchaseRequisitionLinesApi } from './PurchaseRequisitionLinesApi';
...
/**
 * This class represents the entity "PurchaseRequisitionLines" of service "d365_metadata".
 */
export class PurchaseRequisitionLines<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements PurchaseRequisitionLinesType<T>
{
  /**
   * Technical entity name for PurchaseRequisitionLines.
   */
  static override _entityName = 'PurchaseRequisitionLines';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the PurchaseRequisitionLines entity.
   */
  ...
  constructor(_entityApi: PurchaseRequisitionLinesApi<T>) {
    super(_entityApi);
  }
}

export interface PurchaseRequisitionLinesType<
  T extends DeSerializers = DefaultDeSerializers
> {
