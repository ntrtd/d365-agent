...
import { SalesOrderHeadersV2RequestBuilder } from './SalesOrderHeadersV2RequestBuilder';
...
export class SalesOrderHeadersV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<SalesOrderHeadersV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new SalesOrderHeadersV2Api(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    DIMENSION_SET: OneToOneLink<
      SalesOrderHeadersV2<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = SalesOrderHeadersV2;

  requestBuilder(): SalesOrderHeadersV2RequestBuilder<DeSerializersT> {
    return new SalesOrderHeadersV2RequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<SalesOrderHeadersV2<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      SalesOrderHeadersV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    SALES_ORDER_LINES: OneToManyLink<
      ...
      SalesOrderLinesApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<SalesOrderHeadersV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', SalesOrderHeadersV2)
      };
    }
