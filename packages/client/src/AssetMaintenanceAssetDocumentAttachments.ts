...
import type { AssetMaintenanceAssetDocumentAttachmentsApi } from './AssetMaintenanceAssetDocumentAttachmentsApi';
import { DocuRestriction } from './DocuRestriction';
import { NoYes } from './NoYes';

/**
 * This class represents the entity "AssetMaintenanceAssetDocumentAttachments" of service "d365_metadata".
 */
export class AssetMaintenanceAssetDocumentAttachments<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements AssetMaintenanceAssetDocumentAttachmentsType<T>
{
  /**
   * Technical entity name for AssetMaintenanceAssetDocumentAttachments.
   */
  static override _entityName = 'AssetMaintenanceAssetDocumentAttachments';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the AssetMaintenanceAssetDocumentAttachments entity.
   */
  ...
  constructor(_entityApi: AssetMaintenanceAssetDocumentAttachmentsApi<T>) {
    super(_entityApi);
  }
}

export interface AssetMaintenanceAssetDocumentAttachmentsType<
  T extends DeSerializers = DefaultDeSerializers
> {
