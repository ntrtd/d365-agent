...
import { SalesOrderHeaderV3ExistAddrReadOnlysRequestBuilder } from './SalesOrderHeaderV3ExistAddrReadOnlysRequestBuilder';
...
export class SalesOrderHeaderV3ExistAddrReadOnlysApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      SalesOrderHeaderV3ExistAddrReadOnlys<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): SalesOrderHeaderV3ExistAddrReadOnlysApi<DeSerializersT> {
    return new SalesOrderHeaderV3ExistAddrReadOnlysApi(deSerializers);
  }
  ...
  entityConstructor = SalesOrderHeaderV3ExistAddrReadOnlys;

  requestBuilder(): SalesOrderHeaderV3ExistAddrReadOnlysRequestBuilder<DeSerializersT> {
    return new SalesOrderHeaderV3ExistAddrReadOnlysRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof SalesOrderHeaderV3ExistAddrReadOnlys,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        SalesOrderHeaderV3ExistAddrReadOnlys,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      SalesOrderHeaderV3ExistAddrReadOnlys<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    FIXED_EXCHANGE_RATE: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<SalesOrderHeaderV3ExistAddrReadOnlys<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', SalesOrderHeaderV3ExistAddrReadOnlys)
      };
    }
