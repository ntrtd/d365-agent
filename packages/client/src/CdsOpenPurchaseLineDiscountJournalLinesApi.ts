...
import { CdsOpenPurchaseLineDiscountJournalLinesRequestBuilder } from './CdsOpenPurchaseLineDiscountJournalLinesRequestBuilder';
...
export class CdsOpenPurchaseLineDiscountJournalLinesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      CdsOpenPurchaseLineDiscountJournalLines<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): CdsOpenPurchaseLineDiscountJournalLinesApi<DeSerializersT> {
    return new CdsOpenPurchaseLineDiscountJournalLinesApi(deSerializers);
  }
  ...
  entityConstructor = CdsOpenPurchaseLineDiscountJournalLines;

  requestBuilder(): CdsOpenPurchaseLineDiscountJournalLinesRequestBuilder<DeSerializersT> {
    return new CdsOpenPurchaseLineDiscountJournalLinesRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof CdsOpenPurchaseLineDiscountJournalLines,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        CdsOpenPurchaseLineDiscountJournalLines,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      CdsOpenPurchaseLineDiscountJournalLines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', CdsOpenPurchaseLineDiscountJournalLines)
      };
    }
