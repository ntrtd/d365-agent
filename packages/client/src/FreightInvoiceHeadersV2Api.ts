...
import { FreightInvoiceHeadersV2RequestBuilder } from './FreightInvoiceHeadersV2RequestBuilder';
import { FreightInvoiceLinesV2Api } from './FreightInvoiceLinesV2Api';
...
export class FreightInvoiceHeadersV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<FreightInvoiceHeadersV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new FreightInvoiceHeadersV2Api(deSerializers);
  }

  private navigationPropertyFields!: {
    /**
     * Static representation of the one-to-many navigation property {@link freightInvoiceLineV2} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    FREIGHT_INVOICE_LINE_V_2: OneToManyLink<
      FreightInvoiceHeadersV2<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    linkedApis: [FreightInvoiceLinesV2Api<DeSerializersT>]
  ): this {
    this.navigationPropertyFields = {
      FREIGHT_INVOICE_LINE_V_2: new OneToManyLink(
        'FreightInvoiceLineV2',
        this,
        linkedApis[0]
      )
    };
  ...
  entityConstructor = FreightInvoiceHeadersV2;

  requestBuilder(): FreightInvoiceHeadersV2RequestBuilder<DeSerializersT> {
    return new FreightInvoiceHeadersV2RequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof FreightInvoiceHeadersV2,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        FreightInvoiceHeadersV2,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      FreightInvoiceHeadersV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    FREIGHT_INVOICE_LINE_V_2: OneToManyLink<
      ...
      FreightInvoiceLinesV2Api<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<FreightInvoiceHeadersV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', FreightInvoiceHeadersV2)
      };
    }
