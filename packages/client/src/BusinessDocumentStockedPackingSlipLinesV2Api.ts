...
import { BusinessDocumentStockedPackingSlipLinesV2RequestBuilder } from './BusinessDocumentStockedPackingSlipLinesV2RequestBuilder';
...
export class BusinessDocumentStockedPackingSlipLinesV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      BusinessDocumentStockedPackingSlipLinesV2<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    ...
    return new BusinessDocumentStockedPackingSlipLinesV2Api(deSerializers);
  }
  ...
  entityConstructor = BusinessDocumentStockedPackingSlipLinesV2;

  requestBuilder(): BusinessDocumentStockedPackingSlipLinesV2RequestBuilder<DeSerializersT> {
    return new BusinessDocumentStockedPackingSlipLinesV2RequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof BusinessDocumentStockedPackingSlipLinesV2,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      BusinessDocumentStockedPackingSlipLinesV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
