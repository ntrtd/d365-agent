...
import type { DualWritePurchaseOrderActivitiesV2Api } from './DualWritePurchaseOrderActivitiesV2Api';
...
/**
 * This class represents the entity "DualWritePurchaseOrderActivitiesV2" of service "d365_metadata".
 */
export class DualWritePurchaseOrderActivitiesV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements DualWritePurchaseOrderActivitiesV2Type<T>
{
  /**
   * Technical entity name for DualWritePurchaseOrderActivitiesV2.
   */
  static override _entityName = 'DualWritePurchaseOrderActivitiesV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the DualWritePurchaseOrderActivitiesV2 entity.
   */
  static _keys = ['dataAreaId', 'ActivityNumber', 'PurchaseOrderNumber'];
  /**
   * Data Area Id.
   */
  ...
  constructor(_entityApi: DualWritePurchaseOrderActivitiesV2Api<T>) {
    super(_entityApi);
  }
}

export interface DualWritePurchaseOrderActivitiesV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
