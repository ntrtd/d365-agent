...
import { PersonCountrySpecificFieldsV2RequestBuilder } from './PersonCountrySpecificFieldsV2RequestBuilder';
...
export class PersonCountrySpecificFieldsV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<PersonCountrySpecificFieldsV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new PersonCountrySpecificFieldsV2Api(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
     ...
     */
    PERSON: OneToOneLink<
      PersonCountrySpecificFieldsV2<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = PersonCountrySpecificFieldsV2;

  requestBuilder(): PersonCountrySpecificFieldsV2RequestBuilder<DeSerializersT> {
    return new PersonCountrySpecificFieldsV2RequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof PersonCountrySpecificFieldsV2,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    PARTY_NUMBER: OrderableEdmTypeField<
      PersonCountrySpecificFieldsV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    PERSON: OneToOneLink<
      ...
      PeopleApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<PersonCountrySpecificFieldsV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PersonCountrySpecificFieldsV2)
      };
    }
