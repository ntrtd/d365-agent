...
import type { AgreementLineTransTaxInformationsApi } from './AgreementLineTransTaxInformationsApi';
...
/**
 * This class represents the entity "AgreementLineTransTaxInformations" of service "d365_metadata".
 */
export class AgreementLineTransTaxInformations<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements AgreementLineTransTaxInformationsType<T>
{
  /**
   * Technical entity name for AgreementLineTransTaxInformations.
   */
  static override _entityName = 'AgreementLineTransTaxInformations';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the AgreementLineTransTaxInformations entity.
   */
  static _keys = ['dataAreaId', 'Agreement', 'LineNumber'];
  /**
   * Data Area Id.
   */
   ...
   * Agreement.
   */
  declare agreement: DeserializedType<T, 'Edm.Int64'>;
  /**
   * Line Number.
   */
  ...
  constructor(_entityApi: AgreementLineTransTaxInformationsApi<T>) {
    super(_entityApi);
  }
}

export interface AgreementLineTransTaxInformationsType<
  T extends DeSerializers = DefaultDeSerializers
> {
