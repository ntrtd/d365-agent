...
import type { AssetLeaseLedgerJournalLinesApi } from './AssetLeaseLedgerJournalLinesApi';
...
/**
 * This class represents the entity "AssetLeaseLedgerJournalLines" of service "d365_metadata".
 */
export class AssetLeaseLedgerJournalLines<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements AssetLeaseLedgerJournalLinesType<T>
{
  /**
   * Technical entity name for AssetLeaseLedgerJournalLines.
   */
  static override _entityName = 'AssetLeaseLedgerJournalLines';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the AssetLeaseLedgerJournalLines entity.
   */
   ...
   */
  declare ledgerJournalLineEntityBatchJournalNum?: AssetLeaseLedgerJournalLines<T> | null;
  /**
   * One-to-many navigation property to the {@link AssetLeaseLedgerJournalLines} entity.
   */
  declare assetLeaseLedgerJournalHeaderBatchJournalNum: AssetLeaseLedgerJournalLines<T>[];
  /**
   ...
   */
  declare ledgerJournalLineEntitySalesTaxGroup?: TaxGroups<T> | null;
  /**
   * One-to-one navigation property to the {@link LegalEntities} entity.
   */
   ...
   */
  declare ledgerJournalLineEntityItemSalesTaxGroup?: TaxItemGroupHeadings<T> | null;
  /**
   * One-to-one navigation property to the {@link DimensionSets} entity.
   */
  declare assetLeaseLedgerJournalLineDefaultDimension?: DimensionSets<T> | null;
  /**
   * One-to-one navigation property to the {@link DimensionSets} entity.
   */
  declare assetLeaseLedgerJournalLineOffsetDefaultDimension?: DimensionSets<T> | null;
  /**
   * One-to-one navigation property to the {@link DimensionCombinations} entity.
   */
  declare assetLeaseLedgerJournalLineOffsetLedgerDimensionCombination?: DimensionCombinations<T> | null;
  /**
   * One-to-one navigation property to the {@link DimensionCombinations} entity.
   */
  declare assetLeaseLedgerJournalLineLedgerDimensionCombination?: DimensionCombinations<T> | null;
  /**
   * One-to-one navigation property to the {@link VoucherTypes} entity.
   */
  declare ledgerJournalLineEntityVoucherType?: VoucherTypes<T> | null;

  constructor(_entityApi: AssetLeaseLedgerJournalLinesApi<T>) {
    super(_entityApi);
  }
}

export interface AssetLeaseLedgerJournalLinesType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  ledgerJournalLineEntityBatchJournalNum?: AssetLeaseLedgerJournalLinesType<T> | null;
  assetLeaseLedgerJournalHeaderBatchJournalNum: AssetLeaseLedgerJournalLinesType<T>[];
  ledgerJournalLineCurrency?: CurrenciesType<T> | null;
  ledgerJournalLineCompany?: LegalEntitiesType<T> | null;
  ledgerJournalLineEntitySalesTaxGroup?: TaxGroupsType<T> | null;
  ledgerJournalLineOffsetCompany?: LegalEntitiesType<T> | null;
  ledgerJournalLineEntityItemSalesTaxGroup?: TaxItemGroupHeadingsType<T> | null;
  assetLeaseLedgerJournalLineDefaultDimension?: DimensionSetsType<T> | null;
  assetLeaseLedgerJournalLineOffsetDefaultDimension?: DimensionSetsType<T> | null;
  assetLeaseLedgerJournalLineOffsetLedgerDimensionCombination?: DimensionCombinationsType<T> | null;
  assetLeaseLedgerJournalLineLedgerDimensionCombination?: DimensionCombinationsType<T> | null;
  ledgerJournalLineEntityVoucherType?: VoucherTypesType<T> | null;
}
