...
import { BusinessDocumentStockedPackingSlipLinesRequestBuilder } from './BusinessDocumentStockedPackingSlipLinesRequestBuilder';
...
export class BusinessDocumentStockedPackingSlipLinesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      BusinessDocumentStockedPackingSlipLines<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    ...
    return new BusinessDocumentStockedPackingSlipLinesApi(deSerializers);
  }
  ...
  entityConstructor = BusinessDocumentStockedPackingSlipLines;

  requestBuilder(): BusinessDocumentStockedPackingSlipLinesRequestBuilder<DeSerializersT> {
    return new BusinessDocumentStockedPackingSlipLinesRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof BusinessDocumentStockedPackingSlipLines,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      BusinessDocumentStockedPackingSlipLines<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', BusinessDocumentStockedPackingSlipLines)
      };
    }
