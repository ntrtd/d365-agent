...
import type { InventJournalTransTransTaxInformationsApi } from './InventJournalTransTransTaxInformationsApi';
...
/**
 * This class represents the entity "InventJournalTransTransTaxInformations" of service "d365_metadata".
 */
export class InventJournalTransTransTaxInformations<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements InventJournalTransTransTaxInformationsType<T>
{
  /**
   * Technical entity name for InventJournalTransTransTaxInformations.
   */
  static override _entityName = 'InventJournalTransTransTaxInformations';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the InventJournalTransTransTaxInformations entity.
   */
  ...
  constructor(_entityApi: InventJournalTransTransTaxInformationsApi<T>) {
    super(_entityApi);
  }
}

export interface InventJournalTransTransTaxInformationsType<
  T extends DeSerializers = DefaultDeSerializers
> {
