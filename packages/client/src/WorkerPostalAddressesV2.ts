...
import type { WorkerPostalAddressesV2Api } from './WorkerPostalAddressesV2Api';
import { NoYes } from './NoYes';
import { Timezone } from './Timezone';
import { Workers, WorkersType } from './Workers';

/**
 * This class represents the entity "WorkerPostalAddressesV2" of service "d365_metadata".
 */
export class WorkerPostalAddressesV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements WorkerPostalAddressesV2Type<T>
{
  /**
   * Technical entity name for WorkerPostalAddressesV2.
   */
  static override _entityName = 'WorkerPostalAddressesV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the WorkerPostalAddressesV2 entity.
   */
  ...
  constructor(_entityApi: WorkerPostalAddressesV2Api<T>) {
    super(_entityApi);
  }
}

export interface WorkerPostalAddressesV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
