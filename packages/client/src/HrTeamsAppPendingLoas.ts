...
import type { HrTeamsAppPendingLoasApi } from './HrTeamsAppPendingLoasApi';

/**
 * This class represents the entity "HRTeamsAppPendingLoas" of service "d365_metadata".
 */
export class HrTeamsAppPendingLoas<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements HrTeamsAppPendingLoasType<T>
{
  /**
   * Technical entity name for HrTeamsAppPendingLoas.
   */
  static override _entityName = 'HRTeamsAppPendingLoas';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the HrTeamsAppPendingLoas entity.
   */
  static _keys = ['Id'];
  /**
   * Id.
  ...
  constructor(_entityApi: HrTeamsAppPendingLoasApi<T>) {
    super(_entityApi);
  }
}

export interface HrTeamsAppPendingLoasType<
  T extends DeSerializers = DefaultDeSerializers
> {
