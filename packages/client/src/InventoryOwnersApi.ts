...
import { InventoryOwnersRequestBuilder } from './InventoryOwnersRequestBuilder';
...
export class InventoryOwnersApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<InventoryOwners<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new InventoryOwnersApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    INVENTORY_COUNTING_JOURNAL_LINES: OneToManyLink<
      InventoryOwners<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = InventoryOwners;

  requestBuilder(): InventoryOwnersRequestBuilder<DeSerializersT> {
    return new InventoryOwnersRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<InventoryOwners<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<InventoryOwners<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof InventoryOwners, DeSerializersT>;
  get fieldBuilder() {
  ...
  private _schema?: {
    ...
    INVENTORY_OWNER_ID: OrderableEdmTypeField<
      ...
      true
    >;
    INVENTORY_OWNER_NAME: OrderableEdmTypeField<
      InventoryOwners<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    INVENTORY_TAG_COUNTING_JOURNAL_LINES: OneToManyLink<
      ...
      InventoryTagCountingJournalLinesApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<InventoryOwners<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link inventoryOwnerName} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        INVENTORY_OWNER_NAME: fieldBuilder.buildEdmTypeField(
          'InventoryOwnerName',
          'Edm.String',
          true
        ),
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', InventoryOwners)
      };
    }
