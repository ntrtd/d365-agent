...
import type { ProductSizesApi } from './ProductSizesApi';
import {
...
/**
 * This class represents the entity "ProductSizes" of service "d365_metadata".
 */
export class ProductSizes<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements ProductSizesType<T>
{
  /**
   * Technical entity name for ProductSizes.
   */
  static override _entityName = 'ProductSizes';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ProductSizes entity.
   */
  static _keys = ['SizeId'];
  /**
   * Size Id.
   ...
   */
  declare maintenanceAssetBillOfMaterialsProductSize: AssetMaintenanceAssetBillOfMaterialsV2<T>[];
  /**
   ...
   */
  declare entAssetReleasedProductsDefaultProductSize: AssetMaintenanceReleasedProducts<T>[];
  /**
   * One-to-many navigation property to the {@link AssetMaintenanceReleasedProducts} entity.
   */
  declare entAssetReleasedProductsAlternativeProductSize: AssetMaintenanceReleasedProducts<T>[];
  /**
   * One-to-many navigation property to the {@link AssetMaintenanceWorkOrderLineProductJournals} entity.
   */
  declare workOrderLineProductConsumptionLinesProductSize: AssetMaintenanceWorkOrderLineProductJournals<T>[];
  /**
  ...
  constructor(_entityApi: ProductSizesApi<T>) {
    super(_entityApi);
  }
}
...
> {
  ...
  maintenanceAssetBillOfMaterialsProductSize: AssetMaintenanceAssetBillOfMaterialsV2Type<T>[];
  ...
  entAssetReleasedProductsDefaultProductSize: AssetMaintenanceReleasedProductsType<T>[];
  entAssetReleasedProductsAlternativeProductSize: AssetMaintenanceReleasedProductsType<T>[];
  workOrderLineProductConsumptionLinesProductSize: AssetMaintenanceWorkOrderLineProductJournalsType<T>[];
