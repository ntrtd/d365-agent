...
import { DiscussionOverallCommentsRequestBuilder } from './DiscussionOverallCommentsRequestBuilder';
...
export class DiscussionOverallCommentsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<DiscussionOverallComments<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new DiscussionOverallCommentsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    DISCUSSION: OneToOneLink<
      DiscussionOverallComments<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    linkedApis: [DiscussionsApi<DeSerializersT>, PeopleApi<DeSerializersT>]
  ): this {
  ...
  entityConstructor = DiscussionOverallComments;

  requestBuilder(): DiscussionOverallCommentsRequestBuilder<DeSerializersT> {
    return new DiscussionOverallCommentsRequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof DiscussionOverallComments,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DISCUSSION_WORKER_PERSONNEL_NUMBER: OrderableEdmTypeField<
      DiscussionOverallComments<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    COMMENTER: OneToOneLink<
      ...
      PeopleApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<DiscussionOverallComments<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', DiscussionOverallComments)
      };
    }
