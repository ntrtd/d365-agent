...
import type { VendInvoiceRegisterLinesApi } from './VendInvoiceRegisterLinesApi';
...
/**
 * This class represents the entity "VendInvoiceRegisterLines" of service "d365_metadata".
 */
export class VendInvoiceRegisterLines<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements VendInvoiceRegisterLinesType<T>
{
  /**
   * Technical entity name for VendInvoiceRegisterLines.
   */
  static override _entityName = 'VendInvoiceRegisterLines';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the VendInvoiceRegisterLines entity.
   */
   ...
   */
  declare vendInvoiceRegisterLineEntityOffsetAccountDimensionCombination?: DimensionCombinations<T> | null;
  /**
   ...
   */
  declare vendInvoiceRegisterLedgerVoucherTypeRole?: VoucherTypes<T> | null;
  /**
   * One-to-one navigation property to the {@link Workers} entity.
   */
  declare vendInvoiceRegisterLineHcmWorkerEntityRole?: Workers<T> | null;
  /**
   * One-to-one navigation property to the {@link Currencies} entity.
   */
  declare vendInvoiceRegisterLineEntityCurrency?: Currencies<T> | null;
  /**
   * One-to-one navigation property to the {@link DimensionCombinations} entity.
   */
  declare vendInvoiceRegisterLineEntityAccountDimensionCombination?: DimensionCombinations<T> | null;

  constructor(_entityApi: VendInvoiceRegisterLinesApi<T>) {
    super(_entityApi);
  }
}

export interface VendInvoiceRegisterLinesType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  vendInvoiceRegisterLineEntityOffsetAccountDimensionCombination?: DimensionCombinationsType<T> | null;
  vendInvoiceRegisterHeader?: VendInvoiceRegisterHeadersType<T> | null;
  vendInvoiceRegisterLedgerVoucherTypeRole?: VoucherTypesType<T> | null;
  vendInvoiceRegisterLineHcmWorkerEntityRole?: WorkersType<T> | null;
  vendInvoiceRegisterLineEntityCurrency?: CurrenciesType<T> | null;
  vendInvoiceRegisterLineEntityAccountDimensionCombination?: DimensionCombinationsType<T> | null;
}
