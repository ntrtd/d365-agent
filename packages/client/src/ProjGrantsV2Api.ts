...
import { ProjGrantsV2RequestBuilder } from './ProjGrantsV2RequestBuilder';
...
export class ProjGrantsV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<ProjGrantsV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): ProjGrantsV2Api<DeSerializersT> {
    return new ProjGrantsV2Api(deSerializers);
  }
  ...
  entityConstructor = ProjGrantsV2;

  requestBuilder(): ProjGrantsV2RequestBuilder<DeSerializersT> {
    return new ProjGrantsV2RequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    ProjGrantsV2<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<ProjGrantsV2<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<ProjGrantsV2<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof ProjGrantsV2, DeSerializersT>;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(ProjGrantsV2, this.deSerializers);
    }
  ...
  private _schema?: {
    ...
    MATCHING_AMOUNT: OrderableEdmTypeField<
      ...
      true
    >;
    GRANTOR_AGENCY: OrderableEdmTypeField<
      ProjGrantsV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    GRANT_PARENT_ID: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<ProjGrantsV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link cfda} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CFDA: fieldBuilder.buildEdmTypeField('CFDA', 'Edm.String', true),
        /**
        ...
        /**
         * Static representation of the {@link grantorAgency} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        GRANTOR_AGENCY: fieldBuilder.buildEdmTypeField(
          'GrantorAgency',
          'Edm.String',
          true
        ),
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ProjGrantsV2)
      };
    }
