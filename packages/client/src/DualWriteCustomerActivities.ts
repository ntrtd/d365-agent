...
import type { DualWriteCustomerActivitiesApi } from './DualWriteCustomerActivitiesApi';
...
/**
 * This class represents the entity "DualWriteCustomerActivities" of service "d365_metadata".
 */
export class DualWriteCustomerActivities<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements DualWriteCustomerActivitiesType<T>
{
  /**
   * Technical entity name for DualWriteCustomerActivities.
   */
  static override _entityName = 'DualWriteCustomerActivities';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the DualWriteCustomerActivities entity.
   */
  ...
  constructor(_entityApi: DualWriteCustomerActivitiesApi<T>) {
    super(_entityApi);
  }
}

export interface DualWriteCustomerActivitiesType<
  T extends DeSerializers = DefaultDeSerializers
> {
