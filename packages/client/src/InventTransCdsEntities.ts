...
import type { InventTransCdsEntitiesApi } from './InventTransCdsEntitiesApi';
...
/**
 * This class represents the entity "InventTransCDSEntities" of service "d365_metadata".
 */
export class InventTransCdsEntities<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements InventTransCdsEntitiesType<T>
{
  /**
   * Technical entity name for InventTransCdsEntities.
   */
  static override _entityName = 'InventTransCDSEntities';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the InventTransCdsEntities entity.
   */
  static _keys = ['dataAreaId', 'InventTransOrigin', 'inventDimId', 'RecordId'];
  /**
   * Data Area Id.
   */
  ...
  /**
   * Invent Trans Origin Sales Ru.
   */
  declare inventTransOriginSalesRu: DeserializedType<T, 'Edm.Int64'>;
  /**
   * Value Open.
   * @nullable
   */
  ...
  constructor(_entityApi: InventTransCdsEntitiesApi<T>) {
    super(_entityApi);
  }
}

export interface InventTransCdsEntitiesType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  inventTransOriginSalesRu: DeserializedType<T, 'Edm.Int64'>;
