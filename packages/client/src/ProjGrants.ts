...
import type { ProjGrantsApi } from './ProjGrantsApi';
import { NoYes } from './NoYes';
import { ProjGrantStatus } from './ProjGrantStatus';

/**
 * This class represents the entity "ProjGrants" of service "d365_metadata".
 */
export class ProjGrants<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements ProjGrantsType<T>
{
  /**
   * Technical entity name for ProjGrants.
   */
  static override _entityName = 'ProjGrants';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ProjGrants entity.
   */
   ...
   * @nullable
   */
  declare cfdaId?: DeserializedType<T, 'Edm.String'> | null;
  /**
   * Cust Account.
   * @nullable
   */
  ...
  constructor(_entityApi: ProjGrantsApi<T>) {
    super(_entityApi);
  }
}

export interface ProjGrantsType<
...
> {
  ...
  cfdaId?: DeserializedType<T, 'Edm.String'> | null;
