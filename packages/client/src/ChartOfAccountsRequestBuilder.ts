...
> extends RequestBuilder<ChartOfAccounts<T>, T> {
   ...
   * @param chartOfAccounts Key property. See {@link ChartOfAccounts.chartOfAccounts}.
   ...
   */
  delete(chartOfAccounts: string): DeleteRequestBuilder<ChartOfAccounts<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `ChartOfAccounts`.
  ...
  delete(
    ...
    return new DeleteRequestBuilder<ChartOfAccounts<T>, T>(
      this.entityApi,
      chartOfAccountsOrEntity instanceof ChartOfAccounts
