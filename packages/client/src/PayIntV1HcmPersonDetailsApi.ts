...
import { PayIntV1HcmPersonDetailsRequestBuilder } from './PayIntV1HcmPersonDetailsRequestBuilder';
...
export class PayIntV1HcmPersonDetailsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<PayIntV1HcmPersonDetails<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new PayIntV1HcmPersonDetailsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
     ...
     */
    PERSON: OneToOneLink<
      PayIntV1HcmPersonDetails<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = PayIntV1HcmPersonDetails;

  requestBuilder(): PayIntV1HcmPersonDetailsRequestBuilder<DeSerializersT> {
    return new PayIntV1HcmPersonDetailsRequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof PayIntV1HcmPersonDetails,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    PARTY_NUMBER: OrderableEdmTypeField<
      PayIntV1HcmPersonDetails<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    VETERAN_STATUS: OneToOneLink<
      ...
      VeteranStatusesApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<PayIntV1HcmPersonDetails<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PayIntV1HcmPersonDetails)
      };
    }
