...
import type { AssetMaintenanceWorkOrderParentProjectsV2Api } from './AssetMaintenanceWorkOrderParentProjectsV2Api';
import {
...
/**
 * This class represents the entity "AssetMaintenanceWorkOrderParentProjectsV2" of service "d365_metadata".
 */
export class AssetMaintenanceWorkOrderParentProjectsV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements AssetMaintenanceWorkOrderParentProjectsV2Type<T>
{
  /**
   * Technical entity name for AssetMaintenanceWorkOrderParentProjectsV2.
   */
  static override _entityName = 'AssetMaintenanceWorkOrderParentProjectsV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the AssetMaintenanceWorkOrderParentProjectsV2 entity.
   */
  static _keys = [
    'dataAreaId',
    'WorkOrderTypeId',
   ...
   * Valid To Date Time.
   */
  declare validToDateTime: DeserializedType<T, 'Edm.DateTimeOffset'>;
  /**
   * Project Id.
   * @nullable
   */
  ...
  constructor(_entityApi: AssetMaintenanceWorkOrderParentProjectsV2Api<T>) {
    super(_entityApi);
  }
}

export interface AssetMaintenanceWorkOrderParentProjectsV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
