...
import type { ExpMobilePerDiemDataForLineApprovalsApi } from './ExpMobilePerDiemDataForLineApprovalsApi';

/**
 * This class represents the entity "ExpMobilePerDiemDataForLineApprovals" of service "d365_metadata".
 */
export class ExpMobilePerDiemDataForLineApprovals<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ExpMobilePerDiemDataForLineApprovalsType<T>
{
  /**
   * Technical entity name for ExpMobilePerDiemDataForLineApprovals.
   */
  static override _entityName = 'ExpMobilePerDiemDataForLineApprovals';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ExpMobilePerDiemDataForLineApprovals entity.
   */
  ...
  constructor(_entityApi: ExpMobilePerDiemDataForLineApprovalsApi<T>) {
    super(_entityApi);
  }
}

export interface ExpMobilePerDiemDataForLineApprovalsType<
  T extends DeSerializers = DefaultDeSerializers
> {
