...
import type { PositionForecastsApi } from './PositionForecastsApi';
...
/**
 * This class represents the entity "PositionForecasts" of service "d365_metadata".
 */
export class PositionForecasts<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements PositionForecastsType<T>
{
  /**
   * Technical entity name for PositionForecasts.
   */
  static override _entityName = 'PositionForecasts';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the PositionForecasts entity.
   */
  static _keys = [
    'ForecastPositionId',
  ...
  constructor(_entityApi: PositionForecastsApi<T>) {
    super(_entityApi);
  }
}

export interface PositionForecastsType<
