...
import type { ClientelingParametersV2Api } from './ClientelingParametersV2Api';
import { NoYes } from './NoYes';

/**
 * This class represents the entity "ClientelingParametersV2" of service "d365_metadata".
 */
export class ClientelingParametersV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ClientelingParametersV2Type<T>
{
  /**
   * Technical entity name for ClientelingParametersV2.
   */
  static override _entityName = 'ClientelingParametersV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the ClientelingParametersV2 entity.
   */
  ...
  constructor(_entityApi: ClientelingParametersV2Api<T>) {
    super(_entityApi);
  }
}

export interface ClientelingParametersV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
