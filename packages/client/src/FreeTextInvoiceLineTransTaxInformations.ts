...
import type { FreeTextInvoiceLineTransTaxInformationsApi } from './FreeTextInvoiceLineTransTaxInformationsApi';
...
/**
 * This class represents the entity "FreeTextInvoiceLineTransTaxInformations" of service "d365_metadata".
 */
export class FreeTextInvoiceLineTransTaxInformations<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements FreeTextInvoiceLineTransTaxInformationsType<T>
{
  /**
   * Technical entity name for FreeTextInvoiceLineTransTaxInformations.
   */
  static override _entityName = 'FreeTextInvoiceLineTransTaxInformations';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the FreeTextInvoiceLineTransTaxInformations entity.
   */
  static _keys = ['dataAreaId', 'ParentRecId', 'LineNumber'];
  /**
   * Data Area Id.
   */
  ...
  constructor(_entityApi: FreeTextInvoiceLineTransTaxInformationsApi<T>) {
    super(_entityApi);
  }
}

export interface FreeTextInvoiceLineTransTaxInformationsType<
  T extends DeSerializers = DefaultDeSerializers
> {
