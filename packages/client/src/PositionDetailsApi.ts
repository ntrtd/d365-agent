...
import { PositionDetailsRequestBuilder } from './PositionDetailsRequestBuilder';
...
export class PositionDetailsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<PositionDetails<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new PositionDetailsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
     ...
     */
    TITLE: OneToOneLink<
      PositionDetails<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = PositionDetails;

  requestBuilder(): PositionDetailsRequestBuilder<DeSerializersT> {
    return new PositionDetailsRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<PositionDetails<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<PositionDetails<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof PositionDetails, DeSerializersT>;
  get fieldBuilder() {
  ...
  private _schema?: {
    ...
    POSITION_TYPE: OneToOneLink<
      ...
      PositionTypesApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<PositionDetails<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PositionDetails)
      };
    }
