...
import { SalesOrderTransTaxInformationsRequestBuilder } from './SalesOrderTransTaxInformationsRequestBuilder';
...
export class SalesOrderTransTaxInformationsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<SalesOrderTransTaxInformations<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): SalesOrderTransTaxInformationsApi<DeSerializersT> {
    return new SalesOrderTransTaxInformationsApi(deSerializers);
  }
  ...
  entityConstructor = SalesOrderTransTaxInformations;

  requestBuilder(): SalesOrderTransTaxInformationsRequestBuilder<DeSerializersT> {
    return new SalesOrderTransTaxInformationsRequestBuilder<DeSerializersT>(
      this
    );
  }

  entityBuilder(): EntityBuilderType<
    SalesOrderTransTaxInformations<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof SalesOrderTransTaxInformations,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        SalesOrderTransTaxInformations,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      SalesOrderTransTaxInformations<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    EXCISE_IS_SCRAP: EnumField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<SalesOrderTransTaxInformations<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', SalesOrderTransTaxInformations)
      };
    }
