...
import { PayIntV1EmployeesV2RequestBuilder } from './PayIntV1EmployeesV2RequestBuilder';
...
export class PayIntV1EmployeesV2Api<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<PayIntV1EmployeesV2<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): PayIntV1EmployeesV2Api<DeSerializersT> {
    return new PayIntV1EmployeesV2Api(deSerializers);
  }
  ...
  entityConstructor = PayIntV1EmployeesV2;

  requestBuilder(): PayIntV1EmployeesV2RequestBuilder<DeSerializersT> {
    return new PayIntV1EmployeesV2RequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    PayIntV1EmployeesV2<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<PayIntV1EmployeesV2<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    PERSONNEL_NUMBER: OrderableEdmTypeField<
      PayIntV1EmployeesV2<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    PENSION_ENROLLMENT: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<PayIntV1EmployeesV2<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PayIntV1EmployeesV2)
      };
    }
