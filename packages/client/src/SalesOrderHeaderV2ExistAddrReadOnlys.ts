...
import type { SalesOrderHeaderV2ExistAddrReadOnlysApi } from './SalesOrderHeaderV2ExistAddrReadOnlysApi';
...
/**
 * This class represents the entity "SalesOrderHeaderV2ExistAddrReadOnlys" of service "d365_metadata".
 */
export class SalesOrderHeaderV2ExistAddrReadOnlys<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements SalesOrderHeaderV2ExistAddrReadOnlysType<T>
{
  /**
   * Technical entity name for SalesOrderHeaderV2ExistAddrReadOnlys.
   */
  static override _entityName = 'SalesOrderHeaderV2ExistAddrReadOnlys';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the SalesOrderHeaderV2ExistAddrReadOnlys entity.
   */
  static _keys = [
    'dataAreaId',
  ...
  constructor(_entityApi: SalesOrderHeaderV2ExistAddrReadOnlysApi<T>) {
    super(_entityApi);
  }
}

export interface SalesOrderHeaderV2ExistAddrReadOnlysType<
  T extends DeSerializers = DefaultDeSerializers
> {
