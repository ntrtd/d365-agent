...
import { SmaServiceOrderLineTransTaxInformationsRequestBuilder } from './SmaServiceOrderLineTransTaxInformationsRequestBuilder';
...
export class SmaServiceOrderLineTransTaxInformationsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<
      SmaServiceOrderLineTransTaxInformations<DeSerializersT>,
      DeSerializersT
    >
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): SmaServiceOrderLineTransTaxInformationsApi<DeSerializersT> {
    return new SmaServiceOrderLineTransTaxInformationsApi(deSerializers);
  }
  ...
  entityConstructor = SmaServiceOrderLineTransTaxInformations;

  requestBuilder(): SmaServiceOrderLineTransTaxInformationsRequestBuilder<DeSerializersT> {
    return new SmaServiceOrderLineTransTaxInformationsRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof SmaServiceOrderLineTransTaxInformations,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        SmaServiceOrderLineTransTaxInformations,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      SmaServiceOrderLineTransTaxInformations<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', SmaServiceOrderLineTransTaxInformations)
      };
    }
