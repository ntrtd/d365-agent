...
import { InventTransCdsEntitiesRequestBuilder } from './InventTransCdsEntitiesRequestBuilder';
...
export class InventTransCdsEntitiesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<InventTransCdsEntities<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): InventTransCdsEntitiesApi<DeSerializersT> {
    return new InventTransCdsEntitiesApi(deSerializers);
  }
  ...
  entityConstructor = InventTransCdsEntities;

  requestBuilder(): InventTransCdsEntitiesRequestBuilder<DeSerializersT> {
    return new InventTransCdsEntitiesRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    InventTransCdsEntities<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof InventTransCdsEntities,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        InventTransCdsEntities,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      InventTransCdsEntities<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    INVOICE_RETURNED: EnumField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<InventTransCdsEntities<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', InventTransCdsEntities)
      };
    }
