...
import { VendVendorPostalAddressesRequestBuilder } from './VendVendorPostalAddressesRequestBuilder';
...
export class VendVendorPostalAddressesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<VendVendorPostalAddresses<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): VendVendorPostalAddressesApi<DeSerializersT> {
    return new VendVendorPostalAddressesApi(deSerializers);
  }
  ...
  entityConstructor = VendVendorPostalAddresses;

  requestBuilder(): VendVendorPostalAddressesRequestBuilder<DeSerializersT> {
    return new VendVendorPostalAddressesRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    VendVendorPostalAddresses<DeSerializersT>,
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof VendVendorPostalAddresses,
    DeSerializersT
  >;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(
        VendVendorPostalAddresses,
        this.deSerializers
      );
    }
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      VendVendorPostalAddresses<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    >;
    VENDOR_LEGAL_ENTITY_ID: OrderableEdmTypeField<
      VendVendorPostalAddresses<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
    ...
    ADDRESS_COUNTRY_REGION_ISO_CODE: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<VendVendorPostalAddresses<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link vendorLegalEntityId} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        VENDOR_LEGAL_ENTITY_ID: fieldBuilder.buildEdmTypeField(
          'VendorLegalEntityId',
          'Edm.String',
          false
        ),
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', VendVendorPostalAddresses)
      };
    }
