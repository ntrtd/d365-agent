...
import type { MarginComponentPriceAdjustmentsApi } from './MarginComponentPriceAdjustmentsApi';
...
/**
 * This class represents the entity "MarginComponentPriceAdjustments" of service "d365_metadata".
 */
export class MarginComponentPriceAdjustments<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements MarginComponentPriceAdjustmentsType<T>
{
  /**
   * Technical entity name for MarginComponentPriceAdjustments.
   */
  static override _entityName = 'MarginComponentPriceAdjustments';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the MarginComponentPriceAdjustments entity.
   */
  ...
  constructor(_entityApi: MarginComponentPriceAdjustmentsApi<T>) {
    super(_entityApi);
  }
}

export interface MarginComponentPriceAdjustmentsType<
  T extends DeSerializers = DefaultDeSerializers
> {
