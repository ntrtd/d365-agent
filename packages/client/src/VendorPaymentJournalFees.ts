...
import type { VendorPaymentJournalFeesApi } from './VendorPaymentJournalFeesApi';
...
/**
 * This class represents the entity "VendorPaymentJournalFees" of service "d365_metadata".
 */
export class VendorPaymentJournalFees<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements VendorPaymentJournalFeesType<T>
{
  /**
   * Technical entity name for VendorPaymentJournalFees.
   */
  static override _entityName = 'VendorPaymentJournalFees';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the VendorPaymentJournalFees entity.
   */
  static _keys = [
    'dataAreaId',
  ...
  /**
   * Is Paym Fee Covered By Vendor.
   * @nullable
   */
  declare isPaymFeeCoveredByVendor?: NoYes | null;
  /**
   * Account Type.
   * @nullable
   */
   ...
   */
  declare vendorPaymentJournalLine?: VendorPaymentJournalLines<T> | null;
  /**
   * One-to-one navigation property to the {@link VendorPaymentFees} entity.
   */
  declare vendorPaymentFee?: VendorPaymentFees<T> | null;
  /**
  ...
  constructor(_entityApi: VendorPaymentJournalFeesApi<T>) {
    super(_entityApi);
  }
}

export interface VendorPaymentJournalFeesType<
  T extends DeSerializers = DefaultDeSerializers
> {
  ...
  isPaymFeeCoveredByVendor?: NoYes | null;
  ...
  vendorPaymentJournalLine?: VendorPaymentJournalLinesType<T> | null;
  vendorPaymentFee?: VendorPaymentFeesType<T> | null;
