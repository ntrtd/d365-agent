...
import type { InventorySitesOnHandV2Api } from './InventorySitesOnHandV2Api';
import { NoYes } from './NoYes';

/**
 * This class represents the entity "InventorySitesOnHandV2" of service "d365_metadata".
 */
export class InventorySitesOnHandV2<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements InventorySitesOnHandV2Type<T>
{
  /**
   * Technical entity name for InventorySitesOnHandV2.
   */
  static override _entityName = 'InventorySitesOnHandV2';
  /**
   * Default url path for the according service.
   */
  static override _defaultBasePath = '/';
  /**
   * All key fields of the InventorySitesOnHandV2 entity.
   */
  static _keys = [
    'dataAreaId',
    'ItemNumber',
  ...
  constructor(_entityApi: InventorySitesOnHandV2Api<T>) {
    super(_entityApi);
  }
}

export interface InventorySitesOnHandV2Type<
  T extends DeSerializers = DefaultDeSerializers
> {
