...
import { LineDiscountCustomerGroupsRequestBuilder } from './LineDiscountCustomerGroupsRequestBuilder';
...
export class LineDiscountCustomerGroupsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<LineDiscountCustomerGroups<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new LineDiscountCustomerGroupsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    OPEN_SALES_LINE_DISCOUNT_JOURNAL_LINE: OneToManyLink<
      LineDiscountCustomerGroups<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    linkedApis: [OpenSalesLineDiscountJournalLinesApi<DeSerializersT>]
  ): this {
  ...
  entityConstructor = LineDiscountCustomerGroups;

  requestBuilder(): LineDiscountCustomerGroupsRequestBuilder<DeSerializersT> {
    return new LineDiscountCustomerGroupsRequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof LineDiscountCustomerGroups,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DATA_AREA_ID: OrderableEdmTypeField<
      LineDiscountCustomerGroups<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    OPEN_SALES_LINE_DISCOUNT_JOURNAL_LINE: OneToManyLink<
      ...
      OpenSalesLineDiscountJournalLinesApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<LineDiscountCustomerGroups<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', LineDiscountCustomerGroups)
      };
    }
